...
import { icelandGroupSummer7SouthGoldenCircleHikingPricing } from "../lib/trip-pricing/iceland-group-summer-7-south-golden-circle-hiking";
...
async function main() {
  const config = {
    ...
    corivo: { ...icelandGroupSummer7SouthGoldenCircleHikingPricing.corivo! },
  };
