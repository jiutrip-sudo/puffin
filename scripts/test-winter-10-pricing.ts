...
import { icelandSelfDriveWinter10Pricing } from "../lib/trip-pricing/iceland-self-drive-winter-10";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter10Pricing,
    corivo: { ...icelandSelfDriveWinter10Pricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-10",
