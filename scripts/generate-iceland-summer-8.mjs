...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-8-live.html");
const IMG_BASE =
...
const ATTRACTION_TITLES = [
  ...
  "斯卡夫塔山国家公园｜Skaftafell National Park",
...
function extractPackageMeta(decoded) {
  const headerMatch = decoded.match(
    /"header":\{"title":"([^"]+)","images":\[([\s\S]*?)\],"days":8,"nights":7/,
  );
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandSelfDriveSummer8Day${dayNum}Highlights`;
    const ex = `icelandSelfDriveSummer8Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-8-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer8Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-8-days2-8-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer8Day2Highlights",
      items: dayData["黄金圈之旅"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day2OptionalActivities",
      items: dayData["黄金圈之旅"].extras,
    },
    {
      name: "icelandSelfDriveSummer8Day3Highlights",
      items: dayData["冰岛南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day3OptionalActivities",
      items: dayData["冰岛南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer8Day4Highlights",
      items: dayData["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day4OptionalActivities",
      items: dayData["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer8Day5Highlights",
      items: dayData["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day5OptionalActivities",
      items: dayData["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer8Day6Highlights",
      items: dayData["米湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day6OptionalActivities",
      items: dayData["米湖风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer8Day7Highlights",
      items: dayData["冰岛西部白银圈"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day7OptionalActivities",
      items: dayData["冰岛西部白银圈"].extras,
    },
    {
      name: "icelandSelfDriveSummer8Day8Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer8Day8OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-8.ts"),
