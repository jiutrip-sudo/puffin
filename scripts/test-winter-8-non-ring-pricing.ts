...
import { icelandSelfDriveWinter8NonRingPricing } from "../lib/trip-pricing/iceland-self-drive-winter-8-non-ring";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter8NonRingPricing,
    corivo: { ...icelandSelfDriveWinter8NonRingPricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-8-non-ring",
