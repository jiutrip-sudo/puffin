...
import { icelandSelfDriveWinter8Pricing } from "../lib/trip-pricing/iceland-self-drive-winter-8";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter8Pricing,
    corivo: { ...icelandSelfDriveWinter8Pricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-8",
