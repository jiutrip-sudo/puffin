...
import { icelandSelfDriveWinter9NonRingPricing } from "../lib/trip-pricing/iceland-self-drive-winter-9-non-ring";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter9NonRingPricing,
    corivo: { ...icelandSelfDriveWinter9NonRingPricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-9-non-ring",
