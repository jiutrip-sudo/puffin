...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-winter-group-7-live.html");
const IMG_BASE =
...
const DAY_PAIRS = [
  ["入境日", "南岸风光：塞里雅兰瀑布、斯科加瀑布、维克黑沙滩"],
  [
    "南岸风光：塞里雅兰瀑布、斯科加瀑布、维克黑沙滩",
    "东南岸景色：杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险",
  ],
  [
    "东南岸景色：杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险",
    "黄金圈：辛格维利尔国家公园、间歇泉、黄金瀑布、凯瑞斯火山口",
  ],
  [
    "黄金圈：辛格维利尔国家公园、间歇泉、黄金瀑布、凯瑞斯火山口",
    "冰岛西部风光：格兰尼瀑布、德尔达图赫菲温泉、赫伦瀑布、熔岩洞穴探险",
  ],
  [
    "冰岛西部风光：格兰尼瀑布、德尔达图赫菲温泉、赫伦瀑布、熔岩洞穴探险",
    "斯奈山半岛： 海豹沙滩、黑教堂、阿纳斯塔皮、教会山",
  ],
  ["斯奈山半岛： 海豹沙滩、黑教堂、阿纳斯塔皮、教会山", "离境日"],
  ["离境日", null],
];
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupWinter7Day${dayNum}Highlights`;
    const ex = `icelandGroupWinter7Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
  ...
  const routeStopDetails = [
    ...
    "黃金圈（辛格維利爾 → 間歇泉 → 黃金瀑布 → 凱瑞斯火山口）",
    "冰島西部（格蘭尼瀑布 → 赫倫瀑布 → 熔岩洞穴）",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-7-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter7Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandGroupWinter7Day1OptionalActivities",
      items: dayData["入境日"].extras,
    },
  ]),
);

const DAY2 = "南岸风光：塞里雅兰瀑布、斯科加瀑布、维克黑沙滩";
const DAY3 = "东南岸景色：杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险";
const DAY4 =
  "黄金圈：辛格维利尔国家公园、间歇泉、黄金瀑布、凯瑞斯火山口";
const DAY5 =
  "冰岛西部风光：格兰尼瀑布、德尔达图赫菲温泉、赫伦瀑布、熔岩洞穴探险";
const DAY6 = "斯奈山半岛： 海豹沙滩、黑教堂、阿纳斯塔皮、教会山";

fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-7-days2-7-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter7Day2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupWinter7Day2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupWinter7Day3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupWinter7Day3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupWinter7Day4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupWinter7Day4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupWinter7Day5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupWinter7Day5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupWinter7Day6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupWinter7Day6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupWinter7Day7Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupWinter7Day7OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-7.ts"),
