...
import { icelandSelfDriveSummer14Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-14";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer14Pricing,
    corivo: { ...icelandSelfDriveSummer14Pricing.corivo! },
  };
