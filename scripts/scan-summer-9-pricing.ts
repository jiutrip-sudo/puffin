...
import { icelandSelfDriveSummer9Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-9";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer9Pricing,
    corivo: { ...icelandSelfDriveSummer9Pricing.corivo! },
  };
