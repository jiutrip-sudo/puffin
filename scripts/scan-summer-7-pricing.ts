...
import { icelandSelfDriveSummer7Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-7";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer7Pricing,
    corivo: { ...icelandSelfDriveSummer7Pricing.corivo! },
  };
