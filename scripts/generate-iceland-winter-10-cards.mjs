...
const SLM_HTML =
  ...
  path.join(ROOT, "tmp/slm-winter-10.html");
const IMG_BASE =
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-10-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter10Day1Highlights",
      items: data["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-10-days2-10-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter10Day2Highlights",
      items: data["黄金圈"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day2OptionalActivities",
      items: data["黄金圈"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day3Highlights",
      items: data["南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day3OptionalActivities",
      items: data["南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day4Highlights",
      items: data["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day4OptionalActivities",
      items: data["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day5Highlights",
      items: data["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day5OptionalActivities",
      items: data["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day6Highlights",
      items: data["米湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day6OptionalActivities",
      items: data["米湖风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day7Highlights",
      items: data["北部风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day7OptionalActivities",
      items: data["北部风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day8Highlights",
      items: data["西部沿途风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day8OptionalActivities",
      items: data["西部沿途风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day9Highlights",
      items: data["斯奈山半岛"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day9OptionalActivities",
      items: data["斯奈山半岛"].extras,
    },
    {
      name: "icelandSelfDriveWinter10Day10Highlights",
      items: data["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter10Day10OptionalActivities",
