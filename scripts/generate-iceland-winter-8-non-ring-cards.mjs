...
const SLM_HTML =
  ...
  path.join(ROOT, "tmp/slm-winter-8-non-ring.html");
const IMG_BASE =
...
const PREFIX = "icelandSelfDriveWinter8NonRing";

const data = extractAllDays();
const outDir = path.join(ROOT, "lib/trip-packages");

fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-8-non-ring-day1-cards.ts"),
  renderExports([
    {
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-8-non-ring-days2-8-cards.ts"),
