...
import { icelandGroupWinter4Pricing } from "../lib/trip-pricing/iceland-group-winter-4";
...
async function main() {
  const config = {
    ...icelandGroupWinter4Pricing,
    corivo: { ...icelandGroupWinter4Pricing.corivo! },
  };
  ...
  console.log(
    JSON.stringify(
      {
        dates: dates.length,
        combos: dates.length * tiers.length,
        ok,
        fail,
      },
      null,
