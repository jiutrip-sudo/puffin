...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-4-day1-cards.ts"),
  renderExports([
    { name: "icelandSelfDriveWinter4Day1Highlights", items: data["入境日"].highlights },
    {
      name: "icelandSelfDriveWinter4Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-4-days2-4-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter4Day2Highlights",
      items: data["冰岛南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter4Day2OptionalActivities",
      items: data["冰岛南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter4Day3Highlights",
      items: data["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter4Day3OptionalActivities",
      items: data["冰河湖风光"].extras,
    },
    { name: "icelandSelfDriveWinter4Day4Highlights", items: data["离境日"].highlights },
    {
      name: "icelandSelfDriveWinter4Day4OptionalActivities",
