...
const SLM_HTML = process.env.SLM_HTML ?? "/tmp/slm-winter-8.html";
const IMG_BASE =
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-8-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter8Day1Highlights",
      items: data["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-8-days2-8-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter8Day2Highlights",
      items: data["黄金圈"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day2OptionalActivities",
      items: data["黄金圈"].extras,
    },
    {
      name: "icelandSelfDriveWinter8Day3Highlights",
      items: data["南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day3OptionalActivities",
      items: data["南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter8Day4Highlights",
      items: data["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day4OptionalActivities",
      items: data["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter8Day5Highlights",
      items: data["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day5OptionalActivities",
      items: data["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter8Day6Highlights",
      items: data["米湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day6OptionalActivities",
      items: data["米湖风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter8Day7Highlights",
      items: data["西部白银圈"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day7OptionalActivities",
      items: data["西部白银圈"].extras,
    },
    {
      name: "icelandSelfDriveWinter8Day8Highlights",
      items: data["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter8Day8OptionalActivities",
