...
import { icelandGroupSummer5SouthGoldenCirclePricing } from "../lib/trip-pricing/iceland-group-summer-5-south-golden-circle";
...
async function main() {
  const config = {
    ...
    corivo: { ...icelandGroupSummer5SouthGoldenCirclePricing.corivo! },
  };
