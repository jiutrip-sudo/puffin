...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-7-live.html");
const IMG_BASE =
...
function extractPackageMeta(decoded) {
  const headerMatch = decoded.match(
    /"header":\{"title":"([^"]+)","images":\[([\s\S]*?)\],"days":7,"nights":6/,
  );
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandSelfDriveSummer7Day${dayNum}Highlights`;
    const ex = `icelandSelfDriveSummer7Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-7-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer7Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-7-days2-7-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer7Day2Highlights",
      items: dayData["南岸瀑布风光、黑沙滩"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day2OptionalActivities",
      items: dayData["南岸瀑布风光、黑沙滩"].extras,
    },
    {
      name: "icelandSelfDriveSummer7Day3Highlights",
      items: dayData["杰古沙龙冰河湖、钻石沙滩"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day3OptionalActivities",
      items: dayData["杰古沙龙冰河湖、钻石沙滩"].extras,
    },
    {
      name: "icelandSelfDriveSummer7Day4Highlights",
      items: dayData["南岸小众风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day4OptionalActivities",
      items: dayData["南岸小众风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer7Day5Highlights",
      items: dayData["黄金圈、 冰岛西部"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day5OptionalActivities",
      items: dayData["黄金圈、 冰岛西部"].extras,
    },
    {
      name: "icelandSelfDriveSummer7Day6Highlights",
      items: dayData["斯奈山半岛风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day6OptionalActivities",
      items: dayData["斯奈山半岛风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer7Day7Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer7Day7OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-7.ts"),
