...
import { icelandSelfDriveSummer12Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-12";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer12Pricing,
    corivo: { ...icelandSelfDriveSummer12Pricing.corivo! },
  };
