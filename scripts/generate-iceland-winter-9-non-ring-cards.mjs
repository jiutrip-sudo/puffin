...
const SLM_HTML =
  ...
  path.join(ROOT, "tmp/slm-winter-9-non-ring.html");
const IMG_BASE =
...
const PREFIX = "icelandSelfDriveWinter9NonRing";

const data = extractAllDays();
const outDir = path.join(ROOT, "lib/trip-packages");

fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-9-non-ring-day1-cards.ts"),
  renderExports([
    {
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-9-non-ring-days2-9-cards.ts"),
