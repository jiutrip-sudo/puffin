...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-group-9-live.html");
const IMG_BASE =
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupSummer9Day${dayNum}Highlights`;
    const ex = `icelandGroupSummer9Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
function fixSummer9MetaDays(decoded, days) {
  if (days.some((day) => day.title === "入境日")) return days;
  const match = decoded.match(
    /"title":"入境日","description":"((?:[^"\\]|\\.)*)"(?:,"location":(null|"([^"]*)"))?/,
  );
  return [
    {
      title: "入境日",
...
meta.days = fixSummer9MetaDays(decoded, meta.days);
const outDir = path.join(ROOT, "lib/trip-packages");

fs.writeFileSync(
  path.join(outDir, "iceland-group-summer-9-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupSummer9Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandGroupSummer9Day1OptionalActivities",
...
const DAY6 = "斯奈山半岛";
const DAY7 = "火山 & 观鲸";
const DAY8 = "雷克雅未克自由活动日";

fs.writeFileSync(
  path.join(outDir, "iceland-group-summer-9-days2-9-cards.ts"),
  renderExports([
    {
      name: "icelandGroupSummer9Day2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupSummer9Day2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupSummer9Day3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupSummer9Day3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupSummer9Day4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupSummer9Day4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupSummer9Day5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupSummer9Day5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupSummer9Day6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupSummer9Day6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupSummer9Day7Highlights",
      items: dayData[DAY7].highlights,
    },
    {
      name: "icelandGroupSummer9Day7OptionalActivities",
      items: dayData[DAY7].extras,
    },
    {
      name: "icelandGroupSummer9Day8Highlights",
      items: dayData[DAY8].highlights,
    },
    {
      name: "icelandGroupSummer9Day8OptionalActivities",
      items: dayData[DAY8].extras,
    },
    {
      name: "icelandGroupSummer9Day9Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupSummer9Day9OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-summer-9.ts"),
