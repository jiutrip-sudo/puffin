...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-winter-group-8-non-ring-live.html");
const IMG_BASE =
...
const DAY_PAIRS = [
  ["入境日", "南岸瀑布和黑沙滩"],
  ["南岸瀑布和黑沙滩", "冰河湖风光、钻石沙滩、蓝冰洞探险"],
  ["冰河湖风光、钻石沙滩、蓝冰洞探险", "黄金瀑布、间歇泉、辛格维利尔国家公园"],
  ["黄金瀑布、间歇泉、辛格维利尔国家公园", "熔岩瀑布、儿童瀑布、雷克霍特历史遗址"],
  [
    "熔岩瀑布、儿童瀑布、雷克霍特历史遗址",
    "斯奈山半岛：黑教堂、阿尔纳斯塔皮、教会山",
  ],
  ["斯奈山半岛：黑教堂、阿尔纳斯塔皮、教会山", "雷克雅未克自由活动日"],
  ["雷克雅未克自由活动日", "离境日"],
  ["离境日", null],
];
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupWinter8NonRingDay${dayNum}Highlights`;
    const ex = `icelandGroupWinter8NonRingDay${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-8-non-ring-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter8NonRingDay1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay1OptionalActivities",
...
const DAY2 = "南岸瀑布和黑沙滩";
const DAY3 = "冰河湖风光、钻石沙滩、蓝冰洞探险";
const DAY4 = "黄金瀑布、间歇泉、辛格维利尔国家公园";
const DAY5 = "熔岩瀑布、儿童瀑布、雷克霍特历史遗址";
const DAY6 = "斯奈山半岛：黑教堂、阿尔纳斯塔皮、教会山";
const DAY7 = "雷克雅未克自由活动日";

fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-8-non-ring-days2-8-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter8NonRingDay2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupWinter8NonRingDay3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupWinter8NonRingDay4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupWinter8NonRingDay5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupWinter8NonRingDay6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupWinter8NonRingDay7Highlights",
      items: dayData[DAY7].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay7OptionalActivities",
      items: dayData[DAY7].extras,
    },
    {
      name: "icelandGroupWinter8NonRingDay8Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupWinter8NonRingDay8OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-8-non-ring.ts"),
