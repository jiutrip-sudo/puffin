...
import { icelandSelfDriveWinter7Pricing } from "../lib/trip-pricing/iceland-self-drive-winter-7";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter7Pricing,
    corivo: { ...icelandSelfDriveWinter7Pricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-7",
