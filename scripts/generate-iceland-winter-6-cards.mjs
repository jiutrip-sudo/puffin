...
const SLM_HTML = process.env.SLM_HTML ?? "/tmp/slm-winter-6.html";
const IMG_BASE =
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-6-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter6Day1Highlights",
      items: data["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter6Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-6-days2-6-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter6Day2Highlights",
      items: data["冰岛南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter6Day2OptionalActivities",
      items: data["冰岛南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter6Day3Highlights",
      items: data["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter6Day3OptionalActivities",
      items: data["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter6Day4Highlights",
      items: data["冰岛南岸小众景点"].highlights,
    },
    {
      name: "icelandSelfDriveWinter6Day4OptionalActivities",
      items: data["冰岛南岸小众景点"].extras,
    },
    {
      name: "icelandSelfDriveWinter6Day5Highlights",
      items: data["黄金圈之旅"].highlights,
    },
    {
      name: "icelandSelfDriveWinter6Day5OptionalActivities",
      items: data["黄金圈之旅"].extras,
    },
    {
      name: "icelandSelfDriveWinter6Day6Highlights",
      items: data["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter6Day6OptionalActivities",
