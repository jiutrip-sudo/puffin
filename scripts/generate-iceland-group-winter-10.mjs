...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-winter-group-10-live.html");
const IMG_BASE =
...
const DAY_PAIRS = [
  ...
  ["北部观鲸之旅", "斯奈山半岛一日游"],
  ["斯奈山半岛一日游", "赫伦瀑布、儿童瀑布、德尔达图赫菲温泉"],
  ["赫伦瀑布、儿童瀑布、德尔达图赫菲温泉", "离境日"],
  ["离境日", null],
];
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupWinter10Day${dayNum}Highlights`;
    const ex = `icelandGroupWinter10Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
const DAY3 = "塞里雅兰瀑布、斯科加瀑布、维克黑沙滩、冰川徒步";
const DAY4 = "杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险";
const DAY5 = "东部峡湾风光";
const DAY6 = "米湖、Hverir地热泥浆池、黑暗城堡、众神瀑布";
const DAY7 = "北部观鲸之旅";
const DAY8 = "斯奈山半岛一日游";
const DAY9 = "赫伦瀑布、儿童瀑布、德尔达图赫菲温泉";

fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-10-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter10Day1Highlights",
      items: dayData[DAY1].highlights,
    },
    {
      name: "icelandGroupWinter10Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-10-days2-10-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter10Day2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupWinter10Day2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupWinter10Day3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupWinter10Day3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupWinter10Day4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupWinter10Day4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupWinter10Day5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupWinter10Day5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupWinter10Day6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupWinter10Day6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupWinter10Day7Highlights",
      items: dayData[DAY7].highlights,
    },
    {
      name: "icelandGroupWinter10Day7OptionalActivities",
      items: dayData[DAY7].extras,
    },
    {
      name: "icelandGroupWinter10Day8Highlights",
      items: dayData[DAY8].highlights,
    },
    {
      name: "icelandGroupWinter10Day8OptionalActivities",
      items: dayData[DAY8].extras,
    },
    {
      name: "icelandGroupWinter10Day9Highlights",
      items: dayData[DAY9].highlights,
    },
    {
      name: "icelandGroupWinter10Day9OptionalActivities",
      items: dayData[DAY9].extras,
    },
    {
      name: "icelandGroupWinter10Day10Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupWinter10Day10OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-10.ts"),
