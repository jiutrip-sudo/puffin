...
import { icelandSelfDriveWinter6Pricing } from "../lib/trip-pricing/iceland-self-drive-winter-6";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter6Pricing,
    corivo: { ...icelandSelfDriveWinter6Pricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-6",
