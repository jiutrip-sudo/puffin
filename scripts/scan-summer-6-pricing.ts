...
import { icelandSelfDriveSummer6Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-6";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer6Pricing,
    corivo: { ...icelandSelfDriveSummer6Pricing.corivo! },
  };
