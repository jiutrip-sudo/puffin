...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-winter-group-10-non-ring-live.html");
const IMG_BASE =
...
const DAY_PAIRS = [
  ["入境日", "南岸经典观光：打卡壮美南岸瀑布及黑沙滩"],
  [
    "南岸经典观光：打卡壮美南岸瀑布及黑沙滩",
    "冰河湖风景：杰古沙龙冰河湖、钻石沙滩、避世小镇维克",
  ],
  [
    "冰河湖风景：杰古沙龙冰河湖、钻石沙滩、避世小镇维克",
    "黄金圈环游：黄金瀑布、辛格维利尔国家公园、间歇泉",
  ],
  [
    "黄金圈环游：黄金瀑布、辛格维利尔国家公园、间歇泉",
    "探访西部：熔岩瀑布、儿童瀑布、欧洲流速最快温泉",
  ],
  [
    "探访西部：熔岩瀑布、儿童瀑布、欧洲流速最快温泉",
    "冰岛缩影斯奈山半岛：黑教堂、教会山、阿尔纳斯塔皮渔村",
  ],
  [
    "冰岛缩影斯奈山半岛：黑教堂、教会山、阿尔纳斯塔皮渔村",
    "轻松活动日：Hvammsvík温泉（可选浮潜）",
  ],
  [
    "轻松活动日：Hvammsvík温泉（可选浮潜）",
    "特别活动日：冰岛马骑行（可选浮潜）",
...
const ATTRACTION_TITLES = [
  ...
  "杰古沙龙冰河湖｜Jökulsárlón",
  "瓦特纳冰川蓝冰洞探秘｜Crystal Ice Cave Adventure",
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupWinter10NonRingDay${dayNum}Highlights`;
    const ex = `icelandGroupWinter10NonRingDay${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-10-non-ring-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter10NonRingDay1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay1OptionalActivities",
      items: dayData["入境日"].extras,
    },
  ]),
);

const DAY2 = "南岸经典观光：打卡壮美南岸瀑布及黑沙滩";
const DAY3 = "冰河湖风景：杰古沙龙冰河湖、钻石沙滩、避世小镇维克";
const DAY4 = "黄金圈环游：黄金瀑布、辛格维利尔国家公园、间歇泉";
const DAY5 = "探访西部：熔岩瀑布、儿童瀑布、欧洲流速最快温泉";
const DAY6 = "冰岛缩影斯奈山半岛：黑教堂、教会山、阿尔纳斯塔皮渔村";
const DAY7 = "轻松活动日：Hvammsvík温泉（可选浮潜）";
const DAY8 = "特别活动日：冰岛马骑行（可选浮潜）";
const DAY9 = "雷克雅未克自由活动日（可选观鲸）";

fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-10-non-ring-days2-10-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter10NonRingDay2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay7Highlights",
      items: dayData[DAY7].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay7OptionalActivities",
      items: dayData[DAY7].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay8Highlights",
      items: dayData[DAY8].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay8OptionalActivities",
      items: dayData[DAY8].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay9Highlights",
      items: dayData[DAY9].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay9OptionalActivities",
      items: dayData[DAY9].extras,
    },
    {
      name: "icelandGroupWinter10NonRingDay10Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupWinter10NonRingDay10OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-10-non-ring.ts"),
