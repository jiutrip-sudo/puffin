...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-winter-group-6-live.html");
const IMG_BASE =
...
const DAY_PAIRS = [
  ["入境日", "塞里雅兰瀑布、斯科加瀑布、黑沙滩"],
  ["塞里雅兰瀑布、斯科加瀑布、黑沙滩", "杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险、南岸沿途风光"],
  ["杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险、南岸沿途风光", "黄金圈：间歇泉、黄金瀑布、辛格维利尔国家公园"],
  ["黄金圈：间歇泉、黄金瀑布、辛格维利尔国家公园", "斯奈山半岛"],
  ["斯奈山半岛", "离境日"],
  ["离境日", null],
];
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupWinter6Day${dayNum}Highlights`;
    const ex = `icelandGroupWinter6Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-6-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter6Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandGroupWinter6Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-6-days2-6-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter6Day2Highlights",
      items: dayData["塞里雅兰瀑布、斯科加瀑布、黑沙滩"].highlights,
    },
    {
      name: "icelandGroupWinter6Day2OptionalActivities",
      items: dayData["塞里雅兰瀑布、斯科加瀑布、黑沙滩"].extras,
    },
    {
      name: "icelandGroupWinter6Day3Highlights",
      items: dayData["杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险、南岸沿途风光"].highlights,
    },
    {
      name: "icelandGroupWinter6Day3OptionalActivities",
      items: dayData["杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险、南岸沿途风光"].extras,
    },
    {
      name: "icelandGroupWinter6Day4Highlights",
      items: dayData["黄金圈：间歇泉、黄金瀑布、辛格维利尔国家公园"].highlights,
    },
    {
      name: "icelandGroupWinter6Day4OptionalActivities",
      items: dayData["黄金圈：间歇泉、黄金瀑布、辛格维利尔国家公园"].extras,
    },
    {
      name: "icelandGroupWinter6Day5Highlights",
      items: dayData["斯奈山半岛"].highlights,
    },
    {
      name: "icelandGroupWinter6Day5OptionalActivities",
      items: dayData["斯奈山半岛"].extras,
    },
    {
      name: "icelandGroupWinter6Day6Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupWinter6Day6OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-6.ts"),
