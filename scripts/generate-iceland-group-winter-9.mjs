...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-winter-group-9-live.html");
const IMG_BASE =
...
const DAY_PAIRS = [
  ["入境日、雷克雅未克城市风光", "黄金圈之旅：辛格维利尔国家公园、间歇泉、黄金瀑布"],
  [
    "黄金圈之旅：辛格维利尔国家公园、间歇泉、黄金瀑布",
    "冰岛南岸风光：塞里雅兰瀑布、斯科加瀑布、维克黑沙滩",
  ],
  [
    "冰岛南岸风光：塞里雅兰瀑布、斯科加瀑布、维克黑沙滩",
    "杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险",
  ...
  [
    "东部峡湾风光",
    "米湖、Hverir地热泥浆池、黑暗城堡、众神瀑布",
  ],
  ["米湖、Hverir地热泥浆池、黑暗城堡、众神瀑布", "北部观鲸之旅"],
  [
    "北部观鲸之旅",
    "斯奈山半岛：海豹沙滩、黑教堂、教会山、阿尔纳斯塔皮",
  ],
  ["斯奈山半岛：海豹沙滩、黑教堂、教会山、阿尔纳斯塔皮", "离境日"],
  ["离境日", null],
];
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupWinter9Day${dayNum}Highlights`;
    const ex = `icelandGroupWinter9Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
  ...
  const routeStopDetails = [
    "雷克雅未克（入境、城市風光、可選 Sky Lagoon）",
    "黃金圈（辛格維利爾 → 間歇泉 → 黃金瀑布）",
    "南岸 → 塞里雅蘭／斯科加瀑布 → 黑沙灘 → 維克",
    "傑古沙龍冰河湖 → 鑽石沙灘 → 藍冰洞",
    "東部峽灣風光",
...
const DAY1 = "入境日、雷克雅未克城市风光";
const DAY2 = "黄金圈之旅：辛格维利尔国家公园、间歇泉、黄金瀑布";
const DAY3 = "冰岛南岸风光：塞里雅兰瀑布、斯科加瀑布、维克黑沙滩";
const DAY4 = "杰古沙龙冰河湖、钻石沙滩、蓝冰洞探险";
const DAY5 = "东部峡湾风光";
const DAY6 = "米湖、Hverir地热泥浆池、黑暗城堡、众神瀑布";
const DAY7 = "北部观鲸之旅";
const DAY8 = "斯奈山半岛：海豹沙滩、黑教堂、教会山、阿尔纳斯塔皮";

fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-9-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter9Day1Highlights",
      items: dayData[DAY1].highlights,
    },
    {
      name: "icelandGroupWinter9Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-9-days2-9-cards.ts"),
  renderExports([
    {
      name: "icelandGroupWinter9Day2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupWinter9Day2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupWinter9Day3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupWinter9Day3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupWinter9Day4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupWinter9Day4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupWinter9Day5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupWinter9Day5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupWinter9Day6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupWinter9Day6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupWinter9Day7Highlights",
      items: dayData[DAY7].highlights,
    },
    {
      name: "icelandGroupWinter9Day7OptionalActivities",
      items: dayData[DAY7].extras,
    },
    {
      name: "icelandGroupWinter9Day8Highlights",
      items: dayData[DAY8].highlights,
    },
    {
      name: "icelandGroupWinter9Day8OptionalActivities",
      items: dayData[DAY8].extras,
    },
    {
      name: "icelandGroupWinter9Day9Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupWinter9Day9OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-winter-9.ts"),
