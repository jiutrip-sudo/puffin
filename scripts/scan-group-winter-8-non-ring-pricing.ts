...
import { icelandGroupWinter8NonRingPricing } from "../lib/trip-pricing/iceland-group-winter-8-non-ring";
...
async function main() {
  const config = {
    ...icelandGroupWinter8NonRingPricing,
    corivo: { ...icelandGroupWinter8NonRingPricing.corivo! },
  };
