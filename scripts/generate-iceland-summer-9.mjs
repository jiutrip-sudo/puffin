...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-9-live.html");
const IMG_BASE =
...
function extractPackageMeta(decoded) {
  const headerMatch = decoded.match(
    /"header":\{"title":"([^"]+)","images":\[([\s\S]*?)\],"days":9,"nights":8/,
  );
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandSelfDriveSummer9Day${dayNum}Highlights`;
    const ex = `icelandSelfDriveSummer9Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
  ...
  const routeStopDetails = [
    ...
    "東部峽灣海岸公路 → 埃伊爾斯塔濟",
    "黛提瀑布 → 東北部風光 → 北部方向",
    "米湖地熱區及周邊（胡薩維克可選）→ 北部住宿",
    "眾神瀑布 → 阿克雷里 → 西部白銀圈 → 雷克雅未克",
    "雷克雅未克市區（可選）→ 機場離境",
  ];
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-9-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer9Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-9-days2-9-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer9Day2Highlights",
      items: dayData["黄金圈之旅"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day2OptionalActivities",
      items: dayData["黄金圈之旅"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day3Highlights",
      items: dayData["南岸绝赞风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day3OptionalActivities",
      items: dayData["南岸绝赞风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day4Highlights",
      items: dayData["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day4OptionalActivities",
      items: dayData["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day5Highlights",
      items: dayData["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day5OptionalActivities",
      items: dayData["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day6Highlights",
      items: dayData["东北部风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day6OptionalActivities",
      items: dayData["东北部风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day7Highlights",
      items: dayData["米湖热能区及周边"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day7OptionalActivities",
      items: dayData["米湖热能区及周边"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day8Highlights",
      items: dayData["西部风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day8OptionalActivities",
      items: dayData["西部风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer9Day9Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer9Day9OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-9.ts"),
