...
import { icelandGroupWinter9NonRingPricing } from "../lib/trip-pricing/iceland-group-winter-9-non-ring";
...
async function main() {
  const config = {
    ...icelandGroupWinter9NonRingPricing,
    corivo: { ...icelandGroupWinter9NonRingPricing.corivo! },
  };
