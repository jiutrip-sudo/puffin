...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-12-live.html");
const IMG_BASE =
...
function extractPackageMeta(decoded) {
  const headerMatch = decoded.match(
    /"header":\{"title":"([^"]+)","images":\[([\s\S]*?)\],"days":12,"nights":11/,
  );
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandSelfDriveSummer12Day${dayNum}Highlights`;
    const ex = `icelandSelfDriveSummer12Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
  ...
  const routeStopDetails = [
    ...
    "瓦特納冰川 → 傑古沙龍冰河湖 → 鑽石沙灘",
    "東部峽灣海岸公路 → 東部住宿",
    "黛提瀑布 → 胡薩維克（出海觀鯨可選）→ 北部住宿",
    "米湖 → 眾神瀑布 → 阿克雷里 → 北部",
    "西部沿途風光",
    "西部白銀圈（德爾達拉通加 → 熔岩瀑布 → 兒童瀑布）",
...
import {
  icelandSelfDriveSummer12Day1Highlights,
  icelandSelfDriveSummer12Day1OptionalActivities,
} from "./iceland-self-drive-summer-12-day1-cards";
import {
  icelandSelfDriveSummer12Day2Highlights,
  icelandSelfDriveSummer12Day2OptionalActivities,
  icelandSelfDriveSummer12Day3Highlights,
  icelandSelfDriveSummer12Day3OptionalActivities,
  icelandSelfDriveSummer12Day4Highlights,
  icelandSelfDriveSummer12Day4OptionalActivities,
  icelandSelfDriveSummer12Day5Highlights,
  icelandSelfDriveSummer12Day5OptionalActivities,
  icelandSelfDriveSummer12Day6Highlights,
  icelandSelfDriveSummer12Day6OptionalActivities,
  icelandSelfDriveSummer12Day7Highlights,
  icelandSelfDriveSummer12Day7OptionalActivities,
  icelandSelfDriveSummer12Day8Highlights,
  icelandSelfDriveSummer12Day8OptionalActivities,
  icelandSelfDriveSummer12Day9Highlights,
  icelandSelfDriveSummer12Day9OptionalActivities,
  icelandSelfDriveSummer12Day10Highlights,
  icelandSelfDriveSummer12Day10OptionalActivities,
  icelandSelfDriveSummer12Day11Highlights,
  icelandSelfDriveSummer12Day11OptionalActivities,
  icelandSelfDriveSummer12Day12Highlights,
  icelandSelfDriveSummer12Day12OptionalActivities,
} from "./iceland-self-drive-summer-12-days2-12-cards";

export const icelandSelfDriveSummer12: TripPackage = {
  id: "iceland-self-drive-summer-12",
  tripKey: "iceland/self-drive/summer/12",
  slug: "12-days-summer-self-drive-around-iceland-in-depth",
  tourCode: "SSD-121",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-12-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer12Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-12-days2-12-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer12Day2Highlights",
      items: dayData["黄金圈"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day2OptionalActivities",
      items: dayData["黄金圈"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day3Highlights",
      items: dayData["南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day3OptionalActivities",
      items: dayData["南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day4Highlights",
      items: dayData["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day4OptionalActivities",
      items: dayData["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day5Highlights",
      items: dayData["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day5OptionalActivities",
      items: dayData["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day6Highlights",
      items: dayData["黛提瀑布+胡萨维克"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day6OptionalActivities",
      items: dayData["黛提瀑布+胡萨维克"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day7Highlights",
      items: dayData["米湖+众神瀑布+阿克雷里"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day7OptionalActivities",
      items: dayData["米湖+众神瀑布+阿克雷里"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day8Highlights",
      items: dayData["西部沿途风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day8OptionalActivities",
      items: dayData["西部沿途风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day9Highlights",
      items: dayData["西部白银圈"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day9OptionalActivities",
      items: dayData["西部白银圈"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day10Highlights",
      items: dayData["斯奈山半岛"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day10OptionalActivities",
      items: dayData["斯奈山半岛"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day11Highlights",
      items: dayData["雷克雅未克自由行"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day11OptionalActivities",
      items: dayData["雷克雅未克自由行"].extras,
    },
    {
      name: "icelandSelfDriveSummer12Day12Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer12Day12OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-12.ts"),
