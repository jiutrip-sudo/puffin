...
import { icelandSelfDriveSummer13Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-13";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer13Pricing,
    corivo: { ...icelandSelfDriveSummer13Pricing.corivo! },
  };
