...
import { icelandSelfDriveSummer10Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-10";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer10Pricing,
    corivo: { ...icelandSelfDriveSummer10Pricing.corivo! },
  };
