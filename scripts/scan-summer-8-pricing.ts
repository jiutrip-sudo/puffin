...
import { icelandSelfDriveSummer8Pricing } from "../lib/trip-pricing/iceland-self-drive-summer-8";
...
async function main() {
  const config = {
    ...icelandSelfDriveSummer8Pricing,
    corivo: { ...icelandSelfDriveSummer8Pricing.corivo! },
  };
