...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-11-live.html");
const IMG_BASE =
...
function extractPackageMeta(decoded) {
  const headerMatch = decoded.match(
    /"header":\{"title":"([^"]+)","images":\[([\s\S]*?)\],"days":11,"nights":10/,
  );
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandSelfDriveSummer11Day${dayNum}Highlights`;
    const ex = `icelandSelfDriveSummer11Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-11-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer11Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-11-days2-11-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer11Day2Highlights",
      items: dayData["黄金圈之旅"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day2OptionalActivities",
      items: dayData["黄金圈之旅"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day3Highlights",
      items: dayData["冰岛南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day3OptionalActivities",
      items: dayData["冰岛南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day4Highlights",
      items: dayData["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day4OptionalActivities",
      items: dayData["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day5Highlights",
      items: dayData["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day5OptionalActivities",
      items: dayData["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day6Highlights",
      items: dayData["米湖、黛提瀑布、胡萨维克"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day6OptionalActivities",
      items: dayData["米湖、黛提瀑布、胡萨维克"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day7Highlights",
      items: dayData["众神瀑布、阿克雷里"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day7OptionalActivities",
      items: dayData["众神瀑布、阿克雷里"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day8Highlights",
      items: dayData["西部沿途风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day8OptionalActivities",
      items: dayData["西部沿途风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day9Highlights",
      items: dayData["斯奈山半岛"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day9OptionalActivities",
      items: dayData["斯奈山半岛"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day10Highlights",
      items: dayData["首都自由行"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day10OptionalActivities",
      items: dayData["首都自由行"].extras,
    },
    {
      name: "icelandSelfDriveSummer11Day11Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer11Day11OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-11.ts"),
