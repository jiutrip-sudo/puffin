...
import { icelandSelfDriveWinter9Pricing } from "../lib/trip-pricing/iceland-self-drive-winter-9";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter9Pricing,
    corivo: { ...icelandSelfDriveWinter9Pricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-9",
