...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-group-7-live.html");
const IMG_BASE =
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandGroupSummer7Day${dayNum}Highlights`;
    const ex = `icelandGroupSummer7Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-summer-7-day1-cards.ts"),
  renderExports([
    {
      name: "icelandGroupSummer7Day1Highlights",
      items: dayData["入境日：雷克雅未克 & Sky Lagoon温泉"].highlights,
    },
    {
      name: "icelandGroupSummer7Day1OptionalActivities",
      items: dayData["入境日：雷克雅未克 & Sky Lagoon温泉"].extras,
    },
  ]),
);

const DAY2 = "黄金圈经典路线";
const DAY3 = "冰岛南岸：瀑布 & 冰川徒步 & 黑沙滩";
const DAY4 = "杰古沙龙冰河湖 & 钻石沙滩 ";
const DAY5 = "斯奈山半岛深度环游";
const DAY6 = "自由活动日（可选内陆徒步）";

fs.writeFileSync(
  path.join(outDir, "iceland-group-summer-7-days2-7-cards.ts"),
  renderExports([
    {
      name: "icelandGroupSummer7Day2Highlights",
      items: dayData[DAY2].highlights,
    },
    {
      name: "icelandGroupSummer7Day2OptionalActivities",
      items: dayData[DAY2].extras,
    },
    {
      name: "icelandGroupSummer7Day3Highlights",
      items: dayData[DAY3].highlights,
    },
    {
      name: "icelandGroupSummer7Day3OptionalActivities",
      items: dayData[DAY3].extras,
    },
    {
      name: "icelandGroupSummer7Day4Highlights",
      items: dayData[DAY4].highlights,
    },
    {
      name: "icelandGroupSummer7Day4OptionalActivities",
      items: dayData[DAY4].extras,
    },
    {
      name: "icelandGroupSummer7Day5Highlights",
      items: dayData[DAY5].highlights,
    },
    {
      name: "icelandGroupSummer7Day5OptionalActivities",
      items: dayData[DAY5].extras,
    },
    {
      name: "icelandGroupSummer7Day6Highlights",
      items: dayData[DAY6].highlights,
    },
    {
      name: "icelandGroupSummer7Day6OptionalActivities",
      items: dayData[DAY6].extras,
    },
    {
      name: "icelandGroupSummer7Day7Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandGroupSummer7Day7OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-group-summer-7.ts"),
