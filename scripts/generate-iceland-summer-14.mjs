...
const SLM_HTML =
  process.env.SLM_HTML ?? path.join(ROOT, "tmp/slm-summer-14-live.html");
const IMG_BASE =
...
function extractPackageMeta(decoded) {
  const headerMatch = decoded.match(
    /"header":\{"title":"([^"]+)","images":\[([\s\S]*?)\],"days":14,"nights":13/,
  );
...
function renderPackage(meta, dayData) {
  ...
  const itineraryDays = meta.days.map((day, index) => {
    ...
    const hl = `icelandSelfDriveSummer14Day${dayNum}Highlights`;
    const ex = `icelandSelfDriveSummer14Day${dayNum}OptionalActivities`;
    return `    {
      day: ${dayNum},
      title: "${esc(title)}",
  ...
  const routeStopDetails = [
    ...
    "米湖地熱區 → 眾神瀑布 → 阿克雷里",
    "西北沿途風光（巨魔半島 → 西峽灣入口）",
    "西峽灣探險 Day 1（伊薩菲厄澤 → 帕特雷克斯峽灣）",
    "西峽灣探險 Day 2（勞特拉爾角海鳥崖 → 丁堅地瀑布）",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-14-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer14Day1Highlights",
      items: dayData["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-14-days2-14-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveSummer14Day2Highlights",
      items: dayData["黄金圈"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day2OptionalActivities",
      items: dayData["黄金圈"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day3Highlights",
      items: dayData["南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day3OptionalActivities",
      items: dayData["南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day4Highlights",
      items: dayData["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day4OptionalActivities",
      items: dayData["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day5Highlights",
      items: dayData["东部峡湾风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day5OptionalActivities",
      items: dayData["东部峡湾风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day6Highlights",
      items: dayData["黛提瀑布、胡萨维克观鲸"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day6OptionalActivities",
      items: dayData["黛提瀑布、胡萨维克观鲸"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day7Highlights",
      items: dayData["米湖、阿克雷里"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day7OptionalActivities",
      items: dayData["米湖、阿克雷里"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day8Highlights",
      items: dayData["西北沿途风光"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day8OptionalActivities",
      items: dayData["西北沿途风光"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day9Highlights",
      items: dayData["西峡湾探险Day1"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day9OptionalActivities",
      items: dayData["西峡湾探险Day1"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day10Highlights",
      items: dayData["西峡湾探险Day2"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day10OptionalActivities",
      items: dayData["西峡湾探险Day2"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day11Highlights",
      items: dayData["斯奈山半岛"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day11OptionalActivities",
      items: dayData["斯奈山半岛"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day12Highlights",
      items: dayData["西部白银圈"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day12OptionalActivities",
      items: dayData["西部白银圈"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day13Highlights",
      items: dayData["雷克雅未克自由行"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day13OptionalActivities",
      items: dayData["雷克雅未克自由行"].extras,
    },
    {
      name: "icelandSelfDriveSummer14Day14Highlights",
      items: dayData["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveSummer14Day14OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-summer-14.ts"),
