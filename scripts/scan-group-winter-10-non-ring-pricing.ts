...
import { icelandGroupWinter10NonRingPricing } from "../lib/trip-pricing/iceland-group-winter-10-non-ring";
...
async function main() {
  const config = {
    ...icelandGroupWinter10NonRingPricing,
    corivo: { ...icelandGroupWinter10NonRingPricing.corivo! },
  };
