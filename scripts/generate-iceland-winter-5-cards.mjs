...
const SLM_HTML = process.env.SLM_HTML ?? "/tmp/slm-winter-5.html";
const IMG_BASE =
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-5-day1-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter5Day1Highlights",
      items: data["入境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter5Day1OptionalActivities",
...
fs.writeFileSync(
  path.join(outDir, "iceland-self-drive-winter-5-days2-5-cards.ts"),
  renderExports([
    {
      name: "icelandSelfDriveWinter5Day2Highlights",
      items: data["冰岛南岸风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter5Day2OptionalActivities",
      items: data["冰岛南岸风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter5Day3Highlights",
      items: data["冰河湖风光"].highlights,
    },
    {
      name: "icelandSelfDriveWinter5Day3OptionalActivities",
      items: data["冰河湖风光"].extras,
    },
    {
      name: "icelandSelfDriveWinter5Day4Highlights",
      items: data["黄金圈"].highlights,
    },
    {
      name: "icelandSelfDriveWinter5Day4OptionalActivities",
      items: data["黄金圈"].extras,
    },
    {
      name: "icelandSelfDriveWinter5Day5Highlights",
      items: data["离境日"].highlights,
    },
    {
      name: "icelandSelfDriveWinter5Day5OptionalActivities",
