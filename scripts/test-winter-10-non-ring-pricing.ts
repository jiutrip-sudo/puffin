...
import { icelandSelfDriveWinter10NonRingPricing } from "../lib/trip-pricing/iceland-self-drive-winter-10-non-ring";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter10NonRingPricing,
    corivo: { ...icelandSelfDriveWinter10NonRingPricing.corivo! },
  };
  const input = {
    packageId: "iceland-self-drive-winter-10-non-ring",
