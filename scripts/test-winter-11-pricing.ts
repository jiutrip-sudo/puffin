...
import { icelandSelfDriveWinter11Pricing } from "../lib/trip-pricing/iceland-self-drive-winter-11";
...
async function main() {
  const config = {
    ...icelandSelfDriveWinter11Pricing,
    corivo: { ...icelandSelfDriveWinter11Pricing.corivo! },
  };
  const input = {
