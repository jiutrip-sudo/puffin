...
export const icelandSelfDriveWinter9NonRingDay3Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    nameEn: "Svartifoss",
    region: "冰島東部",
    subtitle: "如果你去過雷克雅未克大教堂，那你一定會覺得這裡看起來很眼熟！",
...
export const icelandSelfDriveWinter9NonRingDay8Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Laugavegur購物街是冰島雷克雅未克市中心最古老的商業主街，全長約2公里，從哈爾格林姆斯大教堂（Hallgrímskirkja）向東南延伸至舊港區。街道名稱意為“洗衣路”，源於19世紀婦女在此取溫泉熱水洗衣的歷史，如今已成為冰島本土設計、手工藝與北歐時尚的集中地。",
      "Laugavegur的歷史可追溯至1885年，最初是連接溫泉洗衣池與居民區的小徑。20世紀初，隨著雷克雅未克城市化發展，街道兩側逐漸出現木結構商店。1950年代鋪上瀝青路面後，Laugavegur成為冰島第一條現代化商業街。如今保留著部分19世紀末建築，如15號的紅色木屋（現為咖啡館），外牆仍可見當年的馬廄拴馬鐵環。",
      ...
      "Laugavegur商業街見證了冰島從漁業社會到設計之都的轉型，正如當地諺語所說：“想讀懂雷克雅未克，先走九遍Laugavegur。”",
    ],
  },
];
