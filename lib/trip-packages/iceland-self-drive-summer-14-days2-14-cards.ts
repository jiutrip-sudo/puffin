...
export const icelandSelfDriveSummer14Day9Highlights: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "伊薩菲厄澤的交通",
      "伊薩菲厄澤可以輕鬆地駕車抵達。對於自駕旅客，如果從雷克雅維克出發順時針環島，前往伊薩菲厄澤沿著1號公路向北出發，拐入60號公路，隨後駛入61號公路即可到達，大約需要不到6小時的時間，中途會經過冰島西部和西峽灣的許多景點。",
      "如果您選擇逆時針環島，那麼從阿克雷里（Akureyri）或布倫迪歐斯（Blönduós）出發，沿著1號公路向西，拐入68號公路後，再駛入61公路即可到達。",
      "如果不想自駕，您也可以乘坐從雷克雅維克國內機場出發的航班飛往伊薩菲厄澤，航班日均2-3班，飛行時間僅需約50分鐘。",
