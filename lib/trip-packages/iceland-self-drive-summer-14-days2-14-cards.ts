...
export const icelandSelfDriveSummer14Day5Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "戶外活動",
      "在塞濟斯菲厄澤，人們可以近距離地接觸陡峭的高山和廣闊的大海。夏季，有眾多戶外活動供旅客選擇，從短途健行到長達一天的健行或航海探險。仲冬時節，各類滑雪愛好者也能在這裡找到心儀的滑雪場地。",
...
export const icelandSelfDriveSummer14Day7Highlights: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "Námafjall地熱區提供一條健行路線，長2.5公里，爬升約100米，健行時間約為1小時。健行到路線盡頭，旅客能夠獲得一個全新的視野，同時也能避開大量的人群，從高處俯瞰火星似的Námafjall地熱區，還能瞥見遠處靜靜的米湖。",
    ],
  },
  {
    name: "Grjótagjá洞穴",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "現如今，這裡已經被修繕成了一個適合健行的公園，有著眾多長度不一的健行路線。健行路線都不太考驗體能，最長的一條只需幾個小時即可走完。但是由於黑暗城堡內地形十分複雜，容易迷路，所以請事先查詢好路線，並緊緊跟隨路標指示。",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Skútustaðagígar偽火山口是在大約 2300 年前形成的。當附近的Lúdentaborgir 和 Þrengslaborgir 火山噴發時，滾燙的熔岩流過涼爽潮濕的地面，並對地表施壓。在熔岩的重壓下，蒸汽被困，產生極大的壓力。當壓力過大時，就會引發蒸汽爆炸，造成地面凹陷，形成了這些以假亂真的偽火山口。",
      ...
      "偽火山口與米湖濕地的風景融為一體，連綿起伏、風景如畫，特別受到攝影師和旅客的歡迎。這裡還是觀鳥的寶地之一，作為自然保護區，附近水域常年棲息著各種珍奇的鳥類和鴨子，據統計可以觀賞到近 150 種鳥類，因此也吸引著來自世界各地的觀鳥者和自然愛好者前來拜訪。",
    ],
  },
  {
    name: "眾神瀑布",
...
export const icelandSelfDriveSummer14Day13OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "遊覽完之後，嚮導會召集大家返回電梯，重返地面。回到地面以後還有一頓美味的羊肉湯等待大家（也供應素食湯）。吃完美味的餐食，健行返回便可以為這一天畫上完美句點。",
      "集合地點及時間：",
      "最低參加年齡：",
      "行程時長：",
      "行程包括：",
