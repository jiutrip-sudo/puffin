...
export const icelandSelfDriveSummer14Day3OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 如您需要從雷克雅維克出發的卡特拉冰洞探險，請您諮詢帕芬假期旅行後台客服。",
      "體驗時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveSummer14Day4OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 請提前30分鐘在約定集合地點等待。",
      "3. 所有冒險旅行和戶外活動都取決於天氣和路況，我們擁有更改或取消您的旅行的權利，以確保您的安全。具體取消條款請參照帕芬假期旅行服務條款。",
      "體驗包含：",
      "攜帶建議：",
    ],
  },
...
export const icelandSelfDriveSummer14Day6OptionalActivities: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "2. 胡薩維克觀鯨的成功率高達99%，但仍然無法確保您一定能在參團時看到鯨魚。如果旅途中沒有看到任何鯨魚或海豚，您可以免費再獲得一次參加觀鯨旅行團的機會。我們將盡力為您安排參加仍有空位的觀鯨旅行團，為您提供一張新的參團票據。本張票據不得轉讓，僅供原票據的持有者使用，具體參見帕芬假期旅行服務條款，聯繫後台客服諮詢。",
      "注意事項：",
      "行程時長：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveSummer14Day13OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 鯨魚和海豚等海洋生物的行蹤不可控，是否能幸運地看到鯨魚，不僅需要專業人士預測他們的行蹤，還要考慮其他因素，例如：天氣、海況等；若您參團後未看到鯨魚，我們將根據情況額外提供一次免費參團觀鯨機會，具體請您參見帕芬假期旅行的服務條款，詳情請聯繫後台客服。",
