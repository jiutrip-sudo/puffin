...
import { geoseaSpot } from "./spots/geosea";
...
import { vokBathsSpot } from "./spots/vok-baths";
...
import { isafjordurSpot } from "./spots/isafjordur";
import { studlagilSpot } from "./spots/studlagil";
import { hvitserkurSpot } from "./spots/hvitserkur";
...
import { djupivogurSpot } from "./spots/djupivogur";
import { grjotagjaSpot } from "./spots/grjotagja";
import { dettifossSpot } from "./spots/dettifoss";
import { husavikSpot } from "./spots/husavik";
import { hofnSpot } from "./spots/hofn";
import { kirkjufellsfossSpot } from "./spots/kirkjufellsfoss";
import { dimmuborgirSpot } from "./spots/dimmuborgir";
...
import { seydisfjordurSpot } from "./spots/seydisfjordur";
import { keflavikAirportSpot } from "./spots/keflavik-airport";
import { namafjallSpot } from "./spots/namafjall";
...
export const icelandSelfDriveSummer14Day2Highlights: TripAttraction[] = [
    thingvellirSpot,
    geysirSpot,
    gullfossSpot,
...
export const icelandSelfDriveSummer14Day2OptionalActivities: TripAttraction[] = [
    snowmobileLangjokullSpot,silfraSnorkelingSelfDriveSpot,
    fontanaSpot,
    geothermalHorseRidingSpot,laugarasLagoonSpot,
];

export const icelandSelfDriveSummer14Day3Highlights: TripAttraction[] = [
    seljalandsfossSpot,
    gljufrabuiSpot,skogafossSpot,
    planeWreckSpot,reynisfjaraSpot,
    dyrholaeySpot,reynisdrangarSpot,
    vikSpot,
];

export const icelandSelfDriveSummer14Day3OptionalActivities: TripAttraction[] = [
    solheimajokullGlacierHikingSpot,
    reynisfjaraAtvSpot,planeWreckShuttleSpot,katlaIceCaveSpot,vikLavaShowSpot,
    vikHorseRidingSpot,
];

export const icelandSelfDriveSummer14Day4Highlights: TripAttraction[] = [
    eldhraunSpot,vatnajokullSpot,
    skaftafellSpot,jokulsarlonSpot,
    diamondBeachSpot,
    hofnSpot,
];

export const icelandSelfDriveSummer14Day4OptionalActivities: TripAttraction[] = [
    skaftafellGlacierHikingSpot,
    jokulsarlonAmphibianBoatSpot,
    jokulsarlonKayakSpot,
    jokulsarlonZodiacBoatSpot,
    fjallsarlonBoatSpot,
];

export const icelandSelfDriveSummer14Day5Highlights: TripAttraction[] = [
    vestrahornSpot,
    djupivogurSpot,
    faskrudsfjordurSpot,seydisfjordurSpot,egilsstadirSpot,
];

export const icelandSelfDriveSummer14Day5OptionalActivities: TripAttraction[] = [
    vokBathsSpot,
];

export const icelandSelfDriveSummer14Day6Highlights: TripAttraction[] = [
    studlagilSpot,dettifossSpot,husavikSpot,myvatnSpot,
    myvatnGeothermalSpot,
];

export const icelandSelfDriveSummer14Day6OptionalActivities: TripAttraction[] = [
    husavikWhaleWatchingSpot,
    geoseaSpot,myvatnNatureBathsSpot,
];

export const icelandSelfDriveSummer14Day7Highlights: TripAttraction[] = [
    namafjallSpot,
    grjotagjaSpot,myvatnSpot,
    dimmuborgirSpot,skutustadagigarSpot,godafossSpot,
    akureyriSpot,
    akureyrarkirkjaSpot,
    akureyriBotanicalGardenSpot,
];

export const icelandSelfDriveSummer14Day7OptionalActivities: TripAttraction[] = [
    myvatnNatureBathsSpot,
];

export const icelandSelfDriveSummer14Day8Highlights: TripAttraction[] = [
    blonduosSpot,
    hvitserkurSpot,hvammstangiSpot,
];

export const icelandSelfDriveSummer14Day8OptionalActivities: TripAttraction[] = [

];

export const icelandSelfDriveSummer14Day9Highlights: TripAttraction[] = [
    isafjordurSpot,
];

export const icelandSelfDriveSummer14Day9OptionalActivities: TripAttraction[] = [

];

export const icelandSelfDriveSummer14Day10Highlights: TripAttraction[] = [
    latrabjargSpot,
];

export const icelandSelfDriveSummer14Day10OptionalActivities: TripAttraction[] = [

];

export const icelandSelfDriveSummer14Day11Highlights: TripAttraction[] = [
    stykkisholmurSpot,kirkjufellSpot,
    kirkjufellsfossSpot,djupalonssandurSpot,
    londrangarSpot,arnarstapiSpot,budakirkjaSpot,
    ytriTungaSpot,
    borgarnesSpot,
];

export const icelandSelfDriveSummer14Day11OptionalActivities: TripAttraction[] = [
    vatnshellirCaveSpot,
];

export const icelandSelfDriveSummer14Day12Highlights: TripAttraction[] = [
    deildartunguhverSpot,
    reykholtSpot,hraunfossarSpot,
    barnafossSpot,
];

export const icelandSelfDriveSummer14Day12OptionalActivities: TripAttraction[] = [
    kraumaSpot,vidgelmirLavaCaveSpot,langjokullIceTunnelSpot,
    hvammsvikTicketSpot,
];

export const icelandSelfDriveSummer14Day13Highlights: TripAttraction[] = [
    oldHarbourSpot,harpaSpot,
    sunVoyagerSpot,
    baejarinsBeztuSpot,phallologicalMuseumSpot,
];

export const icelandSelfDriveSummer14Day13OptionalActivities: TripAttraction[] = [
    skyLagoonTicketSpot,blueLagoonComfortSpot,
    reykjavikWhaleWatchingSpot,
    reykjavikSeaAnglingSpot,insideVolcanoSpot,flyoverIcelandSpot,
    reykjavikLavaShowSpot,
    perlanMuseumSpot,
];

export const icelandSelfDriveSummer14Day14Highlights: TripAttraction[] = [
    reykjavikSpot,
    keflavikAirportSpot,
];

export const icelandSelfDriveSummer14Day14OptionalActivities: TripAttraction[] = [
    flyoverIcelandSpot,
    reykjavikLavaShowSpot,
    perlanMuseumSpot,
];
