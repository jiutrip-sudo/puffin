...
export const icelandSelfDriveWinter7: TripPackage = {
  ...
  intro: {
    summary:
      "這個 7 天 6 夜冰島西南岸冬季自駕遊，帶您在一週內自駕玩遍南岸、冰河湖、黃金圈與斯奈山半島，並有機會追尋極光。",
    full: `這個 7 天 6 夜冰島西南岸冬季自駕遊，是冬季自駕的熱門之選。行程充分考量冬季日照與路況，節奏適中，涵蓋南岸一號公路、傑古沙龍冰河湖、鑽石沙灘、南岸小眾景點、黃金圈三大景點，以及被稱為「冰島縮影」的斯奈山半島。

途中可搭配冰川徒步、冰河湖船遊、藍冰洞探險、溫泉體驗等自選活動，靈活掌握行程節奏。預訂後您將收到專屬中文路書，並可依天氣安排極光觀測路線，輕鬆收穫冰島冬日美景。`,
  },
  gallery: [
    {
      id: "kirkjufell",
  ...
  routeStops: [
    ...
    { label: "第 7 天", detail: "雷克雅未克市區（可選）→ 機場離境" },
  ],
  routeMap: {
    waypoints: [
      {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "前往凱夫拉維克國際機場還車離境。若航班較晚，可在雷克雅未克市區最後走走逛逛，或造訪哈帕音樂廳、托寧湖等市區景點。我們歡迎您下次再來冰島！",
