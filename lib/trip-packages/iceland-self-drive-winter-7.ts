...
import {
  icelandSelfDriveWinter7Day1Highlights,
  icelandSelfDriveWinter7Day1OptionalActivities,
} from "./iceland-self-drive-winter-7-day1-cards";
import {
  icelandSelfDriveWinter7Day2Highlights,
  icelandSelfDriveWinter7Day2OptionalActivities,
  icelandSelfDriveWinter7Day3Highlights,
  icelandSelfDriveWinter7Day3OptionalActivities,
  icelandSelfDriveWinter7Day4Highlights,
  icelandSelfDriveWinter7Day4OptionalActivities,
  icelandSelfDriveWinter7Day5Highlights,
  icelandSelfDriveWinter7Day5OptionalActivities,
  icelandSelfDriveWinter7Day6Highlights,
  icelandSelfDriveWinter7Day6OptionalActivities,
  icelandSelfDriveWinter7Day7Highlights,
  icelandSelfDriveWinter7Day7OptionalActivities,
} from "./iceland-self-drive-winter-7-days2-7-cards";

export const icelandSelfDriveWinter7: TripPackage = {
  ...
  backLabel: "返回冬季自駕",
  heroImage:
    "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1920,q_auto:good/Kirkjufell1_053dfbdc9a.jpg",
  whyChooseUs: [
    {
      id: "deposit",
      title: "20% 訂金",
  ...
  intro: {
    summary:
      "這個 7 天 6 夜冰島西南岸冬季自駕遊讓您在一週內盡覽冰島最熱門景區，涵蓋三大國家公園、黃金圈與斯奈山半島，並有機會看見舞動的北極光。行程充分顧及冬季日照與路況，節奏適中、安排務實。",
    full: `這個 7 天 6 夜冰島西南岸冬季自駕遊讓您在一週內盡覽冰島最熱門景區，涵蓋三大國家公園、黃金圈與斯奈山半島，並有機會看見舞動的北極光。套餐充分顧及冬季日照時數與路況，行程安排合理、節奏適中。

若您熱愛攝影，這趟旅程更是絕佳選擇：在遠離光害的地區有機會拍下絢麗極光，並造訪辛格維利爾國家公園（Þingvellir National Park）、蓋錫爾間歇泉地帶（Geysir）、黃金瀑布（Gullfoss）、鑽石沙灘（Diamond Beach）與南岸瀑布等經典景點，滿足您對冰島自然風光的想像。

您將近距離感受巨大冰川與潔白雪山，見證傑古沙龍冰河湖（Jökulsárlón）上千年浮冰漂流，海豹偶爾在冰塊上休憩。西部還可探索「冰島縮影」斯奈山半島（Snæfellsnes），於教會山（Kirkjufell）留影——這裡是《權力遊戲》取景地，也是風光攝影愛好者的必訪景點；天候許可時，更有機會在此欣賞北極光。

途中亦可另行加購雪地摩托、藍冰洞探險、冰川健行、絲浮拉裂谷（Silfra）浮潛等冬季體驗，或於自駕途中造訪小眾溫泉。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島冬季精華。`,
  },
  gallery: [
    {
      id: "kirkjufell",
  ...
  routeStops: [
    ...
    { label: "第 6 天", detail: "斯奈山半島（教會山 → 布迪爾 → 漁村海岸）→ 雷克雅維克" },
  ...
  itinerary: [
    {
      ...
      highlights: icelandSelfDriveWinter7Day1Highlights,
      optionalActivities: icelandSelfDriveWinter7Day1OptionalActivities,
    },
    {
      day: 2,
      title: "冰島南岸風光",
      accommodation: "南岸",
      description:
        "今天請一早出發，沿冰島南岸一號公路南下。冬季南岸色調獨特：白雪覆蓋大地、天際染上一抹粉霞，為旅程增添溫暖氣息。\n\n首先來到塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；冬季基於安全考量，塞里雅蘭瀑布後方小徑通常封閉。繼續南下造訪黑沙灘（Reynisfjara），沿岸玄武岩石柱層層疊疊，遠處可見雷尼斯岩（Reynisdrangar）矗立海中；沿途亦可安排 DC-3 飛機殘骸，或另行加購冰川健行等戶外體驗。今晚入住南岸附近飯店。",
      highlights: icelandSelfDriveWinter7Day2Highlights,
      optionalActivities: icelandSelfDriveWinter7Day2OptionalActivities,
    },
    {
      day: 3,
      title: "傑古沙龍冰河湖、鑽石沙灘、藍冰洞",
      accommodation: "南岸",
      description:
      ...
      highlights: icelandSelfDriveWinter7Day3Highlights,
      optionalActivities: icelandSelfDriveWinter7Day3OptionalActivities,
    },
    {
      day: 4,
      title: "南岸小眾景點",
      ...
      highlights: icelandSelfDriveWinter7Day4Highlights,
      optionalActivities: icelandSelfDriveWinter7Day4OptionalActivities,
    },
    {
      day: 5,
      title: "黃金圈之旅",
      accommodation: "西部",
      description:
        "今日造訪冰島最著名的黃金圈路線，依序遊覽辛格維利爾國家公園、蓋錫爾間歇泉地帶與黃金瀑布（Gullfoss）三大景點。之後繼續西行，可造訪熔岩瀑布（Hraunfossar）、兒童瀑布（Barnafoss）等西部特色景觀。今晚入住西部。",
      highlights: icelandSelfDriveWinter7Day5Highlights,
      optionalActivities: icelandSelfDriveWinter7Day5OptionalActivities,
    },
    {
      day: 6,
      title: "斯奈山半島",
      ...
      highlights: icelandSelfDriveWinter7Day6Highlights,
      optionalActivities: icelandSelfDriveWinter7Day6OptionalActivities,
    },
    {
      day: 7,
      title: "離境日",
      accommodation: "—",
      description:
        "歡樂時光總是過得特別快。今天是離境日，請預留時間前往凱夫拉維克國際機場辦理還車與退稅。若班機時間較晚，可在雷克雅維克市區多留片刻，造訪哈帕音樂廳、托寧湖（Tjörnin）等景點。期待您下次再來冰島！",
      highlights: icelandSelfDriveWinter7Day7Highlights,
      optionalActivities: icelandSelfDriveWinter7Day7OptionalActivities,
    },
  ],
  inclusions: {
    included: [
      "專業行程策劃師為您獨家客製的中文行程手冊（包含冰島駕駛實用資訊，以及各類景點、歷史、文化和自然等資訊描述）",
      "6 整天租車（多種車型可選，包含 CDW 碰撞險）",
      "冰島行程期間 6 晚住宿",
      "簽證輔助行程單材料提供",
      "台灣冰島雙時區服務",
      "VAT 增值稅",
