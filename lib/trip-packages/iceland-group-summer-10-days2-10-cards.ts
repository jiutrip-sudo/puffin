...
export const icelandGroupSummer10Day2Highlights: TripAttraction[] = [
  {
    name: "辛格維利爾國家公園",
...
export const icelandGroupSummer10Day2OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer10Day3Highlights: TripAttraction[] = [
  {
    name: "塞里雅蘭瀑布",
...
export const icelandGroupSummer10Day3OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer10Day4Highlights: TripAttraction[] = [
  {
    name: "傑古沙龍冰河湖",
    nameEn: "Jökulsárlón",
    region: "冰島東部",
...
export const icelandGroupSummer10Day4OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer10Day5Highlights: TripAttraction[] = [
  {
    name: "格蘭尼瀑布",
...
export const icelandGroupSummer10Day5OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer10Day6Highlights: TripAttraction[] = [
  {
    name: "教會山",
    nameEn: "Kirkjufell",
    region: "斯奈山半島",
...
export const icelandGroupSummer10Day6OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer10Day7Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克經典觀鯨",
    region: "雷克雅未克",
    ...
    paragraphs: [
      "最理想的首都觀鯨體驗",
      "雷克雅未克附近的海域可以看到眾多不同的鯨魚和海豚，例如小鬚鯨、座頭鯨、白喙海豚和鼠海豚等等，是冰島出海觀賞鯨魚最方便的選擇之一。在自然棲息地親眼看到這些標誌性的海洋生物自由跳躍，與您在水族館的透明玻璃中的感受將會截然不同。",
      "您將自行前往雷克雅未克的老港口參加出海觀鯨項目，該地點屬於雷克雅未克市區範圍，距離各大景點和主要街道步行距離可達。",
      "您將乘坐冰島最大的觀鯨船之一，從雷克雅未克出發，駛入大西洋，感受揚帆起航、海風吹拂的自在，尋找這些海洋朋友的身影，體驗冰島觀鯨的樂趣。",
  ...
  },
  {
    ...
    paragraphs: [
      "世界唯一能夠進入內部探索的火山",
      "冰島的獨特地質特點之一，就是有著數量眾多的火山，距離雷克雅未克郊外不遠處的Þríhnúkagígur休眠火山，便是全球唯一一個可以進入內部遊覽的火山！",
      "這座火山已經沉睡了4000多年，但是直到1974年才被發現。在2012年建立完善的安全設施後，才正式對外開放。雖然才有10年的運營歷史，就因為它獨一無二的特性，出場即是巔峰，早早晉升為冰島旅行最具特色的景點之一。",
      "本次探險將從雷克雅未克出發，首先前往距離雷克雅未克車程30分鐘的藍山國家公園（Bláfjöll），再徒步前往目的地Þríhnúkagígur火山。兩地之間有3.5km的徒步路程，約45-50分鐘，在嚮導的帶領下，您可以欣賞著周圍的風景，聽著嚮導所講關於火山的趣聞和歷史，這將是一個非常愉快的徒步體驗。",
...
export const icelandGroupSummer10Day7OptionalActivities: TripAttraction[] = [
  {
...
export const icelandGroupSummer10Day8Highlights: TripAttraction[] = [
  {
    name: "辛格維利爾國家公園",
    nameEn: "Þingvellir National Park",
    region: "冰島南部",
  ...
  },
  {
    ...
    paragraphs: [
      "在海景溫泉中，親身感受潮起潮落",
      "Hvammsvík溫泉是一家新興成立的溫泉品牌，它位於鯨魚峽灣（Hvalfjörður），距離雷克雅未克僅需要45分鐘車程，被著名城市生活雜誌TimeOut評為2023年度全世界最值得做的23件事之首。",
  ...
  },
  {
    ...
    region: "冰島南部",
    subtitle: "在歐亞大陸和北美大陸版塊間暢遊，感受不一樣的水下世界",
    ...
    paragraphs: [
      "在冰島的心臟地帶的辛格維利爾國家公園內，隱藏著一個令人歎為觀止的自然奇觀——絲浮拉（Silfra）裂縫。作為地球上為數不多的可以親身體驗板塊分裂的地方，絲浮拉裂縫提供了獨一無二的地質觀察機會。這裡同樣是浮潛愛好者的天堂，水體來自冰川融水，經過多年的過濾，純淨透明，能見度超過100米。您將在藍綠色的水域中，探索地球兩大陸板塊間的神秘裂縫，一個清澈見底、色彩斑斕的水下世界等待著您。",
      "絲浮拉裂縫中的水溫常年保持在2-4攝氏度，浮潛時需要穿著專業的乾式潛水服和裝備。在下水前，您將接受簡短的安全指導和浮潛技巧培訓，在專業嚮導的指引下跟隨其一起開啟您的浮潛之旅。",
      "裂縫中的水清澈透明，陽光透過水麵，形成一道道光束，照亮了你的探索之路。在絲浮拉裂縫中，時間彷彿靜止一般，你能清晰地看到水下的岩石紋理，甚至是遠處的同伴。這種體驗獨一無二，令人難忘。",
      "浮潛結束後，你將被引導回到岸邊，擦乾身體，換好衣物返回。",
      "在絲浮拉浮潛，並不需要潛水經驗或豐富的游泳經驗，但仍需滿足以下條件：",
      "1. 必須會游泳且不懼怕水",
      "2. 身高限制：150cm-200cm，體重限制：45-120kg",
      "3. 最低參加年齡12週歲，若年齡在18歲以下需要監護人陪同",
      "4. 60歲以上參團者，需提供專門的醫療鑑定同意書",
      "5. 45歲以上、有強煙癮、酒癮，需提供專門的醫療鑑定同意書",
      "6. 身體健康，無神經系統、循環系統、呼吸系統及相關疾病病症",
      "7. 孕婦不可參加",
      "8. 英語口語交流無障礙",
      "參團注意事項：",
      "1. 雷克雅未克參團的客人需提前30分鐘在飯店門口或就近巴士站點等待。",
      ...
      "4. 行程的一應變更或取消等具體詳情還請參照大樂旅行社旅行的<a target=",
    ],
  },
];

export const icelandGroupSummer10Day8OptionalActivities: TripAttraction[] = [
  {
    name: "珍珠樓博物館（Perlan Museum）入場票",
    imageUrl: IMG("Perlan_b834e5a735.jpg"),
    galleryImages: [
  ...
  },
  {
    ...
    paragraphs: [
      "本次Hvammsvík溫泉體驗將從雷克雅未克出發，乘坐舒適巴士，遠離城市喧囂，前往這個隱藏在大自然懷抱中的Hvammsvík天然地熱溫泉放鬆身心，享受純粹的溫泉體驗。",
      ...
      "班次：",
      "10:30 從雷克雅未克出發，約14:00從Hvammsvík溫泉返回",
      "17:00 從雷克雅未克出發，約20:30從Hvammsvík溫泉返回",
      "11 月 10 日至 30 日期間",
      "增加一個班次： 14:00 從雷克雅未克出發，約17:30從Hvammsvík溫泉返回",
      "注意事項：",
      "1. 從雷克雅未克前往Hvammsvík溫泉的車程約為 1 小時，往返約需2小時，請您合理安排時間。",
      "2. 建議您攜帶好泳衣和毛巾。",
      "行程時長：",
      "行程包括：",
      "不包括：",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "參團注意事項：",
      "1. 雷克雅未克參團客人需提前30分鐘在飯店門口或就近巴士站點等待。",
      "2. 該活動為乾衣浮潛體驗，建議您穿著貼身保暖的打底裡衣、長於腳踝的襪子，方便和幹潛水衣疊加穿著。並建議您準備一套額外衣物以備不時之需。",
      "3. 該浮潛團最少3人成團，若本次行程參團人數未達到3人，您將提前收到取行程取消通知，還請在行程開始前查看郵箱是否有關於行程的任何變更。",
...
export const icelandGroupSummer10Day9Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克舊港",
...
export const icelandGroupSummer10Day9OptionalActivities: TripAttraction[] = [
  {
    name: "冰島海釣體驗（雷克雅未克出發）",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 此團為16人超級吉普，出發當天於早晨開始在雷克雅未克飯店或巴士站接團（詳情以收到電子票據為準），請提前30分鐘在指定地點等待。返程具體時間由天氣狀況決定。",
      "建議攜帶",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "本次冰川徒步您將從首都雷克雅未克前往索爾黑馬冰川，在去冰川或是從冰川回來的路上，您也將在冰島幾個最壯觀的自然景點：斯科加瀑布（Skógafoss）和塞爾雅蘭瀑布（Seljalandsfoss）停下來參觀，看瀑布奔流而下，晴天時您還能看到彩虹的出現。",
      ...
      "接送須知",
      "一般早上8:00左右從您的飯店或雷克雅未克附近的接送點開始接團，整個接團時間可能需要30分鐘，請您耐心在接送點等候。具體接送時間及接送地點請提前聯繫後台客服諮詢確認。",
      "最低參加年齡：",
      "行程時長：",
      "體驗包括：",
      "不包括：",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "本次旅程將從雷克雅未克出發，乘坐巴士前往西部，途中，您還會感受到熔岩瀑布（Hraunfossar）、兒童瀑布（Barnafossar）別樣秀美及歐洲流速最快的溫泉——德爾達圖赫菲溫泉（Deildartunguhver）的熱氣騰騰、氣氳繚繞。隨後，您將前往集合點，乘坐巨輪雪地卡車前往隧道洞口，一路上，您將被冰島壯觀的冰川景觀所包圍，這種獨特的冒險之旅絕對讓您振奮不已！",
...
export const icelandGroupSummer10Day10Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克",
    nameEn: "Reykjavík",
    region: "雷克雅未克",
...
export const icelandGroupSummer10Day10OptionalActivities: TripAttraction[] = [
  {
    name: "珍珠樓博物館（Perlan Museum）入場票",
    imageUrl: IMG("Perlan_b834e5a735.jpg"),
    galleryImages: [
