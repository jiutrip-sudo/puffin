...
export const icelandGroupSummer10Day7Highlights: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "船上會有專業的嚮導給您講述海洋生物的各種故事，關於它們的種類、棲息地以及現在海洋環境情況等，充滿教育性互動式體驗。同時，嚮導也會為大家尋找鯨魚和海豚的身影，儘可能讓大家不要錯過每一個精彩瞬間！另外，在出海同途中還能看到到各種種類的海鳥，如果正值冰島夏季（5-8月），還可能遇到以呆萌著稱的冰島”國鳥“海鸚puffin。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "本次探險將從雷克雅維克出發，首先前往距離雷克雅維克車程30分鐘的藍山國家公園（Bláfjöll），再健行前往目的地Þríhnúkagígur火山。兩地之間有3.5km的健行路程，約45-50分鐘，在嚮導的帶領下，您可以欣賞著周圍的風景，聽著嚮導所講關於火山的趣聞和歷史，這將是一個非常愉快的健行體驗。",
...
export const icelandGroupSummer10Day9OptionalActivities: TripAttraction[] = [
  ...
  {
    name: "西人島Vestmannaeyjar一日遊：火山健行、欣賞海岸線、觀海鸚",
    ...
    paragraphs: [
      ...
      "西人島最矚目的景點之一是Eldfell火山，它是在1973年的火山噴發中形成的。這座火山散發著神秘的魅力，您將有機會親身踏足歷史的痕跡，並進行一次壯麗的火山健行探險！而除了火山，西人島還擁有諸多令人驚歎的自然景觀，如壯觀的峽灣、奇特的岩石柱以及繁多的海鳥和其他野生動物。作為一個重要的觀鳥地點，您將能夠近距離觀察到那些蠢萌可愛的海鸚。",
      "在這次精彩的一日遊中，我們將帶您前往西人島，探索這個鮮為人知卻令人驚歎的地方。您將遇見冰島的可愛代表——海鸚（Puffin），探索該地區的火山歷史，並進行一次激動人心的火山健行！您還將沉浸在美麗的大海之中，欣賞到神奇的海中小島、迷人的海岸線和令人震撼的大象石景觀。這一切都將帶給您難以忘懷的體驗，讓您的冰島之旅更加豐富多彩。",
      "車輛：",
      "最低參加年齡：",
      "行程包括：",
      "不包括：",
