...
export const icelandGroupSummer10Day9OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "本次冰川健行您將從首都雷克雅維克前往索爾黑馬冰川，在去冰川或是從冰川回來的路上，您也將在冰島幾個最壯觀的自然景點：斯科加瀑布（Skógafoss）和塞爾雅蘭瀑布（Seljalandsfoss）停下來參觀，看瀑布奔流而下，晴天時您還能看到彩虹的出現。",
      "當您抵達索爾黑馬冰川停車場時，一場令人心馳神往的冒險即將展開。您將迎接專業冰川嚮導的指導，他們將為您提供一套專屬的冰川健行裝備，並耐心演示和講解如何正確穿戴以及冰川健行的注意事項。在裝備整齊之後，我們將踏上向索爾黑馬冰川進發的旅程，沿途嚮導將與您分享關於冰川的悠久歷史和獨特地理知識，讓您對這片壯麗冰川的形成和演變有更深入的瞭解。而在抵達索爾黑馬冰川之前，您將穿過一個精心設計的觀景臺，讓您欣賞到絕美的冰川風景，並記錄下這一珍貴的時刻。整個冰川健行活動大約需要2.5-3小時，輕鬆而愉快，適合各類旅行者來體驗。",
      "接送須知",
