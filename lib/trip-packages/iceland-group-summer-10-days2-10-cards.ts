...
export const icelandGroupSummer10Day8Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "絲浮拉裂縫中的水溫常年保持在2-4攝氏，浮潛時需要穿著專業的乾式潛水服和裝備。在下水前，您將接受簡短的安全指導和浮潛技巧培訓，在專業嚮導的指引下跟隨其一起開啟您的浮潛之旅。",
...
export const icelandGroupSummer10Day9OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "當您抵達索爾黑馬冰川停車場時，一場令人心馳神往的冒險即將展開。您將迎接專業冰川嚮導的指導，他們將為您提供一套專屬的冰川健行裝備，並耐心演示和講解如何正確穿戴以及冰川健行的注意事項。在裝備整齊之後，我們將踏上向索爾黑馬冰川進發的旅程，沿途嚮導將與您分享關於冰川的悠久歷史和獨特地理知識，讓您對這片壯麗冰川的形成和演變有更深入的了解。而在抵達索爾黑馬冰川之前，您將穿過一個精心設計的觀景臺，讓您欣賞到絕美的冰川風景，並記錄下這一珍貴的時刻。整個冰川健行活動大約需要2.5-3小時，輕鬆而愉快，適合各類旅行者來體驗。",
      "接送須知",
      "一般早上8:00左右從您的飯店或雷克雅維克附近的接送點開始接團，整個接團時間可能需要30分鐘，請您耐心在接送點等候。具體接送時間及接送地點請提前聯繫後臺客服諮詢確認。",
      "最低參加年齡：",
      "行程時長：",
      "體驗包括：",
      "不包括：",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "在這次探險中，您將由經驗豐富的嚮導帶領，探索迷宮般的冰川內部。步入神秘的冰川隧道，猶如進入一座冰雪宮殿，精緻的冰晶和藍色的冰柱在微光中閃爍，散發出令人陶醉的神秘光芒。透過透明的冰壁，您將目睹到冰川內部隱藏的獨特地貌和冰川的奇觀。您的心靈將被這壯美的景象深深震撼，彷彿置身於童話世界，難以磨滅的回憶將就此誕生。專業嚮導將與您分享關於冰川形成的奇妙過程和冰川生態系統的知識。您將了解到冰川的壯麗背後蘊含的地質奧秘，以及它對地球的重要意義。",
      "行程長度：",
      "最低參加年齡：",
      "行程包括：",
      "不包括：",
