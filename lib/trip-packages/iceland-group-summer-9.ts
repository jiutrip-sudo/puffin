...
西部白銀圈將遊覽熔岩瀑布（Hraunfossar）、德爾達圖赫菲溫泉（Deildartunguhver）與 Víðgelmir 熔岩洞穴；斯奈山半島則造訪教會山（Kirkjufell）與布迪爾黑教堂。行程另安排一日火山內部探險與出海觀鯨，並留有一日雷克雅維克自由行，可另行加購絲浮拉浮潛、溫泉體驗或內陸高地徒步等夏季活動。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊。`,
  },
  gallery: [
    {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "雷克雅維克",
      description:
        "今日為雷克雅維克自由活動日，您可依個人興趣安排行程。建議造訪哈爾格林姆斯大教堂、哈帕音樂廳、國家博物館或雷克雅維克藝術博物館，亦可另行加購騎冰島馬、冰川隧道探險、絲浮拉浮潛或內陸高地徒步等夏季活動。\n\n今晚入住雷克雅維克。",
