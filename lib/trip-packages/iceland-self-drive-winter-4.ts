...
export const icelandSelfDriveWinter4: TripPackage = {
  ...
  intro: {
    summary:
      "這個冬季 4 日自駕套餐是入門首選，不僅能把冬季極致美景盡收眼底，還有機會看見舞動的北極光。行程充分顧及冬季日照與路況，節奏適中、安排務實。",
    full: `這個冬季 4 日自駕套餐是冬季自駕的入門首選，不僅能把冬季極致美景盡收眼底，還有機會看見舞動的北極光。套餐充分顧及冬季日照時數與路況，行程安排合理、節奏適中。南岸動線與黃金圈（Golden Circle）是冰島最熱門的路線；冬季的傑古沙龍冰河湖（Jökulsárlón）、獨一無二的藍冰洞（Blue Ice Cave），以及白雪覆蓋的黃金瀑布（Gullfoss），都是這個季節最值得造訪的風景。

途中您還可選擇戶外體驗，例如在湛藍冰川上徒步、搭乘雪地摩托感受速度與刺激、騎乘鬃毛飄逸的冰島馬，或進入藍冰洞探險，為旅程增添不同樂趣；同時也能靈活掌握停留時間，依自己的步調安排每一天。

完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，沿途景點、人文、歷史與自然皆有詳盡說明，並會依您的班機與行程時間，規劃適合追極光的路線，讓您輕鬆盡享南岸精華。不論是在藍湖溫泉中放鬆身心，或是在黑沙灘聆聽海浪聲，都將留下獨一無二的回憶。`,
  },
  gallery: [
    {
      id: "aurora",
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "雷克雅維克完美地融合了過去與現在，提供了豐富的城市文化生活和自然美景。無論您是想享受便利的都市生活、探索充滿活力的藝術場景，還是深入冰島令人驚嘆的自然風光，雷克雅維克作為您到達冰島的第一站，一定能為您帶來難忘的體驗。",
      ],
    },
  ],
  routeStops: [
