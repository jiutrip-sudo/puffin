...
export const icelandSelfDriveWinter12Day1Highlights: TripAttraction[] = [
    reykjavikSpot,
    hallgrimskirkjaSpot,
    laugavegurSpot,
...
export const icelandSelfDriveWinter12Day1OptionalActivities: TripAttraction[] = [
    skyLagoonTicketSpot,blueLagoonComfortSpot,
    reykjavikWhaleWatchingSpot,
    auroraBoatTourSpot,perlanMuseumSpot,reykjavikLavaShowSpot,flyoverIcelandSpot,
];
