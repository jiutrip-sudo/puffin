...
import {
  icelandSelfDriveWinter9Day1Highlights,
  icelandSelfDriveWinter9Day1OptionalActivities,
} from "./iceland-self-drive-winter-9-day1-cards";
import {
  icelandSelfDriveWinter9Day2Highlights,
  icelandSelfDriveWinter9Day2OptionalActivities,
  icelandSelfDriveWinter9Day3Highlights,
  icelandSelfDriveWinter9Day3OptionalActivities,
  icelandSelfDriveWinter9Day4Highlights,
  icelandSelfDriveWinter9Day4OptionalActivities,
  icelandSelfDriveWinter9Day5Highlights,
  icelandSelfDriveWinter9Day5OptionalActivities,
  icelandSelfDriveWinter9Day6Highlights,
  icelandSelfDriveWinter9Day6OptionalActivities,
  icelandSelfDriveWinter9Day7Highlights,
  icelandSelfDriveWinter9Day7OptionalActivities,
  icelandSelfDriveWinter9Day8Highlights,
  icelandSelfDriveWinter9Day8OptionalActivities,
  icelandSelfDriveWinter9Day9Highlights,
  icelandSelfDriveWinter9Day9OptionalActivities,
} from "./iceland-self-drive-winter-9-days2-9-cards";

export const icelandSelfDriveWinter9: TripPackage = {
  id: "iceland-self-drive-winter-9",
  tripKey: "iceland/self-drive/winter/9",
  ...
  backLabel: "返回 9 日行程",
  heroImage:
    "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1920,q_auto:good/Godafoss_5e28babf27.jpg",
  whyChooseUs: [
    {
      id: "deposit",
      title: "20% 訂金",
  ...
  intro: {
    summary:
      "這個 9 天 8 夜冰島冬季深度環島自駕，沿一號公路環島，深入北部阿克雷里與眾神瀑布，節奏更從容。",
    full: `這個 9 天 8 夜冰島冬季深度環島自駕，比 8 天環島行程多一日，讓您更從容地探索冰島冬日風光。行程涵蓋黃金圈、南岸瀑布與黑沙灘、傑古沙龍冰河湖與鑽石沙灘、東部峽灣、米湖地熱區、北部眾神瀑布與阿克雷里，以及西部風光。

全程由您掌控方向盤，靈活安排冰川徒步、藍冰洞、溫泉等自選活動。預訂後將收到專屬中文路書，冬季亦有機會追尋北極光，盡收冰島環島冬日精華。`,
  },
  gallery: [
    {
      id: "godafoss",
    ...
    {
      id: "akureyri",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/bailey_zindel_f_LO_Qcsqm8_I_unsplash_f73321d3af.jpg",
      alt: "阿克雷里",
      caption: "北部阿克雷里",
    },
    {
      id: "myvatn",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/serge_taeymans_bm_W6q_Ii_K8lc_unsplash_602aed9a86.jpg",
      alt: "米湖",
      caption: "米湖地熱區",
    },
    {
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        "眾神瀑布（Goðafoss）位於冰島北部，是鑽石圈線路上的標誌性景點。冰川河水從弧形懸崖落下，冬季雪景下尤為壯麗。",
        "瀑布名稱源自古老的維京傳說，是北部環島自駕不可錯過的冬日風光。",
      ],
    },
  ],
  routeOverviewSubtitle: "一號公路冬季深度環島自駕動線",
  routeStops: [
    ...
    { label: "第 6 天", detail: "米湖地熱區 → 北部住宿" },
    { label: "第 7 天", detail: "眾神瀑布 → 阿克雷里 → 北部" },
    { label: "第 8 天", detail: "西部風光 → 雷克雅未克" },
  ...
  itinerary: [
    {
      ...
      highlights: icelandSelfDriveWinter9Day1Highlights,
      optionalActivities: icelandSelfDriveWinter9Day1OptionalActivities,
    },
    {
      day: 2,
      title: "黃金圈之旅",
      accommodation: "南岸",
      description:
        "造訪黃金圈三大景點：辛格維利爾國家公園、間歇泉與黃金瀑布。可選擇絲浮拉浮潛、雪地摩托或溫泉體驗，隨後繼續南下前往南岸住宿。",
      highlights: icelandSelfDriveWinter9Day2Highlights,
      optionalActivities: icelandSelfDriveWinter9Day2OptionalActivities,
    },
    {
      day: 3,
      title: "南岸風光",
      ...
      highlights: icelandSelfDriveWinter9Day3Highlights,
      optionalActivities: icelandSelfDriveWinter9Day3OptionalActivities,
    },
    {
      day: 4,
      title: "冰河湖風光",
      ...
      highlights: icelandSelfDriveWinter9Day4Highlights,
      optionalActivities: icelandSelfDriveWinter9Day4OptionalActivities,
    },
    {
      day: 5,
      title: "東部峽灣風光",
      ...
      highlights: icelandSelfDriveWinter9Day5Highlights,
      optionalActivities: icelandSelfDriveWinter9Day5OptionalActivities,
    },
    {
      day: 6,
      title: "米湖地熱區",
      ...
      highlights: icelandSelfDriveWinter9Day6Highlights,
      optionalActivities: icelandSelfDriveWinter9Day6OptionalActivities,
    },
    {
      day: 7,
      title: "北部風光",
      ...
      highlights: icelandSelfDriveWinter9Day7Highlights,
      optionalActivities: icelandSelfDriveWinter9Day7OptionalActivities,
    },
    {
      day: 8,
      title: "西部風光",
      accommodation: "雷克雅未克",
      description:
        "返回首都途中遊覽西部風光：博爾加峽灣（Borgarfjörður）沿線的熔岩瀑布、兒童瀑布等西部特色景觀，傍晚回到雷克雅未克入住。",
      highlights: icelandSelfDriveWinter9Day8Highlights,
      optionalActivities: icelandSelfDriveWinter9Day8OptionalActivities,
    },
    {
      day: 9,
      title: "離境日",
      ...
      highlights: icelandSelfDriveWinter9Day9Highlights,
      optionalActivities: icelandSelfDriveWinter9Day9OptionalActivities,
    },
  ],
  inclusions: {
    included: [
