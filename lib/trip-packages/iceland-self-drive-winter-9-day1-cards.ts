...
export const icelandSelfDriveWinter9Day1Highlights: TripAttraction[] = [
    reykjavikSpot,
    hallgrimskirkjaSpot,
    harpaSpot,
    rainbowStreetSpot,phallologicalMuseumSpot,sunVoyagerSpot,
];

export const icelandSelfDriveWinter9Day1OptionalActivities: TripAttraction[] = [
