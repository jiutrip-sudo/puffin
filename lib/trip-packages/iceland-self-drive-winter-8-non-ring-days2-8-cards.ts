...
export const icelandSelfDriveWinter8NonRingDay4Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "冰島環島之旅第一站的滿分選擇",
      "海拉（Hella）位於冰島南部，距離雷克雅未克約95公里，處於塞爾福斯（Selfoss）與霍爾斯沃德呂爾（Hvolsvöllur）中間，靠近眾多景點。海拉是冰島最大的自治市之一北蘭加湖市（Rangárþing ytra）中人口最多的小鎮，擁有超過900人口，佔據了過半的北蘭加湖市人口。北蘭加湖市從沿海地區一直延伸至內陸高地，坐擁高地和低地獨特的自然資源。",
      "海拉可以作為您冰島環島之旅的第一站。它附近有許多著名的瀑布，距離著名的黃金圈只有一個半小時的車程，同時也是觀賞北極光的好地方。所以在欣賞完辛格維利爾國家公園（Þingvellir National Park）、間歇泉（Geysir）和巨大的黃金瀑布（Gullfoss）之後，您可以驅車向南行駛，在海拉停留休息一晚。從海拉向東行駛不遠，您就能看到冰島幾個最著名的瀑布：塞里雅蘭瀑布（Seljalandsfoss）、秘密瀑布（Gljúfrabúi）和斯科加瀑布（Skógafoss）。但如果您想探索一些更加人跡罕至的地方，您可以朝著黃金圈的方向行駛，大概40分鐘後，沿著一條河流左轉。第一站您會看到Hjalparfoss瀑布，兩股溪流傾瀉而下，最終落入同一汪水潭。它的不遠處還有冰島第三高的瀑布Háifoss瀑布，它高達122米，與環島沿線的大多數網紅瀑布相比，這裡的旅客要少得多。",
      ...
      "現在的海拉無疑是該市的商業和行政中心，擁有商店、餐館、酒店、泳池、銀行、露營地、藥店、加油站、小學和幼兒園以及各種其他服務機構和公共機構。北蘭加湖市市政廳和市政服務中心也位於海拉。",
    ],
  },
];
