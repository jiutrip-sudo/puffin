...
行程涵蓋黃金圈三大景點——辛格維利爾國家公園（Þingvellir National Park）、蓋錫爾間歇泉地帶與黃金瀑布（Gullfoss），並參觀凱瑞斯火山口（Kerið）；南岸則有塞里雅蘭瀑布（Seljalandsfoss）、斯科加瀑布（Skógafoss）、索爾黑馬冰川徒步、黑沙灘（Reynisfjara）與雷尼斯岩（Reynisdrangar）。第四日造訪傑古沙龍冰河湖（Jökulsárlón）與鑽石沙灘（Diamond Beach）；第五日深度遊覽斯奈山半島，造訪教會山（Kirkjufell）、阿爾納斯塔皮（Arnarstapi）與布迪爾黑教堂（Búðakirkja）。
...
第六日為自由活動，可另行加購蘭德曼納勞卡（Landmannalaugar）內陸高地徒步——僅夏季開放。入境日可前往 Sky Lagoon 天空之境溫泉放鬆身心。夏季迪霍拉里（Dyrhólaey）等地常有海鸚棲息，實際停留時間將由嚮導依天候與路況調整。`,
  ...
  routeStops: [
    ...
    { label: "第 6 天", detail: "雷克雅維克（自由活動日，可選內陸徒步）" },
  ...
  itinerary: [
    ...
    {
      day: 3,
      title: "冰島南岸：瀑布 & 冰川徒步 & 黑沙灘",
      accommodation: "南岸",
      description:
        "今日品質小巴團沿南岸一號公路南下。夏季日照長，沿途綠意盎然。\n\n首先造訪塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；天候許可時可繞行至塞里雅蘭瀑布後方小徑，亦可造訪秘密瀑布（Gljúfrabúi）。接著在專業嚮導帶領下進行索爾黑馬冰川（Sólheimajökull）徒步，穿戴安全裝備踏上夾雜火山灰紋路的藍白冰川。（注：冰川徒步體驗僅限 10 月前，10 月開始將替換為藍冰洞體驗。）\n\n最後前往黑沙灘（Reynisfjara），沿岸玄武岩石柱層層疊疊，遠處可見雷尼斯岩（Reynisdrangar）矗立海中。夏季迪霍拉里（Dyrhólaey）常有海鸚棲息。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚入住南岸附近飯店。",
