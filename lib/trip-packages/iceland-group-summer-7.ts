...
export const icelandGroupSummer7: TripPackage = {
  ...
  intro: {
    summary:
      "這個 7 天 6 夜夏季跟團套餐涵蓋黃金圈、南岸、冰河湖與斯奈山半島深度環遊，由品質小巴團與專業嚮導帶領。第六日為自由活動，可另行加購內陸高地健行。夏季日照長，沿途可欣賞海鸚與午夜陽光。",
...
第六日為自由活動，可另行加購蘭德曼納勞卡（Landmannalaugar）內陸高地健行——僅夏季開放。入境日可前往 Sky Lagoon 天空之境溫泉放鬆身心。夏季迪霍拉里（Dyrhólaey）等地常有海鸚棲息，實際停留時間將由嚮導依天候與路況調整。`,
  },
  gallery: [
    {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今日品質小巴團沿南岸一號公路南下。夏季日照長，沿途綠意盎然。\n\n首先造訪塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；天候許可時可繞行至塞里雅蘭瀑布後方小徑，亦可造訪秘密瀑布（Gljúfrabúi）。接著在專業嚮導帶領下進行索爾黑馬冰川（Sólheimajökull）健行，穿戴安全裝備踏上夾雜火山灰紋路的藍白冰川。（注意：冰川健行體驗僅限 10 月前，10 月開始將替換為藍冰洞體驗。）\n\n最後前往黑沙灘（Reynisfjara），沿岸玄武岩石柱層層疊疊，遠處可見雷尼斯岩（Reynisdrangar）矗立海中。夏季迪霍拉里（Dyrhólaey）常有海鸚棲息。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚入住南岸附近飯店。",
