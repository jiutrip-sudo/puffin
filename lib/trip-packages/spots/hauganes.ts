...
export const hauganesSpot: TripAttraction = {
  ...
  paragraphs: [
    "冰島最早商業觀鯨的村落之一",
    `豪加內斯（Hauganes）在埃亞峽灣南岸，屬達爾維克（Dalvík）行政區，距${PLACE_TW.akureyri}以北約 43 公里。人口約一百四十人，漁業、魚品加工與觀鯨並列為主要經濟來源。`,
    "冰島最早的商業觀鯨行程即從此出發，至今仍是北部熱門出海點。峽灣內常見座頭鯨、小鬚鯨、白喙海豚等；亦可搭船前往赫里斯島、格里姆賽島賞鳥。",
