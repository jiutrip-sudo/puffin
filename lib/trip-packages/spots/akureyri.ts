...
export const akureyriSpot: TripAttraction = {
  ...
  paragraphs: [
    "冰島北部的交通與生活重心",
    `${PLACE_TW.akureyri}人口約兩萬，是冰島第二大城市、北部最大的聚落，坐落在埃亞峽灣（Eyjafjörður）畔。許多北部行程以此為住宿與補給基地，再前往${PLACE_TW.myvatn}、${PLACE_TW.godafoss}、胡薩維克（Húsavík）賞鯨或黛提瀑布（Dettifoss）等景點。`,
    ...
    "冬季夜長，晴朗時極光出現機率高；夏季則適合安排賞鯨、健行或前往離島赫里斯（Hrísey）、格里姆塞（Grímsey）等。若環島北段行程緊湊，建議至少停留一晚，感受與首都不同的北部節奏。",
  ],
};
