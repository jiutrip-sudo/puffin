...
export const icelandGroupSummer4: TripPackage = {
  ...
  intro: {
    summary:
      "這個夏季 4 日跟團套餐濃縮南岸精華，兩日品質小巴團造訪瀑布、黑沙灘、冰河湖與鑽石沙灘，含冰川徒步與 Sky Lagoon 體驗。行程善用夏季長日照，由專業嚮導依天候調整節奏。",
    full: `這個夏季 4 日跟團套餐濃縮南岸精華，兩日品質小巴團造訪塞里雅蘭瀑布（Seljalandsfoss）、斯科加瀑布（Skógafoss）、黑沙灘（Reynisfjara）、傑古沙龍冰河湖（Jökulsárlón）與鑽石沙灘（Diamond Beach），含冰川徒步與 Sky Lagoon 溫泉體驗。套餐含凱夫拉維克機場至市區大巴接送與專業嚮導帶領，充分利用夏季長日照與午夜陽光，行程安排務實。

南岸一號公路串連冰島最具代表性的夏日風景；冰川徒步由嚮導陪同並提供安全裝備（10 月前為冰川徒步，之後改為藍冰洞體驗）。入境日安排 Sky Lagoon 溫泉放鬆，為後續南岸行程儲備體力。`,
  },
  gallery: [
    {
      id: "_5579ea0363",
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今日搭乘品質小巴團沿南岸一號公路南下。夏季南岸草木蔥鬱、瀑布水量充沛，長日照讓您有充裕時間造訪各景點。\n\n首先造訪塞里雅蘭瀑布（Seljalandsfoss）、秘密瀑布（Gljúfrabúi）與斯科加瀑布（Skógafoss）；夏季可沿小徑繞至塞里雅蘭瀑布後方，斯科加瀑布晴朗時常可見彩虹。接著在專業嚮導帶領下進行索爾黑馬冰川（Sólheimajökull）徒步，穿戴安全裝備近距離感受千年冰川地貌（10 月前為冰川徒步，之後改為藍冰洞體驗）。最後前往黑沙灘（Reynisfjara），沿岸玄武岩石柱層層疊疊，遠處可見雷尼斯岩（Reynisdrangar）矗立海中；夏季加達爾懸崖常有海鳥棲息。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚入住南岸附近飯店。",
