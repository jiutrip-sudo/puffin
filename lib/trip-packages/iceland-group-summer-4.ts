...
export const icelandGroupSummer4: TripPackage = {
  ...
  intro: {
    summary:
      "前往冰島，用最為精煉的時間和成本，體驗我們為您呈現的獨特而充實的冰島夏季四日遊套餐。",
    full: `前往冰島，用最為精煉的時間和成本，體驗我們為您呈現的獨特而充實的冰島夏季四日遊套餐。

本4日輕鬆暢玩套餐包括全程住宿與交通、南岸精緻小巴團以及靜謐安寧的品質天空之境溫泉（Sky Lagoon）體驗。在這次南岸之旅中，您將被冰島夏季的壯麗景色所環繞。我們將帶您探訪那些令人歎為觀止的自然奇觀，包括氣勢磅礴的瀑布、神秘莫測的黑沙灘（Reynisfjara），以及令人屏息的冰河湖（Jökulsárlón）和鑽石沙灘（Diamond Beach）。這些景觀不僅是冰島的標誌性景點，也是您冰島之旅中不容錯過的亮點，讓您深刻體驗冰島大自然的獨特魅力。

此外，您更有機會參加一場令人腎上腺素飆升的冰川徒步活動，用腳步丈量千年冰川，近距離感受冰川的神秘和壯麗。（注：冰川徒步體驗僅限10月前，10月開始將替換為藍冰洞體驗）。

在此次旅程裡，您將深入體驗冰島大自然的獨特之美，從自然景觀到文化體驗，從身體放鬆到心靈震撼。這將是一次讓您終身難忘的旅程，讓您在冰島的大自然中找到內心的寧靜與力量。`,
  },
  gallery: [
    {
      id: "_5579ea0363",
  ...
  routeStops: [
    ...
    { label: "第 2 天", detail: "塞里雅蘭／斯科加瀑布 → 冰川徒步 → 黑沙灘 → 維克" },
    { label: "第 3 天", detail: "傑古沙龍冰河湖 → 鑽石沙灘 → 返回雷克雅未克" },
    { label: "第 4 天", detail: "雷克雅未克 → 機場離境" }
  ],
  routeMap: {
    waypoints: [
      {
  ...
  itinerary: [
    {
      day: 1,
      title: "入境日：雷克雅未克 & Sky Lagoon舒適溫泉體驗",
      accommodation: "雷克雅未克",
      description:
        "今天是您抵達冰島的第一天，冰島夏日的生機將撲面而來。入境抵達機場並乘坐機場巴士到達冰島首都雷克雅未克之後，我們為您安排了天空之境溫泉（Sky Lagoon）溫泉體驗，這個溫泉以其獨特的設計理念和舒適的環境，讓您在享受溫泉的同時，也能欣賞到周圍壯麗的自然風光。在享受完首都唯一的極致溫泉體驗之後，如果您有足夠的精神，您將會目睹冰島夏季獨有的夢幻午夜陽光，您可以走出戶外，沉浸在黃金色的天空之下，感受冰島夏季獨有的寧靜與祥和。當然，在對雷克雅未克這個極北首都收穫初印象以後，我們也建議您早早回飯店休息，準備迎接接下來的旅途。",
      highlights: icelandGroupSummer4Day1Highlights,
      optionalActivities: icelandGroupSummer4Day1OptionalActivities,
    },
    {
      day: 2,
      title: "塞里雅蘭瀑布 & 斯科加瀑布 & 冰川徒步 & 黑沙灘",
      accommodation: "南岸",
      description:
        "今天您將遊覽冰島南岸風格各異、獨樹一幟的瀑布——斯科加瀑布（Skógafoss）、塞里雅蘭瀑布（Seljalandsfoss）以及秘密瀑布（Gljúfrabúi）。塞里雅蘭瀑布的水流從懸崖上傾瀉而下，形成了一道銀色的帷幕。旅客可以沿著小徑走到瀑布後方，體驗從水簾後看風景的獨特視角，感受水霧撲面而來的清新。隱藏在塞里雅蘭瀑布附近的秘密瀑布是一個小眾景點，旅客需要沿著狹窄的山道進入峽谷才能發現。斯科加瀑布寬約25米，高達60米，水流湍急，氣勢磅礴。晴天時，瀑布激起的水霧常常形成彩虹，因而被稱為“彩虹瀑布”。旅客可以在瀑布下方近距離欣賞水流的壯觀，甚至可以沿著階梯攀登至瀑布頂端，俯瞰南岸的美景。緊接著，您將跟隨專業登山向導的步伐，攀爬徒步著名的索爾黑馬冰川（Sólheimajökull）。索爾黑馬冰川徒步是冰島冰川徒步地點的首選，在配備繩索、登山杖和頭盔等所有必要的安全裝備後，您將跟隨專業嚮導領略冰川的宏大與壯闊，探索這裡縱橫交錯的裂縫、冰晶隧道和多種多樣的冰川地貌。（注：冰川徒步體驗僅限10月前，10月以後將替換為藍冰洞體驗）。最後，您將來到激動人心的雷尼斯黑沙灘（Reynisfjara）。沒錯！就是那個在各大明信片和攝影作品裡面上鏡率極高的冰島黑沙灘。在這裡，您可以置身在魔幻詭譎的黝黑海岸，親身感受北大西洋的澎湃和兇猛。在這裡，除了沙灘本身之外，您還能夠看到幾個獨特的地質景觀，例如雷尼斯岩（Reynisdrangar）以及迪霍拉里（Dyrhólaey）。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "這是您行程的最後一天，冰藍色的傑古沙龍冰河湖（Jökulsárlón）和精靈般的鑽石沙灘（The Diamond Beach）就靜靜地坐落在冰島最大冰川瓦特納冰川（Vatnajökull）的東南角，等待著您的探索。在傑古沙龍冰河湖，您有機會近距離接觸到已有千年歷史的冰山，感受時間和大自然的力量。這些冰山在陽光的照射下呈現出迷人的藍色和白色，彷彿是大自然的藝術品。在鑽石沙灘上，冰塊在海浪的沖刷下，閃爍著如同鑽石般的光芒，形成了獨特的自然景觀。在這裡，您可以親手撿起被沖刷下來的冰山一角，記錄下這一珍貴的瞬間。想像一下，手中握著的是千年冰川的遺物，感受著冰冷的觸感，彷彿與大自然的歷史緊密相連。回程途中，您會經過連綿起伏的埃爾德熔岩原（Eldhraun）覆蓋著厚厚的苔蘚，形成了一片獨特的綠色海洋，也絕對讓您印象深刻。今天，您也有機會在溫馨的維克鎮（Vík）停留，享受這個小鎮的寧靜與美麗。維克鎮以其壯麗的海岸線和黑沙灘而聞名，您可以在這裡放鬆身心，品嚐當地美食，或是漫步在海邊，欣賞雷尼斯岩（Reynisdrangar）的壯觀景色。",
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "時間過得飛快，今天是您的離境日。我們將為您預訂了前往機場的巴士車票，您可以根據離境航班自由安排今天的行程。無論是在洛加維格購物街（Laugavegur）購物血拼，還是前往海岸線參觀太陽航海者雕塑（Sólfarið）和哈帕音樂廳（Harpa Concert Hall），都是不錯的選擇。凱夫拉維克國際機場內也有如Blue Lagoon和66 North等一眾冰島本土品牌，您也可以在機場充實地度過在冰島最後的時光。我們誠摯希望您在 冰島度過了一段美好的時光，並期待與您再次相遇。",
