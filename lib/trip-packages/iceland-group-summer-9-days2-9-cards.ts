...
export const icelandGroupSummer9Day8OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "這次旅行將由冰島小矮馬們帶我們穿過苔原地、熔岩地和一條風景秀麗的小河，盡享南岸風光。途中您還可以欣賞到遠處的火山和農田。在欣賞風景的同時，嚮導會給您講解冰島馬的相關歷史和故事。途中您還會駐足幾個農場，了解過去幾十年來冰島的農業發展。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "本次行程您將乘坐超級吉普從首都雷克雅維克出發，開啟您的冰洞探索之旅。在日光允許的情況下（約從2月1日到11月15日），您將在途中遊覽冰島南岸著名的斯科加瀑布（Skógafoss）和塞里雅蘭瀑布（Seljalandsfoss），感受水流澎湃。",
