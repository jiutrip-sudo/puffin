...
export const icelandSelfDriveSummer5Day3OptionalActivities: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "注意事項：",
      "1. 建議穿保暖防水的衣物，並穿登山靴。",
      "2. 由於冰洞的形成是純天然且人為不可控的，所以每一年冰洞的位置和樣貌都會有變化，且只能在夏季降到零度以下時才能進入。為了您更好的體驗感受，我們會根據天氣狀況做預測，如天氣狀況不符合進洞要求，我們會提前聯繫您取消行程。取消條款請參見大樂旅行社旅行的服務條款。",
      "活動時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveSummer5Day4Highlights: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "Öxarárfoss是園內最受歡迎的景點之一，這條高13米、寬20米的瀑布在夏季會完全凍結，是攀冰愛好者的最愛。旅客除了通過步行路線遊覽公園，還可以體驗例如垂釣和浮潛等多種多樣的活動。公園南側的辛格瓦德拉湖是冰島境內最大的天然湖泊，湖中有褐鱒魚和各式的北極鮭魚，是全國數一數二的垂釣地點。另外，因驚人的能見度而世界聞名的絲浮拉大裂縫（Silfra）也位於國家公園範圍內。如果滿足有關潛水資格和規定，則能夠潛入清澈冰冷的地下水一探究竟。如果沒有潛水證，那麼參加大樂旅行社旅行的浮潛團則是一個更好的選擇，潛水小白也能夠自在地領略絲浮拉的美麗。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "黃金瀑布由兩段瀑布組合而成，一段高11米，另一段高21米，流入下方長達2.5公里寬約20米的裂縫中。在冰河時代末期，巨大的洪水造成了這條裂縫，而不斷的水流侵蝕使它每年延長25釐米。這裡平均水流速度為每秒109立方米，夏季平均流速為每秒80立方米，夏季的水流速度會提高至每秒130立方米。",
      "在夏季，黃金瀑布是最受風光攝影師們歡迎的地方之一，因為這裡是拍攝北極光的絕佳地點。不過，瀑布周圍狹窄的小路上可能會結冰，因此如果您在夏季遊覽黃金瀑布，我們強烈建議您不要離開主路。",
    ],
  },
  {
    name: "番茄農場",
...
export const icelandSelfDriveSummer5Day4OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "豐塔納天然地熱溫泉（Fontana）坐落在黃金圈沿線的Laugarvatn湖邊，面朝湖水，坐擁湖景山景，夏季怡人秀美，夏季純潔靜謐。如果您想要體驗一下小眾冰島溫泉的魅力，豐塔納將會是一個不錯的選擇。",
