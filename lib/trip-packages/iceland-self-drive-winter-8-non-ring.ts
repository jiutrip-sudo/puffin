...
import {
  icelandSelfDriveWinter8NonRingDay1Highlights,
  icelandSelfDriveWinter8NonRingDay1OptionalActivities,
} from "./iceland-self-drive-winter-8-non-ring-day1-cards";
import {
  icelandSelfDriveWinter8NonRingDay2Highlights,
  icelandSelfDriveWinter8NonRingDay2OptionalActivities,
  icelandSelfDriveWinter8NonRingDay3Highlights,
  icelandSelfDriveWinter8NonRingDay3OptionalActivities,
  icelandSelfDriveWinter8NonRingDay4Highlights,
  icelandSelfDriveWinter8NonRingDay4OptionalActivities,
  icelandSelfDriveWinter8NonRingDay5Highlights,
  icelandSelfDriveWinter8NonRingDay5OptionalActivities,
  icelandSelfDriveWinter8NonRingDay6Highlights,
  icelandSelfDriveWinter8NonRingDay6OptionalActivities,
  icelandSelfDriveWinter8NonRingDay7Highlights,
  icelandSelfDriveWinter8NonRingDay7OptionalActivities,
  icelandSelfDriveWinter8NonRingDay8Highlights,
  icelandSelfDriveWinter8NonRingDay8OptionalActivities,
} from "./iceland-self-drive-winter-8-non-ring-days2-8-cards";

export const icelandSelfDriveWinter8NonRing: TripPackage = {
  ...
  backLabel: "返回 8 日行程",
  heroImage:
    "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1920,q_auto:good/_bf1d145332.jpg",
  whyChooseUs: [
    {
      id: "deposit",
      title: "20% 訂金",
  ...
  intro: {
    summary:
      "這個 8 天 7 夜冰島冬季精選自駕，打卡黃金圈、南岸、冰河湖與斯奈山半島，並留有一日首都自由行。",
    full: `在 8 天時間內，您將打卡黃金圈三大景點，體驗南岸瀑布與黑沙灘的冬日風光，探索傑古沙龍冰河湖與鑽石沙灘，前往斯奈山半島欣賞迷人海岸線，並有充裕時間漫步雷克雅未克，品味冰島美食與極北首都的人文藝術氛圍。
...
全程由您掌控方向盤，靈活安排冰川徒步、藍冰洞、溫泉與極光追尋等自選活動。專業行程策劃師客製中文路書，涵蓋實用駕駛資訊與景點深度介紹。`,
  ...
  gallery: [
    {
      id: "kirkjufell",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/Kirkjufell1_053dfbdc9a.jpg",
      alt: "教會山",
      caption: "斯奈山半島教會山",
    },
    {
      id: "ice-cave",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/close_up_vatnajokull_ice_cave_copyright_matthew_shearer_indefinitely_lost_3ea56eca4b_3024a72160.jpg",
      alt: "藍冰洞",
      caption: "瓦特納冰川藍冰洞",
    },
    {
    ...
    {
      id: "skogafoss",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/Skogafoss_2418a39cf6.jpg",
      alt: "斯科加瀑布",
      caption: "斯科加瀑布",
    },
    {
    ...
    {
      id: "budir",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/Budir_4c45c803cc.jpg",
      alt: "布迪爾黑教堂",
      caption: "布迪爾黑教堂",
    },
    {
  ...
  routeOverviewSubtitle: "南岸、黃金圈與斯奈山半島冬季自駕動線",
  routeStops: [
    ...
    { label: "第 4 天", detail: "南岸小眾景點 → 維克 → 小冰河湖 → 迪霍拉里" },
    { label: "第 5 天", detail: "黃金圈 → 西部熔岩瀑布 → 西部／首都住宿" },
    { label: "第 6 天", detail: "斯奈山半島（教會山 → 布迪爾 → 漁村海岸）→ 雷克雅未克" },
    { label: "第 7 天", detail: "雷克雅未克（首都自由行）" },
  ...
  itinerary: [
    {
      ...
      highlights: icelandSelfDriveWinter8NonRingDay1Highlights,
      optionalActivities: icelandSelfDriveWinter8NonRingDay1OptionalActivities,
    },
    {
      day: 2,
      title: "南岸瀑布與黑沙灘",
    ...
    },
    {
      ...
      highlights: icelandSelfDriveWinter8NonRingDay4Highlights,
      optionalActivities: icelandSelfDriveWinter8NonRingDay4OptionalActivities,
    },
    {
      day: 5,
      title: "黃金圈",
      accommodation: "西部",
      description:
        "造訪黃金圈三大景點：辛格維利爾國家公園、間歇泉與黃金瀑布。隨後向西，可遊覽熔岩瀑布（Hraunfossar）、兒童瀑布（Barnafoss）等西部特色景觀。",
      highlights: icelandSelfDriveWinter8NonRingDay5Highlights,
      optionalActivities: icelandSelfDriveWinter8NonRingDay5OptionalActivities,
    },
    {
      day: 6,
      title: "斯奈山半島",
      accommodation: "雷克雅未克",
      description:
        "斯奈山半島被稱為「冰島縮影」，一日之內可見多樣地貌。打卡教會山（Kirkjufell）、布迪爾黑教堂、阿爾納斯塔皮海岸與斯蒂基斯霍爾米漁村，傍晚返回雷克雅未克入住。",
      highlights: icelandSelfDriveWinter8NonRingDay6Highlights,
      optionalActivities: icelandSelfDriveWinter8NonRingDay6OptionalActivities,
    },
    {
      day: 7,
      title: "雷克雅未克自由行",
      ...
      highlights: icelandSelfDriveWinter8NonRingDay7Highlights,
      optionalActivities: icelandSelfDriveWinter8NonRingDay7OptionalActivities,
    },
    {
      day: 8,
      title: "離境日",
      ...
      highlights: icelandSelfDriveWinter8NonRingDay8Highlights,
      optionalActivities: icelandSelfDriveWinter8NonRingDay8OptionalActivities,
    },
  ],
  inclusions: {
    included: [
