...
export const icelandSelfDriveWinter8NonRing: TripPackage = {
  ...
  intro: {
    summary:
      "這個 8 天 7 夜冰島冬季精選自駕遊深度走訪西南岸，涵蓋黃金圈、南岸、斯奈山半島，並留有一日暢遊雷克雅維克。行程充分顧及冬季日照與路況，節奏適中、安排務實。",
    full: `這個 8 天 7 夜冰島冬季精選自駕遊深度走訪西南岸，涵蓋黃金圈、南岸、斯奈山半島，並留有一日暢遊雷克雅維克。套餐充分顧及冬季日照時數與路況，行程安排合理、節奏適中。
...
行程另安排一日探索「冰島縮影」斯奈山半島（Snæfellsnes），以及一日雷克雅維克自由行，讓您依自己的步調造訪博物館、餐廳與地熱溫泉。途中亦可另行加購藍冰洞探險、冰川健行、觀鯨或極光船遊等體驗。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島冬季西南岸精華。`,
  ...
  routeStops: [
    ...
    { label: "第 7 天", detail: "雷克雅維克（首都自由行）" },
