...
export const icelandGroupSummer6SouthHiking: TripPackage = {
  ...
  intro: {
    summary:
      "這個 6 天 5 夜夏季探險跟團套餐涵蓋火山內部探險、觀鯨、南岸冰川徒步與冰河湖，由品質小巴團與專業嚮導帶領。第五日為自由活動，可另行加購蘭德曼納勞卡高地徒步。",
    full: `這個 6 天 5 夜夏季探險跟團套餐涵蓋火山內部探險、雷克雅維克觀鯨、南岸冰川徒步與傑古沙龍冰河湖，由品質小巴團與專業嚮導帶領。套餐含凱夫拉維克機場至市區大巴接送，充分運用夏季日照長的優勢。

第二日將搭乘升降機深入 Þríhnúkagígur 休眠火山內部，並從雷克雅維克老港口出海觀鯨。南岸行程涵蓋塞里雅蘭瀑布（Seljalandsfoss）、斯科加瀑布（Skógafoss）、索爾黑馬冰川徒步、黑沙灘（Reynisfjara）與雷尼斯岩（Reynisdrangar）；第四日造訪傑古沙龍冰河湖（Jökulsárlón）與鑽石沙灘（Diamond Beach）。
...
第五日為自由活動，可另行加購蘭德曼納勞卡（Landmannalaugar）高地徒步——僅夏季開放，流紋岩山脈色彩斑斕。夏季迪霍拉里（Dyrhólaey）等地常有海鸚棲息，實際停留時間將由嚮導依天候與路況調整。`,
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        "徒步愛好者的夢幻樂園",
        "蘭德曼納勞卡（Landmannalaugar）位於冰島南部的內陸高地，處於Laugahraun熔岩地邊緣。其名直譯為“大眾泳池”，是冰島南部自駕遊的熱門景點，也是徒步旅行者的天堂，有著眾多可供選擇的徒步路線，同時還以其豐富的天然溫泉和斑瀾的地質特徵而著稱。與冰島的其他景點相比，蘭德曼納勞卡的交通略顯不便，但這也為追求空曠寧靜的旅客提供了一個遠離人群的好機會。",
        "蘭德曼納勞卡所處的Laugahraun熔岩地形成於1477年前後的火山爆發，讓它成為了一幅巨大的畫卷，五顏六色的流紋岩山峰讓人目不暇接，綠色、藍色、黃色、紅色和粉色的岩石不斷映入眼簾，就像是小時候用油筆塗畫一樣隨意又充滿大自然的想像力。",
        "蘭德曼納勞卡是徒步旅行的理想去處，這裡有多條長度和難度各異的路線供徒步者選擇。短途的路線包括Brennisteinsalda火山線路，領略流紋岩山脈的集大成者；一小時徒步攀登Bláhnjúkur，欣賞藍峰頂端的絕美風景；四小時徒步前往Ljótipollur火山口湖，看看這口“醜水坑”究竟是美是醜。",
        "長途路線中最有名的當屬“Laugavegur”路線，長度約為54km，徒步者通常需要4天時間從北到南走完這條路線，終點為索斯莫克（Þórsmörk）。沿途會穿過色彩斑斕的流紋岩山、黑曜石般的熔岩地、熱氣騰騰的溫泉、清澈如鏡的湖泊、暗世界的黑色沙漠，最後到達一片鬱鬱蔥蔥的森林，國家地理雜誌曾將其列為世界上最美麗的徒步路線之一。",
        "在蘭德曼納勞卡徒步旅行，最完美的放鬆方式無疑是在山谷中的天然溫泉中閉目養神、舒緩肌肉，畢竟這裡的名字翻譯過來就是“大眾泳池”，它在歷史上被用作偏遠地區的地熱療養之地。因此，一定別忘了在你的登山包中裝上一件泳衣和浴巾。",
  ...
  routeStops: [
    ...
    { label: "第 3 天", detail: "南岸三大瀑布 → 冰川徒步 → 黑沙灘" },
    { label: "第 4 天", detail: "傑古沙龍冰河湖 → 鑽石沙灘" },
    { label: "第 5 天", detail: "自由活動日（可選高地徒步）" },
  ...
  itinerary: [
    ...
    {
      day: 3,
      title: "南岸三大瀑布 & 索爾黑馬冰川徒步 & 黑沙灘",
      accommodation: "南岸",
      description:
        "今日品質小巴團沿南岸一號公路南下。夏季日照長，沿途綠意盎然。\n\n首先造訪塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；天候許可時可繞行至塞里雅蘭瀑布後方小徑。接著在專業嚮導帶領下進行索爾黑馬冰川（Sólheimajökull）徒步，穿戴安全裝備踏上夾雜火山灰紋路的藍白冰川。（注：冰川徒步體驗僅限 10 月前，10 月開始將替換為藍冰洞體驗。）\n\n最後前往黑沙灘（Reynisfjara），沿岸玄武岩石柱層層疊疊，遠處可見雷尼斯岩（Reynisdrangar）矗立海中。夏季迪霍拉里（Dyrhólaey）常有海鸚棲息。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚入住南岸附近飯店。",
