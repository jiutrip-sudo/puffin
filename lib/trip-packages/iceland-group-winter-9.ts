...
往東穿越東部峽灣海岸；北上米湖（Lake Mývatn）地區探索火山地質奇景，並造訪眾神瀑布（Goðafoss）。行程另安排北部觀鯨，以及「冰島縮影」斯奈山半島（Snæfellsnes）一日遊。途中亦可另行加購雪地摩托、溫泉體驗或極光船遊等冬季活動。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島環島精華。`,
  ...
  routeStops: [
    { label: "第 1 天", detail: "雷克雅維克（入境、城市風光、可選 Sky Lagoon）" },
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今日品質小巴團沿南岸一號公路南下。冬季南岸色調獨特：白雪覆蓋大地、天際染上粉霞。\n\n造訪塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；冬季基於安全考量，塞里雅蘭瀑布後方小徑通常封閉。繼續前往黑沙灘（Reynisfjara），遠處可見雷尼斯岩（Reynisdrangar）矗立海中，途中經過維克（Vík）。行程另安排索爾黑馬冰川（Sólheimajökull）徒步，由專業嚮導帶領並提供安全裝備。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚繼續入住南岸。",
    ...
    },
    {
      ...
      description:
        "今日沿東部峽灣海岸公路北上，穿越幽靜峽灣與漁村，感受冰島東部壯闊而寧靜的冬日海岸風光。途中將途經埃伊爾斯塔濟（Egilsstaðir），感受東部漁村生活。亦可另行加購東部騎馬體驗或 Vök Baths 湖上溫泉。冬季東部日照時數較短，實際停留時間將由嚮導依天候與路況調整。今晚入住南岸或東部峽灣。",
    ...
    },
    {
      ...
      accommodation: "北部",
      description:
        "今日前往北部米湖（Lake Mývatn）地區，造訪 Hverir 地熱泥漿池、黑暗城堡（Dimmuborgir）熔岩柱群與眾神瀑布（Goðafoss）。米湖周邊火山地貌獨特，是冬季追尋北極光的熱門區域之一。傍晚前往阿克雷里（Akureyri）感受北部城市風情。今晚入住北部。",
    ...
    },
    {
      ...
      accommodation: "雷克雅維克",
      description:
        "今日搭乘品質小巴團前往斯奈山半島（Snæfellsnes），被稱為「冰島縮影」。造訪海豹沙灘（Ytri-Tunga）、布迪爾黑教堂（Búðakirkja）、阿爾納斯塔皮（Arnarstapi）海岸與教會山（Kirkjufell）。傍晚返回雷克雅維克住宿。",
