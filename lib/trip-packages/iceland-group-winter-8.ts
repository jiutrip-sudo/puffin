...
您將造訪黃金圈三大景點——辛格維利爾國家公園（Þingvellir National Park）、蓋錫爾間歇泉地帶（Geysir）與黃金瀑布（Gullfoss）；沿南岸探索塞里雅蘭瀑布、斯科加瀑布、黑沙灘（Reynisfjara）與雷尼斯岩（Reynisdrangar），並參加索爾黑馬冰川徒步與藍冰洞探險。
...
完成預訂後，您將收到行程策劃師為您客製的中文行程手冊。冬季環島團發團日期及團次位置有限，預訂前請確認出發日是否有餘位。`,
  ...
  itinerary: [
    ...
    {
      day: 3,
      title: "塞里雅蘭瀑布、斯科加瀑布、索爾黑馬冰川徒步、黑沙灘",
      accommodation: "南岸",
      description:
