...
您將造訪黃金圈三大景點——辛格維利爾國家公園（Þingvellir National Park）、蓋錫爾間歇泉地帶（Geysir）與黃金瀑布（Gullfoss）；沿南岸探索塞里雅蘭瀑布、斯科加瀑布，參加索爾黑馬冰川徒步，並在黑沙灘（Reynisfjara）遠眺雷尼斯岩（Reynisdrangar），途中經過維克（Vík）。繼續造訪傑古沙龍冰河湖（Jökulsárlón）與鑽石沙灘（Diamond Beach）。

西部白銀圈將遊覽熔岩瀑布（Hraunfossar）、德爾達圖赫菲溫泉（Deildartunguhver）與 Víðgelmir 熔岩洞穴；斯奈山半島則造訪教會山（Kirkjufell）與布迪爾黑教堂。行程另安排出海觀鯨、火山內部探險與絲浮拉浮潛，並留有一日雷克雅維克自由行，可另行加購溫泉體驗、內陸高地徒步或騎冰島馬等夏季活動。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊。`,
  },
  gallery: [
    {
  ...
  routeStops: [
    ...
    { label: "第 8 天", detail: "絲浮拉浮潛 & 溫泉（花少同款）" },
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今日品質小巴團沿南岸一號公路南下，開始為期兩日的南岸行程。夏季日照充沛，綠意與瀑布相映成趣。\n\n造訪塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；夏季可繞行至塞里雅蘭瀑布後方小徑，請注意路面濕滑。行程另安排索爾黑馬冰川（Sólheimajökull）徒步，由專業嚮導帶領並提供安全裝備。繼續前往黑沙灘（Reynisfjara），遠眺雷尼斯岩（Reynisdrangar）矗立海中，途中經過維克（Vík）。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚入住南岸。",
    ...
    },
    {
      ...
      accommodation: "雷克雅維克",
      description:
        "今日為雷克雅維克自由活動日，您可依個人興趣安排行程。建議造訪哈爾格林姆斯大教堂、哈帕音樂廳或市區博物館，亦可另行加購騎冰島馬、冰川隧道探險、內陸高地徒步或海釣等夏季活動。\n\n今晚入住雷克雅維克。",
