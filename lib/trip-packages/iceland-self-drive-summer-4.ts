...
途中您亦可另行加購戶外體驗，例如在冰川上徒步、搭乘冰河湖船遊，或浸泡地熱溫泉，為旅程增添不同樂趣；同時也能靈活掌握停留時間，依自己的步調安排每一天。盛夏時分，還有機會感受午夜太陽下綿長的暮色。
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "藝術和文化是雷克雅維克身份的重要組成部分。城市擁有眾多博物館、畫廊和劇院。冰島國家美術館和雷克雅維克藝術博物館為藝術愛好者提供了欣賞當代藝術的平台。街頭藝術和壁畫裝飾了許多建築，為城市增添了生機。雷克雅維克還有多個年度節日，如雷克雅維克藝術節、冰島Airwaves音樂節和夏季燈光節，吸引了大量國際旅客，展示了城市的活力文化景觀。",
