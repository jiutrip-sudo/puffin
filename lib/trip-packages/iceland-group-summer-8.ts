...
行程另安排一日火山內部探險與出海觀鯨，並留有一日自由活動，可另行加購內陸高地徒步等夏季限定體驗。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊。`,
  },
  gallery: [
    {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "雷克雅維克",
      description:
        "今日為自由活動日，您可依個人興趣安排行程。建議造訪哈爾格林姆斯大教堂、哈帕音樂廳或市區博物館，亦可另行加購蘭德曼納勞卡（Landmannalaugar）內陸高地徒步——此路線僅於夏季 6 月至 9 月開放，彩色山脈與溫泉地帶是冰島高地最具代表性的夏季風光。\n\n其他可加購項目包括騎冰島馬、冰川隧道探險或溫泉體驗等。今晚入住雷克雅維克。",
