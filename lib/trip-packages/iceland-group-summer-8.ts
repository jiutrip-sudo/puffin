...
export const icelandGroupSummer8: TripPackage = {
  ...
  intro: {
    summary:
      "這個 8 天 7 夜冰島夏季跟團遊，由品質小巴團與專業嚮導帶您走訪黃金圈、南岸、冰河湖與斯奈山半島，並安排火山內部探險與出海賞鯨。套餐含機場接送，以雷克雅維克為中心，夏季日照充沛，行程節奏適中、安排務實。",
    full: `這個 8 天 7 夜冰島夏季跟團遊，由品質小巴團與專業嚮導帶您走訪黃金圈、南岸、冰河湖與斯奈山半島，並安排火山內部探險與出海賞鯨。套餐含機場接送，以雷克雅維克為中心，夏季日照充沛，行程安排合理、節奏適中。
...
行程另安排一日火山內部探險與出海賞鯨，並留有一日自由活動，可另行加購內陸高地健行等夏季限定體驗。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊。`,
  },
  gallery: [
    {
  ...
  routeStops: [
    ...
    { label: "第 6 天", detail: "火山內部探秘 & 出海賞鯨" },
  ...
  itinerary: [
    ...
    {
      day: 6,
      title: "活動日1：火山內部 & 出海賞鯨",
      accommodation: "雷克雅維克",
      description:
        "今日安排兩項夏季特色體驗。上午搭乘開放式纜索電梯深入 Þríhnúkagígur 火山內部，在專業嚮導帶領下探索休眠火山的彩色岩壁與地質奇觀；火山內部探險僅於每年 5 月至 10 月開放。\n\n下午從雷克雅維克老港口出海賞鯨，專業船員將介紹當地海洋生態，夏季常可見到座頭鯨、小鬚鯨與海豚等海洋生物。若第一天未能前往 Sky Lagoon，亦可調整至今日。今晚入住雷克雅維克。",
