...
export const icelandGroupSummer5GoldenCircleDay1Highlights: TripAttraction[] = [
    reykjavikSpot,
...
export const icelandGroupSummer5GoldenCircleDay1OptionalActivities: TripAttraction[] = [
