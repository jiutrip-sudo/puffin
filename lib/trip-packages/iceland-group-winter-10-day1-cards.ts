...
export const icelandGroupWinter10Day1Highlights: TripAttraction[] = [
    reykjavikSpot,
...
export const icelandGroupWinter10Day1OptionalActivities: TripAttraction[] = [
    auroraBoatTourSpot,
    auroraMiniBusSpot,
    auroraSuperJeepSpot,reykjavikLavaShowSpot,
