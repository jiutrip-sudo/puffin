...
export const icelandSelfDriveWinter4Day2OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 如您需要從雷克雅未克出發的卡特拉冰洞探險，請您諮詢森林貓旅行後台客服。",
      "體驗時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveWinter4Day3OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "注意事項：",
      "1. 建議穿保暖防水的衣物，並穿登山靴。",
      "2. 由於冰洞的形成是純天然且人為不可控的，所以每一年冰洞的位置和樣貌都會有變化，且只能在冬季降到零度以下時才能進入。為了您更好的體驗感受，我們會根據天氣狀況做預測，如天氣狀況不符合進洞要求，我們會提前聯繫您取消行程。取消條款請參見森林貓旅行的服務條款。",
      "活動時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveWinter4Day4OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 鯨魚和海豚等海洋生物的行蹤不可控，是否能幸運地看到鯨魚，不僅需要專業人士預測他們的行蹤，還要考慮其他因素，例如：天氣、海況等；若您參團後未看到鯨魚，我們將根據情況額外提供一次免費參團觀鯨機會，具體請您參見森林貓旅行的服務條款，詳情請聯繫後台客服。",
