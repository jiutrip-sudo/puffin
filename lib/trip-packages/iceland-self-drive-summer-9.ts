...
export const icelandSelfDriveSummer9: TripPackage = {
  ...
  intro: {
    summary:
      "這個自駕套餐可以充分的利用9天時間玩轉冰島最經典環島路線。 沿著冰島著名的1號環島公路，可以帶你遊覽沿途美麗的瀑布、獨特的溫泉、驚豔的冰川和獨特的火山地貌。",
    full: `這個自駕套餐可以充分的利用9天時間玩轉冰島最經典環島路線。 沿著冰島著名的1號環島公路，可以帶你遊覽沿途美麗的瀑布、獨特的溫泉、驚豔的冰川和獨特的火山地貌。

在這趟豐富的行程中，您將在夏季打卡冰島最熱門旅遊線路黃金圈（Golden Circle），拜訪三大經典景點，探索冰島南部著名的瀑布和黑沙灘（Reynisfjara），欣賞到無邊無際的黑色沙灘和洶湧的海浪，更有機會欣賞冰河湖、感受鑽石沙灘（Diamond Beach）的夢幻浪漫。

除此之外，您還將沿著環島1號公路，去到迷人的東部峽灣，與神奇的野生動物來個不期而遇，並重溫《普羅米修斯》電影開頭取景地黛提瀑布（Dettifoss），見證豐富的米湖（Lake Myvatn）及周邊地區地貌，去到西部白銀圈，感受另一種冰島之美。同樣，您更有機會前往享譽國際的藍湖溫泉（Blue Lagoon）或是其他溫泉，感受至臻的冰島溫泉文化。

如果您希望在您的行程中增加一些不同的元素，您還可以有豐富多樣的體驗選擇。例如：傑古沙龍冰河湖船遊、索爾黑馬冰川徒步、緊張又刺激的朗格冰川雪地摩托、絲浮拉大裂縫浮潛、冰島馬騎行和冰島觀鯨等項目，為您的旅程增添不同的色彩。`,
  },
  gallery: [
    {
  ...
  attractions: [
    ...
    },
    {
      ...
      imageUrl: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/dettifoss2_45da311b3a.jpg",
      galleryImages: [
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/dettifoss2_45da311b3a.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/dettifoss1_9ceaad5480.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/dettifoss3_70d08e045f.jpg",
      ],
      paragraphs: [
        "歐洲最大瀑布盡收眼底",
    ...
    },
    {
      ...
      imageUrl: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/borgarnes1_e7534aec68.jpg",
      galleryImages: [
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/borgarnes1_e7534aec68.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/borgarnes2_180383958c.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/borgarnes3_6b46debad5.jpg",
      ],
      paragraphs: [
        "充滿維京歷史痕跡的冰島西部小鎮",
  ...
  routeStops: [
    ...
    { label: "第 2 天", detail: "黃金圈（辛格維利爾 → 間歇泉 → 黃金瀑布）→ 南岸" },
    ...
    { label: "第 8 天", detail: "眾神瀑布 → 阿克雷里 → 西部白銀圈 → 雷克雅未克" },
    { label: "第 9 天", detail: "雷克雅未克市區（可選）→ 機場離境" }
  ],
  routeMap: {
    waypoints: [
      {
  ...
  itinerary: [
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "歡迎您入境冰島！抵達凱夫拉維克機場後，請您前往租車辦公室取車，並前往冰島首都的飯店辦理入住手續。如時間充裕，可先去藍湖溫泉（Blue Lagoon）放鬆一下。當晚我們會安排您入住雷克雅未克市區精選飯店，您可以在首都悠閒漫步，參觀雷克雅未克的博物館、哈爾格林姆斯大教堂（Hallgrímskirkja）、哈帕音樂廳（Harpa Concert Hall），體驗當地咖啡文化和生活氛圍，留下您的冰島初印象。最後，您不如在飯店好好放鬆休息，為接下來的行程做好準備！",
    ...
    },
    {
      ...
      accommodation: "黃金圈地區",
      description:
        "第二天，您將開啟您的黃金圈之旅，參觀位於歐亞大陸與美洲大陸板塊裂谷的辛格維利爾國家公園（Þingvellir National Park），在這裡，您可以感受腳跨兩大陸的神奇。同時，這裡也是冰島最早的國家議會舉辦地，你可以在這裡可以參加絲浮拉浮潛（Silfra Snorkeling），感受清澈見底的冰川水。在Haukdalur地熱谷，請您隨時準備好相機觀賞史托克間歇泉（Strokkur）噴發的壯觀景象。泉眼每隔5-10分鐘就會噴發，您可以站在安全範圍內，架好相機，準備嚴陣以待，捕捉熱泉噴發的那一絕美瞬間。來到冰島最著名的瀑布之一黃金瀑布（Gullfoss），您從上方俯瞰整個瀑布，看冰川水從32米高的兩級階梯落下，欣賞到遠處的朗格冰川（Langjökull）。晴天時，還會有彩虹掛於其上。或者，您也可以從下方近距離感受水流衝擊力，體驗別樣視角。在前往晚上入住的飯店途中，如果您有興趣，不妨還可以探訪獨特的凱瑞斯火山口（Kerið），這座休眠火山口有著3000多年曆史，覆蓋著火山口周圍的鮮豔的紅色火山岩與湖水周圍的綠色苔蘚使得熱烈鮮豔的紅綠色彩與火山口底部清澈無比的湛藍湖水交相輝映，呈現出一副大膽、夢幻的畫卷。",
    ...
    },
    {
      ...
      accommodation: "南岸地區",
      description:
        "沿著冰島南岸遊覽，您將看到許多耳熟能詳的景點，如塞里雅蘭瀑布（Seljalandsfoss）、斯科加瀑布（Skógafoss）和冰島黑沙灘（Reynisfjara）。塞里雅蘭瀑布最為特別的一點便是您可以站在水幕後的棧道上欣賞別緻角度的瀑布美景，看瀑布跌入深潭的壯麗。夏季時分，這裡的山崖被一篇生機籠罩，野花盛開，美不勝收。在斯科加瀑布，您可以站在底部感受水霧清涼或爬上斯科加瀑布頂部俯瞰整個瀑布和南岸美景。沿途不妨在斯科加民俗博物館和農場停留，瞭解該地區的歷史和人文。如果您有興趣，還可以報名參加離瀑布不遠的索爾黑馬冰川徒步項目，跟隨專業嚮導登上冰川一睹冰川大美。除此之外，您還可以去飛機殘骸（Plane Wreck DC-3）打卡參觀。乘坐擺渡車到達那裡，這架道格拉斯DC-3飛機殘骸位於冰島南部的Sólheimasandur黑沙灘上，其殘破的金屬機身在黝黑的砂石映襯下，展現出一種悽美與震撼，獨有飛行器隕落的荒涼之美。南部地區還有著著名的雷尼斯黑沙灘（Reynisfjara），在此您能欣賞到大西洋海浪衝擊黑沙灘的奇景，注視排列有序玄武岩石柱牆，而這裡同樣也是各大攝影師爭相出片的地方。但要注意的是，為了生命安全，請千萬遠離危險的海浪！",
    ...
    },
    {
      ...
      accommodation: "東南部地區",
      description:
        "在接下來的行程中，您將前往歐洲最大的冰川瓦特納冰川（Vatnajökull），這片廣袤無垠的冰川佔據了冰島國土面積的8%。其中的最大亮點是傑古沙龍冰河湖（Jökulsárlón）和鑽石沙灘（Diamond Beach）。這個由Breiðamerkurjökull冰舌的冰川融水滋養的冰川瀉湖，是冰島最著名的旅遊景點之一。湖中漂浮著無數從冰川上剝離的巨型浮冰，您可以選擇乘坐水陸兩棲船遊覽，欣賞冰川和冰山的美麗景色，近距離接觸千年浮冰，並看小海豹懶洋洋地趴在浮冰上休息。在這附近，您同樣可以在斯卡夫塔自然保護區（Skaftafell）參加斯卡夫塔冰川徒步項目。在途中，嚮導也會為您講解冰河湖及冰川有關的生態知識，讓您有一個更為深入的瞭解。鑽石沙灘（Diamond Beach）是您旅途中不可錯過的一站。這片黑沙灘上散落著晶瑩剔透的冰塊，在陽光下閃爍如鑽石，因此得名“鑽石沙灘”。您可以在這裡尋找冰川碎裂的“鑽石”，感受這份荒涼之美。可以說，您今天在今天與冰的世界深度接觸！當晚，您將入住在冰島東峽灣的霍芬小鎮（Höfn），這裡是以海岸風光和龍蝦餐館而聞名的港口小鎮。在這裡，您可以感受冰島東南部獨特的風光氣候和小鎮風情，品嚐地道的冰島龍蝦。",
    ...
    },
    {
      ...
      accommodation: "東部峽灣",
      description:
        "冰島東部的峽灣地區相對於南部的著名景點來說，旅客較少，但卻隱藏著令人驚歎的異世界自然景觀和寧靜的小鎮，讓每位旅客都會被其美景所震撼。這裡擁有冰島罕見的天然森林，許多野生動物也選擇在東峽灣定居，沿途您可能會偶遇野生馴鹿，而備受冰島人喜愛的海鸚（Puffins）也在東峽灣築巢棲息。來到這裡，您可以前往冰島東部最大的城鎮埃伊爾斯塔濟（Egilsstaðir），您將有機會深入體驗這個地區的本土文化和寧靜氛圍。埃伊爾斯塔濟是冰島東部的交通樞紐和服務中心，擁有超市、紀念品商店、飯店、旅客資訊中心、餐廳等多樣化的服務和設施。您可以在這裡逛逛當地的文化景點，比如參觀冰島人過去居住的古老草頂房，感受冰島的歷史和文化。在這附近，據說冰島版“尼斯湖水怪”就居住在這裡的拉加爾湖（Lagarfjlót）中，若您對這一神秘傳說有興趣，不妨大膽前去一探究竟！此外，您還可以前往Vök Baths湖上的溫泉，這一溫泉由兩座獨特的六邊形結構無邊泳池構成，宛如鑲嵌在Urriðavatn湖面上的璀璨寶石，僅需短短5公里車程即可從埃伊爾斯塔濟抵達，成為冰島東部不容錯過的目的地。在此，您不僅能沉浸在溫暖的溫泉之中，舒展身心，還能同時沉醉於湖泊及其周圍地區的壯麗風光之中，體驗與自然的完美融合。",
    ...
    },
    {
      ...
      accommodation: "米湖周邊",
      description:
        "今天您將繼續穿過冰島東部峽灣來到北部的米湖區（Lake Mývatn）。米湖地區以其豐富的地熱活動、獨特的火山地熱地貌和美麗的湖泊而聞名。在到達米湖之前，您或許將有機會在Stuðlagil峽谷停留，這個如今已成為網紅景點的自然奇觀，以其壯觀的玄武岩石柱排列在兩岸而聞名。冰藍色的河水從峽谷中穿流而過，其色彩和形態美得令人心醉，這裡是攝影師和自然愛好者的天堂，每一個角度都像是一幅精心構圖的畫卷。之後，您將前往歐洲水流量最大的瀑布黛提瀑布（Dettifoss），它以其磅礴的氣勢和壯觀的景色而著稱，水流從高處直瀉而下，形成了一道令人震撼的自然景觀。這裡也是電影《普羅米修斯》的取景地，電影中的外星景象便是在此拍攝，增添了一份神秘色彩。接著，您將抵達胡薩維克（Húsavík），這個擁有“歐洲鯨魚之都”名號的小鎮，是冰島觀鯨活動的熱門地點。從這裡出海，您將有機會與海洋中的巨獸——鯨魚進行親密互動，體驗冰島觀鯨的樂趣所在。這裡的海域是多種鯨魚的棲息地，包括座頭鯨、小鬚鯨等，您可能會有幸目睹這些溫柔巨人的風采。當晚，我們會安排您入住在北部最具代表性的米湖周邊地區，讓您盡情享受冰島北部的美麗風光。",
    ...
    },
    {
      ...
      accommodation: "北部",
      description:
        "米湖（Lake Mývatn）地貌獨特，有大量地熱資源和火山，由於地熱活動和特殊的地質條件，米湖區擁有豐富多樣的生態系統，是許多魚類和候鳥的棲息地。這個地區有著“惡魔廚房”之稱的Námaskarð泥漿地熱區，氣味奇特，您能看到冒泡的泥漿口，感受到濃郁的硫磺味，宛如來到了異世之境。同時您還可以在怪石嶙峋的Dimmuborgir熔岩柱群穿梭，看造型獨特、大小不一的拱門，感受神秘巨魔傳說，這裡也因傳說被稱為黑暗城堡。而權遊中瓊恩雪諾和耶哥蕊特的定情溫泉洞Grjótagjá離此不遠，十分值得一看。在Skútustaðagígar偽火山口可以算是米湖地區最為獨特的景觀。它是一系列特殊的火山口，由於岩漿與地下水的相互作用，形成了一系列圓錐形的小山丘。這些偽火山口的形狀獨特，成為了米湖的地標之一。除此以外，北部的眾神瀑布（Goðafoss）一瀉而下，充滿北歐神話色彩，宛如眾神的悲鳴，讓人心生震撼。作為冰島北部首府，阿克雷裡（Akureyri）別有一番城市風貌，您可以去植物園、大教堂閒庭漫步，感受阿克雷裡輕鬆愜意的城市氛圍。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "今天您將從阿克雷裡出發，沿一號公路返回雷克雅未克。在冰島西北部，您可以在布倫迪歐斯（Blönduós）和華姆斯唐吉（Hvammstangi）兩個風景優美的漁村作為停靠點稍作休整。抵達冰島西部白銀圈，您可以到德爾達圖赫菲溫泉（Deildartunguhver）感受這一歐洲最大的地熱泉的神奇力量，這裡也是附近地熱供能的來源。如果您有興趣，不妨去不遠處的Krauma溫泉體驗一下，感受獨特的冰川水與地熱力量的融合療愈體驗。而在冰島歷史小鎮雷克霍特（Reykholt），感受冰島傳奇的故鄉，探尋歷史文化遺蹟則是另一重別樣體驗。在西部白銀圈，這裡有著不同於狂闊南岸瀑布的兩個瀑布。緩緩而下的熔岩瀑布（Hraunfossar）和湍急飛流的兒童瀑布（Barnafoss）也是該路線上的王牌景點。熔岩瀑布是由一個長達900米的熔岩裂縫中的地下水形成的。清澈的水流從熔岩層下面湧出，緩緩而下，形成了一系列細長的瀑布，融入了周圍獨特的熔岩地貌中。在熔岩瀑布旁邊便是兒童瀑布，這個瀑布相對熔岩瀑布較為湍急，您可以前往瞭解其悲傷傳說，同樣十分值得一看。",
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "在您即將告別冰島的這一天，您需要確保按照約定的時間，將租賃的車輛準時歸還到機場的指定地點。如果您的航班離境時間較晚，您可以充分利用在雷克雅未克的最後時光。藝術館和設計品小店是您不錯的選擇，您可以在這些地方找到冰島本土藝術家的作品和設計師的創意產品，作為與家人朋友分享冰島之旅的完美禮物。此外，如果您希望在離開前再次享受冰島的自然饋贈，那麼靠近機場的藍湖溫泉（Blue Lagoon）是一個理想的去處，讓您在離開前能夠徹底放鬆，帶走旅途的疲憊。在您準備進入機場，開始離境流程之前，請記得辦理退稅手續。冰島的退稅點位於機場一樓大廳。在通過海關檢查後，您還將遇到免稅店，那裡有各種國際品牌和冰島特色商品，是您挑選最後伴手禮的好地方。我們衷心地希望，這次旅程給您留下了美好的回憶，並期待在不久的將來，能再次歡迎您回到冰島，繼續探索這片神秘而美麗的土地。",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "[{\"tag\":\"PARAGRAPH\",\"content\":[{\"tag\":null,\"content\":[\"大樂旅行社旅行提供各類出行方式。對於任意旅行方式，您都可以自由選擇適合您的開始日期。\"]",
        },
        {
