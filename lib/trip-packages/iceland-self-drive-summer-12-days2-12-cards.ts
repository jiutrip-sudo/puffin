...
export const icelandSelfDriveSummer12Day2Highlights: TripAttraction[] = [
    thingvellirSpot,
    geysirSpot,
    gullfossSpot,
...
export const icelandSelfDriveSummer12Day2OptionalActivities: TripAttraction[] = [
...
export const icelandSelfDriveSummer12Day3Highlights: TripAttraction[] = [
    seljalandsfossSpot,
    gljufrabuiSpot,skogafossSpot,
    planeWreckSpot,
    dyrholaeySpot,reynisdrangarSpot,reynisfjaraSpot,
    vikSpot,
];

export const icelandSelfDriveSummer12Day3OptionalActivities: TripAttraction[] = [
    solheimajokullGlacierHikingSpot,
    reynisfjaraAtvSpot,planeWreckShuttleSpot,katlaIceCaveSpot,vikLavaShowSpot,
    vikHorseRidingSpot,
];

export const icelandSelfDriveSummer12Day4Highlights: TripAttraction[] = [
...
export const icelandSelfDriveSummer12Day4OptionalActivities: TripAttraction[] = [
...
export const icelandSelfDriveSummer12Day5Highlights: TripAttraction[] = [
    vestrahornSpot,
    djupivogurSpot,
    faskrudsfjordurSpot,seydisfjordurSpot,egilsstadirSpot,
];

export const icelandSelfDriveSummer12Day5OptionalActivities: TripAttraction[] = [
    vokBathsSpot,
];

export const icelandSelfDriveSummer12Day6Highlights: TripAttraction[] = [
    dettifossSpot,husavikSpot,myvatnSpot,
    myvatnGeothermalSpot,
];

export const icelandSelfDriveSummer12Day6OptionalActivities: TripAttraction[] = [
    husavikWhaleWatchingSpot,
    geoseaSpot,
];

export const icelandSelfDriveSummer12Day7Highlights: TripAttraction[] = [
    myvatnGeothermalSpot,
    namafjallSpot,
    grjotagjaSpot,dimmuborgirSpot,skutustadagigarSpot,godafossSpot,
    akureyriSpot,
    akureyrarkirkjaSpot,
    akureyriBotanicalGardenSpot,
];

export const icelandSelfDriveSummer12Day7OptionalActivities: TripAttraction[] = [
    myvatnNatureBathsSpot,
];

export const icelandSelfDriveSummer12Day8Highlights: TripAttraction[] = [
    dalvikSpot,
    siglufjordurSpot,blonduosSpot,hvammstangiSpot,
    hvitserkurSpot,
];

export const icelandSelfDriveSummer12Day8OptionalActivities: TripAttraction[] = [

];

export const icelandSelfDriveSummer12Day9Highlights: TripAttraction[] = [
    deildartunguhverSpot,
    reykholtSpot,hraunfossarSpot,
    barnafossSpot,
];

export const icelandSelfDriveSummer12Day9OptionalActivities: TripAttraction[] = [
    langjokullIceTunnelSpot,
    vidgelmirLavaCaveSpot,
    kraumaSpot,
];

export const icelandSelfDriveSummer12Day10Highlights: TripAttraction[] = [
...
export const icelandSelfDriveSummer12Day10OptionalActivities: TripAttraction[] = [
    hvammsvikTicketSpot,vatnshellirCaveSpot,
];

export const icelandSelfDriveSummer12Day11Highlights: TripAttraction[] = [
    oldHarbourSpot,harpaSpot,
    sunVoyagerSpot,
    baejarinsBeztuSpot,phallologicalMuseumSpot,
];

export const icelandSelfDriveSummer12Day11OptionalActivities: TripAttraction[] = [
    skyLagoonTicketSpot,
    reykjavikWhaleWatchingSpot,
    reykjavikSeaAnglingSpot,insideVolcanoSpot,
    hvammsvikTicketSpot,flyoverIcelandSpot,
    reykjavikLavaShowSpot,
    perlanMuseumSpot,
];

export const icelandSelfDriveSummer12Day12Highlights: TripAttraction[] = [
    reykjavikSpot,
    keflavikAirportSpot,
];

export const icelandSelfDriveSummer12Day12OptionalActivities: TripAttraction[] = [
    flyoverIcelandSpot,
    reykjavikLavaShowSpot,
    perlanMuseumSpot,
