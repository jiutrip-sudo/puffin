...
export const icelandSelfDriveWinter8: TripPackage = {
  ...
  intro: {
    summary:
      "這個 8 天 7 夜冰島冬季環島自駕遊，沿一號公路環島，涵蓋黃金圈、南岸、冰河湖、東部峽灣、米湖與西部白銀圈。",
    full: `這個 8 天 7 夜冰島冬季 1 號公路環島自駕，帶您沿環島公路深入冰島冬日風光。行程涵蓋黃金圈、南岸瀑布與黑沙灘、傑古沙龍冰河湖與鑽石沙灘、神秘迷人的東部峽灣、北部米湖地區，以及西部白銀圈風光。
...
全程由您掌控方向盤，靈活安排冰川徒步、藍冰洞、溫泉等自選活動。預訂後將收到專屬中文路書，冬季亦有機會追尋北極光，盡收冰島環島冬日精華。`,
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        "米湖（Mývatn）位於冰島北部，是環島自駕的經典北部亮點。周邊分布著偽火山、熔岩地貌、地熱區與豐富鳥類生態，冬季雪景下尤為壯麗。",
  ...
  routeStops: [
    ...
    { label: "第 7 天", detail: "西部白銀圈（熔岩瀑布、兒童瀑布）→ 雷克雅未克" },
    { label: "第 8 天", detail: "雷克雅未克市區（可選）→ 機場離境" },
  ],
  routeMap: {
    waypoints: [
      {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "北部",
      description:
        "前往北部米湖地區，探索偽火山、熔岩地貌與地熱奇景。米湖周邊是冬季追極光的熱門區域之一，請留意路況與天氣預報。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "返回首都途中遊覽西部白銀圈：熔岩瀑布（Hraunfossar）、兒童瀑布（Barnafoss）等西部特色景觀，傍晚回到雷克雅未克入住。",
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "前往凱夫拉維克國際機場還車離境。若航班較晚，可在雷克雅未克市區最後走走逛逛。我們歡迎您下次再來冰島！",
