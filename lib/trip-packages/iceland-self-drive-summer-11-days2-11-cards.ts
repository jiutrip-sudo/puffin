...
export const icelandSelfDriveSummer11Day2Highlights: TripAttraction[] = [
  {
    name: "辛格維利爾國家公園",
...
export const icelandSelfDriveSummer11Day2OptionalActivities: TripAttraction[] = [
  {
...
export const icelandSelfDriveSummer11Day3Highlights: TripAttraction[] = [
  {
    name: "塞里雅蘭瀑布",
...
export const icelandSelfDriveSummer11Day3OptionalActivities: TripAttraction[] = [
  {
    name: "索爾黑馬冰川徒步",
...
export const icelandSelfDriveSummer11Day4Highlights: TripAttraction[] = [
  {
    name: "埃爾德熔岩原",
    nameEn: "Eldhraun",
    region: "冰島南部",
...
export const icelandSelfDriveSummer11Day4OptionalActivities: TripAttraction[] = [
  {
    name: "斯卡夫塔冰川徒步",
...
export const icelandSelfDriveSummer11Day5Highlights: TripAttraction[] = [
  {
    name: "西角山",
    nameEn: "Vestrahorn",
    region: "冰島東部",
...
export const icelandSelfDriveSummer11Day5OptionalActivities: TripAttraction[] = [
  {
...
export const icelandSelfDriveSummer11Day6Highlights: TripAttraction[] = [
  {
    name: "黛提瀑布",
    nameEn: "Dettifoss",
    region: "冰島北部",
...
export const icelandSelfDriveSummer11Day6OptionalActivities: TripAttraction[] = [
  {
    name: "米湖天然溫泉入場票",
...
export const icelandSelfDriveSummer11Day7Highlights: TripAttraction[] = [
  {
    name: "眾神瀑布",
    nameEn: "Goðafoss",
    region: "冰島北部",
...
export const icelandSelfDriveSummer11Day7OptionalActivities: TripAttraction[] = [
  {
    name: "米湖天然溫泉入場票",
    imageUrl: IMG("myvant_949e057f28_48fd938e84.avif"),
    galleryImages: [
  ...
  },
  {
    ...
    paragraphs: [
      "豪加內斯（Hauganes）坐落在冰島北部壯麗的海岸線上，距離阿克雷裡（Akureyri）不遠，擁有廣闊的海域和豐富的海洋生物資源。在這裡出海觀鯨，本次行程您將可以與座頭鯨、海豚等迷人海洋生物近距離接觸。",
      "當您踏上觀鯨船時，您將開始一場令人興奮的冒險。船隻駛向海洋深處，伴隨著清新的海風和波浪聲，您將被冰島壯麗的自然景色所包圍。遠處是崇山峻嶺和綿延的海岸線，而海面上則是碧藍的水域和被陽光照耀的浪花，大自然的美麗在此刻盡顯。船員經驗豐富，他們會確保您的安全和舒適，並與您分享關於海洋生物的知識。",
      "當船隻不斷駛入海域時，您將在專業船員指導下，手持漁具、繫上魚餌，與船友們一同分享歡聲笑語，共同期待著豐厚的捕撈。無論您是釣魚新手還是經驗豐富的釣手，您都可以懷著期待耐心等待魚兒上鉤。相信釣上魚兒的那一刻成就感絕對讓您欣喜若狂！在海釣的過程中，您也可以隨時注意海面動靜，視野良好，運氣使然時，鯨魚也可能隨時出沒在您的眼前。或許突然，一隻巨大的座頭鯨從海面上升起，向您展示它的雄姿。您可以親眼目睹它們優雅的水下動作甚至噴水孔噴出的水花，深刻感受到大海和海洋生物的神秘之美。",
      "體驗時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
      "注意事項：",
      "1. 出海觀鯨途中會為您提供可以套在衣物外面的連體防寒服（同時我們也建議您根據季節穿著合適的保暖裡衣、戶外衣物等）。",
      "2. 請您至少提前30分鐘到達觀鯨集合點。",
      "3. 本次行程發團取決於天氣和海況，為了您的安全和舒適，如果因天氣或其他條件發生變化不適宜出海，本次行程保留更改或取消出發的權利，相應政策請參考大樂旅行社旅行服務條款。",
    ],
  },
];

export const icelandSelfDriveSummer11Day8Highlights: TripAttraction[] = [
  {
    name: "布倫迪歐斯",
    nameEn: "Blönduós",
    region: "冰島北部",
...
export const icelandSelfDriveSummer11Day8OptionalActivities: TripAttraction[] = [
  {
...
export const icelandSelfDriveSummer11Day9Highlights: TripAttraction[] = [
  {
    name: "斯蒂基斯霍爾米",
...
export const icelandSelfDriveSummer11Day9OptionalActivities: TripAttraction[] = [
  {
...
export const icelandSelfDriveSummer11Day10Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克舊港",
...
export const icelandSelfDriveSummer11Day10OptionalActivities: TripAttraction[] = [
  {
...
export const icelandSelfDriveSummer11Day11Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克",
    nameEn: "Reykjavík",
    region: "雷克雅未克",
...
export const icelandSelfDriveSummer11Day11OptionalActivities: TripAttraction[] = [
  {
    name: "雷克雅未克市區Flyover Iceland飛越冰島4D電影",
    imageUrl: IMG("flyover_iceland_cover_59d7c22b26.png"),
    galleryImages: [
