...
import {
  icelandSelfDriveWinter10Day1Highlights,
  icelandSelfDriveWinter10Day1OptionalActivities,
} from "./iceland-self-drive-winter-10-day1-cards";
import {
  icelandSelfDriveWinter10Day2Highlights,
  icelandSelfDriveWinter10Day2OptionalActivities,
  icelandSelfDriveWinter10Day3Highlights,
  icelandSelfDriveWinter10Day3OptionalActivities,
  icelandSelfDriveWinter10Day4Highlights,
  icelandSelfDriveWinter10Day4OptionalActivities,
  icelandSelfDriveWinter10Day5Highlights,
  icelandSelfDriveWinter10Day5OptionalActivities,
  icelandSelfDriveWinter10Day6Highlights,
  icelandSelfDriveWinter10Day6OptionalActivities,
  icelandSelfDriveWinter10Day7Highlights,
  icelandSelfDriveWinter10Day7OptionalActivities,
  icelandSelfDriveWinter10Day8Highlights,
  icelandSelfDriveWinter10Day8OptionalActivities,
  icelandSelfDriveWinter10Day9Highlights,
  icelandSelfDriveWinter10Day9OptionalActivities,
  icelandSelfDriveWinter10Day10Highlights,
  icelandSelfDriveWinter10Day10OptionalActivities,
} from "./iceland-self-drive-winter-10-days2-10-cards";

export const icelandSelfDriveWinter10: TripPackage = {
  ...
  backLabel: "返回 10 日行程",
  heroImage:
    "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1920,q_auto:good/62d0377ef1ce9_6c3c49b775.jpg",
  whyChooseUs: [
    {
      id: "deposit",
      title: "20% 訂金",
  ...
  intro: {
    summary:
      "這個 10 天 9 夜冰島冬季深度環島自駕，沿一號公路完整環島，並深入斯奈山半島，節奏從容。",
    full: `這個 10 天 9 夜冰島冬季深度環島自駕，是冬季環島的完整之選。行程涵蓋黃金圈、南岸、冰河湖、東部峽灣、米湖、北部眾神瀑布與阿克雷里、西部風光，以及被稱為「冰島縮影」的斯奈山半島。

比 9 天行程多一日斯奈山半島探索，讓環島節奏更從容。全程由您掌控方向盤，靈活安排冰川徒步、藍冰洞、溫泉等自選活動，並有機會追尋北極光。`,
  },
  gallery: [
    {
      id: "aurora",
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "斯奈山半島被稱為「冰島縮影」，是 10 天環島自駕的經典收官亮點。",
      ],
    },
  ],
  ...
  routeStops: [
    ...
    { label: "第 8 天", detail: "西部沿途風光 → 雷克雅未克" },
  ...
  itinerary: [
    {
      ...
      highlights: icelandSelfDriveWinter10Day1Highlights,
      optionalActivities: icelandSelfDriveWinter10Day1OptionalActivities,
    },
    {
      day: 2,
      title: "黃金圈",
      ...
      highlights: icelandSelfDriveWinter10Day2Highlights,
      optionalActivities: icelandSelfDriveWinter10Day2OptionalActivities,
    },
    {
      day: 3,
      title: "南岸風光",
      ...
      highlights: icelandSelfDriveWinter10Day3Highlights,
      optionalActivities: icelandSelfDriveWinter10Day3OptionalActivities,
    },
    {
      day: 4,
      title: "冰河湖風光",
      ...
      highlights: icelandSelfDriveWinter10Day4Highlights,
      optionalActivities: icelandSelfDriveWinter10Day4OptionalActivities,
    },
    {
      day: 5,
      title: "東部峽灣風光",
      ...
      highlights: icelandSelfDriveWinter10Day5Highlights,
      optionalActivities: icelandSelfDriveWinter10Day5OptionalActivities,
    },
    {
      day: 6,
      title: "米湖風光",
      ...
      highlights: icelandSelfDriveWinter10Day6Highlights,
      optionalActivities: icelandSelfDriveWinter10Day6OptionalActivities,
    },
    {
      day: 7,
      title: "北部風光",
      ...
      highlights: icelandSelfDriveWinter10Day7Highlights,
      optionalActivities: icelandSelfDriveWinter10Day7OptionalActivities,
    },
    {
      day: 8,
      title: "西部沿途風光",
      accommodation: "雷克雅未克",
      description:
        "從北部返回首都途中，遊覽西部沿途風光：博爾加峽灣沿線的熔岩瀑布、兒童瀑布等西部特色景觀，傍晚回到雷克雅未克入住。",
      highlights: icelandSelfDriveWinter10Day8Highlights,
      optionalActivities: icelandSelfDriveWinter10Day8OptionalActivities,
    },
    {
      day: 9,
      title: "斯奈山半島",
      ...
      highlights: icelandSelfDriveWinter10Day9Highlights,
      optionalActivities: icelandSelfDriveWinter10Day9OptionalActivities,
    },
    {
      day: 10,
      title: "離境日",
      ...
      highlights: icelandSelfDriveWinter10Day10Highlights,
      optionalActivities: icelandSelfDriveWinter10Day10OptionalActivities,
    },
  ],
  inclusions: {
    included: [
