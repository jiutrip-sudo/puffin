...
export const icelandSelfDriveWinter10: TripPackage = {
  ...
  intro: {
    summary:
      "這個 10 天 9 夜冰島冬季一號公路完整環島自駕，沿著冰島最著名的環島公路，盡覽黃金圈、南岸、東部峽灣、米湖、眾神瀑布、阿克雷里、西部風光與斯奈山半島等冬日精華。行程充分顧及冬季日照與路況，節奏適中、安排務實。",
    full: `這個 10 天 9 夜冰島冬季一號公路完整環島自駕，沿著冰島最著名的環島公路，盡覽黃金圈、南岸、東部峽灣、米湖、眾神瀑布、阿克雷里、西部風光與斯奈山半島等冬日精華。套餐充分顧及冬季日照時數與路況，行程安排合理、節奏適中。
...
往東則穿越寧靜的東部峽灣海岸；北上米湖（Lake Mývatn）地區探索火山地質奇景，並造訪眾神瀑布（Goðafoss）與「北方之都」阿克雷里（Akureyri）。回程則遊覽西部熔岩瀑布等風光，並安排一日探索「冰島縮影」斯奈山半島（Snæfellsnes），為環島旅程劃下句點。
