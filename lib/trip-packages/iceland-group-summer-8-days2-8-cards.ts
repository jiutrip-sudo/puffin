...
export const icelandGroupSummer8Day2Highlights: TripAttraction[] = [
  {
    name: "辛格維利爾國家公園",
...
export const icelandGroupSummer8Day2OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer8Day3Highlights: TripAttraction[] = [
  {
    name: "塞里雅蘭瀑布",
...
export const icelandGroupSummer8Day3OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer8Day4Highlights: TripAttraction[] = [
  {
    name: "傑古沙龍冰河湖",
    nameEn: "Jökulsárlón",
    region: "冰島東部",
...
export const icelandGroupSummer8Day4OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer8Day5Highlights: TripAttraction[] = [
  {
    name: "教會山",
    nameEn: "Kirkjufell",
    region: "斯奈山半島",
...
export const icelandGroupSummer8Day5OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer8Day6Highlights: TripAttraction[] = [
  {
    name: "火山內部探險",
    region: "冰島西部",
...
export const icelandGroupSummer8Day6OptionalActivities: TripAttraction[] = [
  {
    name: "火山內部探險",
...
export const icelandGroupSummer8Day7Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克舊港",
...
export const icelandGroupSummer8Day7OptionalActivities: TripAttraction[] = [
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "本次行程您將乘坐超級吉普從首都雷克雅未克出發，開啟您的冰洞探索之旅。在日光允許的情況下（約從2月1日到11月15日），您將在途中游覽冰島南岸著名的斯科加瀑布（Skógafoss）和塞里雅蘭瀑布（Seljalandsfoss），感受水流澎湃。",
      ...
      "您的嚮導將與您分享有關冰洞的歷史，解釋冰洞是如何形成的科學知識，同時也會留有足夠時間供您拍照紀念。探險結束後，您將於約晚上 8:00 左右返回雷克雅未克，具體時間依據當天情況而定。",
      "注意事項：",
...
export const icelandGroupSummer8Day8Highlights: TripAttraction[] = [
  {
    name: "凱夫拉維克國際機場",
...
export const icelandGroupSummer8Day8OptionalActivities: TripAttraction[] = [
  {
