...
export const icelandGroupWinter10: TripPackage = {
  ...
  intro: {
    summary:
      "這個 10 天 9 夜冰島冬季一號公路完整環島跟團，由品質小巴團與專業嚮導帶領，盡覽黃金圈、南岸、東部峽灣、米湖、觀鯨、西部與斯奈山半島等冬日精華。行程充分顧及冬季日照與路況，節奏適中、安排務實。",
    full: `這個 10 天 9 夜冰島冬季一號公路完整環島跟團，由品質小巴團與專業嚮導帶領，沿環島一號公路盡覽黃金圈、南岸、東部峽灣、米湖、觀鯨、西部與斯奈山半島等冬日精華。套餐充分顧及冬季日照時數與路況，行程安排合理、節奏適中。
...
往東穿越東部峽灣海岸；北上米湖（Lake Mývatn）地區探索火山地質奇景，並造訪眾神瀑布（Goðafoss）與「北方之都」阿克雷里（Akureyri）。回程則安排北部觀鯨、西部熔岩瀑布（Hraunfossar）等風光，並探索「冰島縮影」斯奈山半島（Snæfellsnes）。途中亦可另行加購雪地摩托、溫泉體驗或極光船遊等冬季活動。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島環島精華。`,
  },
  gallery: [
    {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "西部",
      description:
        "今日從阿克雷里出發，前往豪加內斯（Hauganes）出海觀鯨。專業嚮導將介紹當地海洋生態，若運氣佳可見到座頭鯨、海豚等海洋生物。觀鯨結束後繼續向西前進，途中嚮導將在風景優美的地點適時停車。今晚入住西部。",
