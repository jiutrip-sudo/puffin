...
export const icelandGroupWinter10: TripPackage = {
  ...
  intro: {
    summary:
      "如果您對冰島旅遊還不是很熟悉，不如將旅行計劃交給我們。我們將為您設計一個充實的冰島之旅，涵蓋最值得打卡的景點和最具代表性的風景，讓人文和自然完美融合，讓悠閒和冒險相得益彰，節奏恰到好處，行程豐富多彩。",
    full: `如果您對冰島旅遊還不是很熟悉，不如將旅行計劃交給我們。我們將為您設計一個充實的冰島之旅，涵蓋最值得打卡的景點和最具代表性的風景，讓人文和自然完美融合，讓悠閒和冒險相得益彰，節奏恰到好處，行程豐富多彩。

在10天9夜的冰島冬季環島之旅中，我們將在極北首都雷克雅未克，感受北歐風情的獨特魅力。隨後，您將開啟冰島南岸精華之旅，遊覽經典的黃金圈（Golden Circle），感受辛格維利爾國家公園（Þingvellir National Park）的自然與人文氣息。同樣，您還將有機會進行刺激的冰川徒步探險，親身體驗冰川的神秘與壯美。同時，我們將深入冰洞內部，一探其中的奇幻景象，並在浪漫的冰河湖和鑽石沙灘（Diamond Beach）留下美麗的瞬間。

旅程中，您還將在東部峽灣體驗漁民的一天，探訪冰島北部的火山地貌，出海觀鯨復刻維京人的日常。除此之外，冰島西部沿途風光同樣美不勝收，您將探秘秀美的熔岩瀑布（Hraunfossar）和兒童瀑布（Barnafossar），觀賞到歐洲最大流速溫泉，而在西部斯奈山半島（Snæfellsnes），這個被譽為

如果天氣晴朗，極光指數可佳，我們還將帶您在途中選擇最佳的觀賞點停車，或是在飯店附近，由我們的嚮導陪伴您一同欣賞極光的壯麗景象。無論是遊覽景點還是深入其中參加冰島特色體驗，我們都將為您安排得井井有條，讓您的旅程充滿難忘的回憶。

由於冬季環島團發團日期及團次位置有限，請預定前聯繫客服查看您想預定的日期是否有餘位。`,
  },
  gallery: [
    {
  ...
  attractions: [
    ...
    },
    {
      ...
      imageUrl: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/barnafoss_west_iceland_3b18a3043e.jpg",
      galleryImages: [
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/barnafoss_west_iceland_3b18a3043e.jpg",
      ],
      paragraphs: [
        "略顯悲劇色彩的傳奇瀑布",
  ...
  routeStops: [
    ...
    { label: "第 3 天", detail: "南岸 → 塞里雅蘭／斯科加瀑布 → 冰川徒步 → 黑沙灘" },
    ...
    { label: "第 9 天", detail: "冰島西部（赫倫瀑布 → 兒童瀑布 → 德爾達圖赫菲溫泉）" },
    { label: "第 10 天", detail: "雷克雅未克 → 機場離境" }
  ],
  routeMap: {
    waypoints: [
      {
  ...
  itinerary: [
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "今天是您來到冰島的第一天，歡迎入境冰島！我們為您安排了貼心的接機服務，您可以選擇乘坐機場大巴抵達雷克雅未克市區飯店。如果您是上午或下午的航班，我們還為您準備了一個令人興奮的行程：前往冰島最著名的溫泉之一——天空之境溫泉（Sky lagoon），這裡是冰島的網紅溫泉，您可以在無邊泳池中盡情地享受海景美景，讓身心得到深度放鬆，洗去長途飛行的疲累，感受冰島溫泉的獨特魅力。如果您是晚間抵達雷克雅未克，我們建議您在飯店早早休息，為接下來的旅程做好準備。",
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "第一天的行程我們將來到冰島著名的黃金圈景區（Golden Circle），這裡匯聚了冰島最著名的三大景點：辛格維利爾國家公園（Þingvellir National Park）、間歇泉（Geysir）和黃金瀑布（Gullfoss）。冰島最著名的蓋歇爾間歇泉（The Great Geysir），它的名字甚至成為了英語中“間歇泉”的代名詞。然而，如今它已經不太噴發，而其旁邊的史托克間歇泉（Strokkur)，它每隔幾分鐘就會噴發一次，將高達20米的熱水噴向天空，非常壯觀。黃金圈內另一著名景點是黃金瀑布。瀑布呈兩級奔流而下，在陽光照耀下甚至會呈現出美麗的彩虹，非常壯觀。冬季白雪覆蓋山谷，與白色的瀑布水流相得益彰。您可以在此感受到水花的噴濺和巨大的能量。今天我們還將前往辛格維勒國家公園，這裡是冰島歷史和文化的重要場所，也是世界上唯一一個位於兩個地質板塊交匯處的國家公園。您可以在此欣賞美麗的峽谷、清澈的湖泊和壯觀的瀑布，盡情沉浸於大自然的綺麗。",
      highlights: icelandGroupWinter10Day2Highlights,
      optionalActivities: icelandGroupWinter10Day2OptionalActivities,
    },
    {
      day: 3,
      title: "塞里雅蘭瀑布、斯科加瀑布、維克黑沙灘、冰川徒步",
      accommodation: "南岸",
      description:
        "來到冰島南岸，這裡的風光同樣美不勝收。塞里雅蘭瀑布（Seljalandsfoss）水流從峭壁上垂直落下。最特別的是，旅客能沿著瀑布後面的小路，繞到瀑布的背後，欣賞到瀑布的完整景色。此時，你可以看到瀑布的水流從高處落下，跌入下方水潭。由於瀑布水流較大，所以在瀑布背後棧道行走時需要小心，以免滑倒。相比之下，斯科加瀑布（Skógafoss）擁有另一種別樣景緻，高達60米的水流從峭壁上傾瀉而下，宛如仙女飄落人間的白色帷幕，令人心醉神迷。站在瀑布旁邊，你會感受到強烈的水氣和震耳欲聾的響聲，彷彿置身於大自然的洪荒之中，震撼不已。隨後我們也將來到黑沙灘（Reynisfjara ），這裡的沙子由火山噴發形成，呈現黑色，和深藍色海水衝擊岸邊形成的白色浪花相映成趣，形成了一幅絕美的畫卷。您今日的行程亮點是索爾黑馬冰川（Sólheimajökull）徒步，整個冰川徒步時間約2.5-3小時，輕鬆愉快，屬於冰島冰川徒步項目中，最適合大眾人體驗的項目。跟隨專業嚮導一起，感受冰川的神奇壯麗！",
    ...
    },
    {
      ...
      description:
        "今天我們將繼續在南岸暢遊，帶您進入冰的王國：前往傑古沙龍冰河湖（Jökulsárlón）和鑽石沙灘（Diamond Beach）。當你站在冰河湖邊，你會看到湖面上漂浮著各種大小及形狀各異的冰塊，它們在湖面上緩緩漂流，散發著耀眼的光芒。這些冰塊的顏色從透明到藍色、綠色、灰色不等遠遠望去，宛如一幅冬日裡的神奇畫卷。在離傑古沙龍冰河湖不遠處的鑽石沙灘上，你會看到散落在黑色沙灘上的美麗冰塊，這些冰塊由冰河湖中的暗流沖刷上岸，閃爍著晶瑩剔透的光芒，好像一顆顆閃閃發光的鑽石。這些冰塊有的像是鑽石，有的像是心形，還有的像是動物形狀，並不規則。然而，每一塊冰塊都獨一無二，散發著神秘而浪漫的氣息。除了這兩處美景，今日最為令人振奮的活動便是藍冰洞探險，佩戴好專業冰川徒步的裝備，專業嚮導將帶您進入獨一無二的藍冰洞，感受冰川的神奇力量，欣賞一塊塊冰晶湛藍。當你欣賞這些美景時，相信你會感受到自己的微小和渺小，也會感受到大自然的偉大和壯美。",
    ...
    },
    {
      ...
      accommodation: "東部峽灣",
      description:
        "經過前幾天的行程，繼續向東前行，我們將帶您前往東部峽灣。冰島東部峽灣是一個由許多峽灣和山脈構成的區域，這裡的峽灣和山脈形態各異，壯麗而美麗。你可以看到高聳入雲的山峰、雄偉的瀑布和清澈的湖泊。我們或許也能在途中偶遇各種野生動物，穿過罕見的森林。除了自然風光外，這裡還有一些迷人的城市景觀。我們將會在附近的城市落腳。埃伊爾斯塔濟（Egilsstaðir）是冰島東部地區的最大城市，這裡有一些歷史悠久的建築和博物館，您可以在這裡瞭解到冰島的歷史和文化藝術，感受東部漁民的生活。為了豐富您在東部的行程，我們還為您提供了兩個額外的自費項目：東部騎馬體驗 和VÖK Baths湖上溫泉體驗，您可以聯繫我們的客服為您預定。如果您在首都沒有機會和可愛的冰島小矮馬親密接觸，也還沒有體驗到冰島獨有的地熱溫泉，那這次在東部的行程您可以就一定不要錯過了！",
    ...
    },
    {
      ...
      accommodation: "米湖或北部",
      description:
        "在冰島北部，絕對不能錯過的美景便是米湖地區（Lake Mývatn）。米湖是冰島最美的湖泊之一，藍綠色湖水置於一片荒涼火山地貌中，是許多水鳥的棲息地。接下來我們會參觀Hverir地熱泥漿池，這裡火山活躍，熱氣騰騰，讓人感受到火星既視感，被譽為“惡魔的廚房”。離米湖不遠處有一片名為Dimmuborgir的熔岩柱群，也被稱之為“黑暗城堡”，這裡是由黑色火山岩形成的奇觀，有著各種各樣的奇特造型，可謂是怪石嶙峋，讓人彷彿置身於一個巨魔的世界中。同樣，北部的眾神瀑布（Goðafoss）絲毫不遜於南部瀑布，氣勢磅礴恢弘。除了美麗的景觀外，這個瀑布還有一個傳說。據傳說，約在公元1000年左右，冰島國會討論是否要接受基督教信仰。最終，法律代表人將北歐神像扔進了眾神瀑布中任其奔流而去，象徵著放棄了傳統信仰，轉向了基督教。眾神瀑布的美景和傳說相互映襯，形成了冰島獨特的文化和歷史。最後我們將會前往冰島北部城市阿克雷裡（Akureyri），領略真正的“北”國風情。",
    ...
    },
    {
      ...
      accommodation: "西部",
      description:
        "今天我們將從阿克雷裡出發前往北部小漁村豪加內斯村（Hauganes），參加出海觀鯨體驗。您會乘坐船出海，船上會有專業的嚮導介紹當地的鯨魚種類和生態環境，讓你更瞭解這些神秘的生物。然後，你會開始尋找鯨魚的蹤跡，如果幸運的話，你會看到巨大的鯨魚在海面上躍出水面，或者看到它們在水下游動的景象，非常震撼。您將有機會近距離觀察到座頭鯨、海豚、海鳥等一系列海洋生物，感受大自然的魅力，以及萬物生靈平等的美好。同時，村莊周圍的景色也非常迷人，你可以在那裡欣賞到美麗的海岸線和壯觀的山脈，享受到冰島獨特的自然風光。結束觀鯨之旅後，我們將繼續向西前進，一路上我們的嚮導會在風景優美的地方停車，讓您可以欣賞到更多的美景。",
    ...
    },
    {
      ...
      accommodation: "西部",
      description:
        "今天，您將前往冰島斯奈山半島（Snæfellsnes），探訪這個被賦予“冰島縮影”之稱的地方。你會來到Gerðuberg稜柱懸崖，這裡的石柱形狀對稱標準，好似有人為雕刻過一般，但這其實是大自然的產物。接下來，我們將前往海豹沙灘（Ytri-Tunga），沙灘顏色在陽光照耀下泛著淺淺的金光，而小海豹們在礁石上曬太陽或在海里露出小腦袋，非常可愛。之後，您將前往Djúpalónsandur黑沙灘，這裡到處是黑色鵝卵石，沙灘兩側矗立著嶙峋的怪石，景色獨特，被稱為“深海珍珠”。今天的高光時刻必須是前往教會山（Kirkjufell），這座山被旅客戲稱為“草帽山”。前有雙層瀑布，後有群山大海圍繞，景色別具一格，開闊大氣，因而吸引各大攝影師爭相拍攝，並在《權力的遊戲》遊戲中作為“箭頭山”的取景地。當晚如果極光指數和天氣允許，我們嚮導也會邀請您一起欣賞極光哦。您今日的行程中還有一個額外自費項目供您選擇：Víðgelmir熔岩洞穴探險，這個活動約1.5小時，您將有機會參觀這個冰島最長的熔岩洞穴，瞭解火山噴發對塑造冰島文化的深遠影響。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "環島之遊的最後一日，我們會前往冰島西部的博爾加峽灣地區（Borgarfjörður），欣賞赫倫瀑布（Hraunfossar）和兒童瀑布（Barnafossar）。與冰島其他壯闊的瀑布不同，熔岩瀑布由多條溪流從豪德門達熔岩原(Hallmundarhraun)流出，最終匯聚在一起，形成了這樣一風光秀美、景色宜人的瀑布群。兒童瀑布則是熔岩瀑布旁一處更加湍急的瀑布，同樣是湛藍的河水，交織匯聚成了一幅美不勝收的油畫。然而，這一美麗景色的背後卻也流傳著一個悲傷傳說，不妨聽嚮導為您細細講述。除此之外，我們還會參觀歐洲流速最快的溫泉：德爾達圖赫菲溫泉（Deildartunguhver），它每秒流量達180公升，遠觀即可感受溫泉水的氣勢和溫度。這一溫泉也為該地區提供熱能供暖。在這一天精彩而多樣的行程最後，我們將返回雷克雅未克，結束這次難忘的環島之旅。",
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "今天是您的離境日，就要和您說再見了。如果您的航班時間較晚，不妨再在雷克雅未克走走逛逛，喝一杯醇香的咖啡，或者再去首都的各大地標性建築參觀，品嚐北歐美食，體驗特色活動，感受當地人的日常生活。如果您還有時間，不妨去市中心的免稅店購買一些冰島特產作為伴手禮，以留下珍貴的冰島回憶。要提醒您的是，離開之前別忘了在機場一樓大廳辦理退稅手續。我們祝您一路順風，希望本次冰島之旅您收穫滿滿，期待與您下次相遇！",
