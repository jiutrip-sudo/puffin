...
export const icelandGroupWinter4: TripPackage = {
  ...
  intro: {
    summary:
      "冰島冬日精簡4日遊，精選南岸最具代表性的景點和特色體驗，讓您在兩日體驗冰島南岸精華景點。",
    full: `冰島冬日精簡4日遊，精選南岸最具代表性的景點和特色體驗，讓您在兩日體驗冰島南岸精華景點。

我們4日套餐包含2天的南岸品質小巴團以及市區住宿和溫泉體驗。我們將帶領您穿越南岸的壯麗景觀，您將有機會欣賞到秀麗壯美的瀑布，如塞里雅蘭瀑布（Seljalandsfoss）和斯科加瀑布（Skógafoss），它們從高聳的峭壁上奔騰而下，營造出壯觀的景象。您還將近距離接觸冰川，感受其壯麗的冰川景觀。

除了瀑布和冰川，您還將前往冰島南岸最著名的景點之一：冰河湖。在冰河湖中，您將看到漂浮的冰山和冰川碎片，這些景象令人歎為觀止。在冰河湖旁的鑽石沙灘上，您還可以欣賞到冰山的碎片被海浪衝刷成璀璨的鑽石般的景象，別有一番風情。

如果您在極光季節參加這個團，嚮導將帶領您去遠離光汙染的地方，尋找最佳觀賞極光的機會。您將在寒冷的冬夜中，仰望天空，期待著神秘而美麗的極光出現，這將是一次難以忘懷的體驗。`,
  },
  gallery: [
    {
      id: "1_1_cd1cf553bf",
  ...
  itinerary: [
    {
      day: 1,
      title: "入境日：雷克雅未克&舒適溫泉",
      accommodation: "雷克雅未克",
      description:
        "今日是您抵達冰島的第一天，我們為您安排了凱夫拉維克機場抵達市區飯店的機場大巴，您可以乘坐機場大巴前往市區飯店或就近的巴士站。之後在飯店稍作休息後，開始您正式的冰島之行。如果您是上午或者下午的航班，在抵達冰島後還有足夠的時間，我們還為您安排了冰島網紅溫泉：天空之境溫泉（Sky Lagoon），您可以在Sky lagoon的無邊泳池中，盡享海景風光，放鬆身心。如果您是晚間抵達雷克雅未克，不如在市區飽餐一頓，品嚐冰島美食，然後回到飯店早早休息，為您第二天的南岸精彩之行養足精神！",
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今天您會從雷克雅未克出發，抵達冰島南岸最具知名的兩大瀑布：塞里雅蘭瀑布（Seljalandsfoss）和斯科加瀑布（Skógafoss）。兩個瀑布都在冰島1號公路附近，塞里雅蘭瀑布是冰島唯一一個可以走到水幕後方的瀑布，您可以從獨特的角度欣賞瀑布和南岸的迷人風光，不過步道在冬日一般會關閉。距離塞里雅蘭瀑布20分鐘車程的是斯科加瀑布，它的水量更大，整條水幕垂直而下，在陽光照射下，常常有彩虹掛於上方，因此也有著“彩虹瀑布”的美譽。冬季時分，更有一種別樣的凌冽。今日的行程亮點：您將抵達冰島最具有代表性的沙灘——黑沙灘（Reynisfjara）。黑色的砂礫配上海浪，將給您帶來極具力量感的視覺衝擊！旁邊排列的玄武石巖柱更是彷彿奏響著自然的樂章。除此之外，您還會經過冰島主島最南端的維克鎮（Vík），欣賞這座南端小鎮的靜謐和周圍的自然風光和佇立在海中的海蝕柱，打卡最美的紅色小教堂。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "今天我們會抵達冰島南岸的明珠景點：傑古沙龍冰河湖（Jökulsárlón）和鑽石沙灘（Diamond Beach）。在冰河湖，您可以欣賞到漂浮在冰河湖中大大小小的冰川碎塊。遠處瓦特納冰川（Vatnajökull）若隱若現，在雲層中更多了一絲仙境的氣韻。除此之外，您還可能看到在湖中游玩或者在冰面上曬太陽的小海豹們。在冰島的冰河湖對面，坐落著一處令人歎為觀止的自然奇觀——鑽石沙灘。這裡的沙灘不同於世界上任何其他地方，它以其深邃的黑色沙粒而聞名，這些沙粒在陽光的照射下閃爍著神秘的光芒，彷彿是大自然精心鋪設的黑色天鵝絨地毯。而最引人注目的，莫過於那些被海浪衝上岸的冰塊，它們大小不一，形態各異，從遠處看去，就像是散落在沙灘上的無數顆未經雕琢的鑽石，在陽光下熠熠生輝，讓人不禁為之心動。穿上專業的裝備，你將跟隨嚮導穿越冰川的裂縫和冰脊，每一步都充滿了未知和挑戰。當你到達藍冰洞（Blue Ice Cave）的入口時，你將被眼前的景象深深震撼。冰洞內部的牆壁呈現出深邃的藍色，彷彿是凍結的海洋，神秘而寧靜。陽光透過冰層，將冰洞內部照亮，形成一幅幅如夢似幻的畫面。",
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "我們南岸兩日之行完美落下帷幕，如果您還有意猶未盡的地方，在飛機起飛之前，不妨在市區再遊玩一番。市區的各色博物館，治癒系的特約寧湖（Tjornin），設計感十足的哈帕音樂廳（Harpa），又或者去市區商店買一些伴手禮送給親朋好友……又或者在冰島本地的咖啡廳喝一杯咖啡，發一會呆，好好感受一下冰島人的一天。如果您在入境日未來得及體驗Sky Lagoon, 那就不妨在離境之前，去往離機場較近的藍湖溫泉好好感受一下冰島的溫泉文化。",
