...
export const icelandGroupWinter8NonRingDay2Highlights: TripAttraction[] = [
  {
    name: "塞里雅蘭瀑布",
...
export const icelandGroupWinter8NonRingDay2OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter8NonRingDay3Highlights: TripAttraction[] = [
  {
    name: "傑古沙龍冰河湖",
    nameEn: "Jökulsárlón",
    region: "冰島東部",
...
export const icelandGroupWinter8NonRingDay3OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter8NonRingDay4Highlights: TripAttraction[] = [
  {
    name: "黃金瀑布",
    nameEn: "Gullfoss",
    region: "冰島南部",
...
export const icelandGroupWinter8NonRingDay4OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter8NonRingDay5Highlights: TripAttraction[] = [
  {
    name: "赫倫瀑布",
    nameEn: "Hraunfossar",
    region: "冰島西部",
...
export const icelandGroupWinter8NonRingDay5OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter8NonRingDay6Highlights: TripAttraction[] = [
  {
    name: "教會山",
    nameEn: "Kirkjufell",
    region: "斯奈山半島",
...
export const icelandGroupWinter8NonRingDay6OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter8NonRingDay7Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克彩虹街",
...
export const icelandGroupWinter8NonRingDay7OptionalActivities: TripAttraction[] = [
  {
    name: "雷克雅未克經典觀鯨",
...
export const icelandGroupWinter8NonRingDay8Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克",
    nameEn: "Reykjavík",
    region: "雷克雅未克",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "從雷克雅未克往返凱夫拉維克國際機場，常見的方式有機場巴士與私人包車兩種。",
...
export const icelandGroupWinter8NonRingDay8OptionalActivities: TripAttraction[] = [
  {
