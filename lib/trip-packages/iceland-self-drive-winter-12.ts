...
途中亦可另行加購雪地摩托、溫泉體驗、賞鯨或極光船遊等冬季活動。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島環島精華。`,
  },
  gallery: [
    {
      id: "aurora",
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "北部",
      description:
        "今日造訪冰島北部最具盛名的眾神瀑布（Goðafoss），冰川河水從弧形懸崖傾瀉而下，冬季雪景下尤為壯麗。之後可前往「北方之都」阿克雷里（Akureyri），漫步漁港城市街道，感受北部冬日風情。亦可另行加購賞鯨、雪地摩托或米湖溫泉等體驗。今晚繼續入住北部。",
    ...
    },
    {
      ...
      accommodation: "雷克雅維克",
      description:
        "今日在雷克雅維克自由安排一日，漫步洛加維格大街（Laugavegur）、彩虹街、哈爾格林姆斯教堂、哈帕音樂廳等市區景點，品嚐當地美食，感受北歐首都的獨特氛圍。亦可另行加購 Sky Lagoon、藍湖溫泉、極光船遊或賞鯨等體驗。今晚繼續入住雷克雅維克。",
