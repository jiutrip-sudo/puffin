...
途中亦可另行加購冰川徒步、冰河湖水陸兩棲船遊、絲浮拉裂谷（Silfra）浮潛或溫泉體驗等夏季活動，或於自駕途中造訪小眾景點。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島夏季精華。`,
  },
  gallery: [
    {
  ...
  attractions: [
    {
      ...
      imageUrl: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/bluelagoon2_03f4fe484e.jpg",
      galleryImages: [
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/bluelagoon2_03f4fe484e.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/bluelagoon1_3cc32fcacd.jpg",
      ],
      paragraphs: [
        "在藍湖溫泉等待治癒時刻的來臨",
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今天請一早出發，沿冰島南岸一號公路南下。夏季日照充裕，南岸綠意盎然，瀑布與海岸在長白晝下格外清晰。\n\n首先來到塞里雅蘭瀑布（Seljalandsfoss）與斯科加瀑布（Skógafoss）；夏季可繞行塞里雅蘭瀑布後方小徑，從水簾後方欣賞不同視角。繼續南下造訪黑沙灘（Reynisfjara），沿岸玄武岩石柱層層疊疊，遠處可見雷尼斯岩（Reynisdrangar）矗立海中；沿途亦可安排 DC-3 飛機殘骸，或另行加購冰川徒步等戶外體驗。今晚入住南岸附近飯店。",
