...
export const icelandGroupWinter6Day2Highlights: TripAttraction[] = [
  {
    name: "塞里雅蘭瀑布",
...
export const icelandGroupWinter6Day2OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter6Day3Highlights: TripAttraction[] = [
  {
    name: "傑古沙龍冰河湖",
    nameEn: "Jökulsárlón",
    region: "冰島東部",
...
export const icelandGroupWinter6Day3OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter6Day4Highlights: TripAttraction[] = [
  {
    name: "辛格維利爾國家公園",
...
export const icelandGroupWinter6Day4OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter6Day5Highlights: TripAttraction[] = [
  {
    name: "博爾加內斯",
    nameEn: "Borgarnes",
    region: "冰島西部",
...
export const icelandGroupWinter6Day5OptionalActivities: TripAttraction[] = [

];

export const icelandGroupWinter6Day6Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克",
    nameEn: "Reykjavík",
    region: "雷克雅未克",
...
export const icelandGroupWinter6Day6OptionalActivities: TripAttraction[] = [
  {
