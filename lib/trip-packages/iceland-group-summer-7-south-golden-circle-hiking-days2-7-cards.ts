...
export const icelandGroupSummer7SouthGoldenCircleHikingDay2Highlights: TripAttraction[] = [
  {
    name: "辛格維利爾國家公園",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay2OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer7SouthGoldenCircleHikingDay3Highlights: TripAttraction[] = [
  {
    name: "塞里雅蘭瀑布",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay3OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer7SouthGoldenCircleHikingDay4Highlights: TripAttraction[] = [
  {
    name: "瓦特納冰川",
    nameEn: "Vatnajökull",
    region: "冰島東部",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay4OptionalActivities: TripAttraction[] = [

];

export const icelandGroupSummer7SouthGoldenCircleHikingDay5Highlights: TripAttraction[] = [
  {
    name: "火山內部探險",
    region: "冰島西部",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay5OptionalActivities: TripAttraction[] = [
  {
    name: "火山內部探險",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay6Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克舊港",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay6OptionalActivities: TripAttraction[] = [
  {
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay7Highlights: TripAttraction[] = [
  {
    name: "雷克雅未克",
    nameEn: "Reykjavík",
    region: "雷克雅未克",
...
export const icelandGroupSummer7SouthGoldenCircleHikingDay7OptionalActivities: TripAttraction[] = [
  {
