...
import {
  icelandSelfDriveWinter9NonRingDay1Highlights,
  icelandSelfDriveWinter9NonRingDay1OptionalActivities,
} from "./iceland-self-drive-winter-9-non-ring-day1-cards";
import {
  icelandSelfDriveWinter9NonRingDay2Highlights,
  icelandSelfDriveWinter9NonRingDay2OptionalActivities,
  icelandSelfDriveWinter9NonRingDay3Highlights,
  icelandSelfDriveWinter9NonRingDay3OptionalActivities,
  icelandSelfDriveWinter9NonRingDay4Highlights,
  icelandSelfDriveWinter9NonRingDay4OptionalActivities,
  icelandSelfDriveWinter9NonRingDay5Highlights,
  icelandSelfDriveWinter9NonRingDay5OptionalActivities,
  icelandSelfDriveWinter9NonRingDay6Highlights,
  icelandSelfDriveWinter9NonRingDay6OptionalActivities,
  icelandSelfDriveWinter9NonRingDay7Highlights,
  icelandSelfDriveWinter9NonRingDay7OptionalActivities,
  icelandSelfDriveWinter9NonRingDay8Highlights,
  icelandSelfDriveWinter9NonRingDay8OptionalActivities,
  icelandSelfDriveWinter9NonRingDay9Highlights,
  icelandSelfDriveWinter9NonRingDay9OptionalActivities,
} from "./iceland-self-drive-winter-9-non-ring-days2-9-cards";

export const icelandSelfDriveWinter9NonRing: TripPackage = {
  ...
  eyebrow: "冰島集合 · 自駕 · 冬季",
  backHref: "/trips/iceland/self-drive/winter/9",
  backLabel: "返回 9 日行程",
  heroImage:
    "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1920,q_auto:good/shawnanggg_u_H9r_AZZ_Zp_HA_unsplash_6839e2bf20.jpg",
  whyChooseUs: [
    {
      id: "deposit",
      title: "20% 訂金",
  ...
  intro: {
    summary:
      "這個 9 天 8 夜冰島冬季精選自駕，打卡黃金圈、南岸、冰河湖、西部白銀圈與斯奈山半島，並留有一日首都自由行。",
    full: `在 9 天時間內，您將打卡黃金圈三大景點，體驗南岸瀑布與黑沙灘的冬日風光，探索傑古沙龍冰河湖與鑽石沙灘，深度遊覽西部白銀圈，前往斯奈山半島欣賞迷人海岸線，並有充裕時間漫步雷克雅未克，品味冰島美食與極北首都的人文藝術氛圍。

全程由您掌控方向盤，靈活安排冰川徒步、藍冰洞、溫泉與極光追尋等自選活動。專業行程策劃師客製中文路書，涵蓋實用駕駛資訊與景點深度介紹。`,
  },
  gallery: [
    {
      id: "winter-drive",
      url: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/shawnanggg_u_H9r_AZZ_Zp_HA_unsplash_6839e2bf20.jpg",
      alt: "冰島冬季自駕",
      caption: "冰島冬季自駕風光",
    },
    {
  ...
  highlights: [
    "9 天精選西南岸自駕，深度探索黃金圈、南岸、西部白銀圈與斯奈山半島",
    "全程由您掌控方向盤，靈活安排旅行節奏",
    "打卡南岸瀑布與黑沙灘冬日奇景",
    "見證歐洲最大冰川瓦特納冰川的冬日風光",
    "暢遊傑古沙龍冰河湖與鑽石沙灘",
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        "Geysir 間歇泉被人們稱為大間歇泉（The Great Geysir），英文單詞「Geyser」即因它而得名。它坐落於冰島西南岸 Haukadalur 山谷，與辛格維利爾國家公園和黃金瀑布共同組成黃金圈。",
    ...
    },
    {
      ...
      paragraphs: [
        "教會山（Kirkjufell）位於斯奈山半島北端，是冰島最具代表性的山峰之一，常與前方的教會山瀑布（Kirkjufellsfoss）一同入鏡。冬季白雪覆蓋時景色尤為壯麗，也是追尋極光的熱門地點。",
        "斯奈山半島被稱為「冰島縮影」，一天之內可見火山、冰川、黑沙灘、漁村與海岸峭壁等多樣地貌，是冬季自駕的經典延伸路線。",
      ],
    },
  ],
  routeOverviewSubtitle: "南岸、黃金圈、西部白銀圈與斯奈山半島冬季自駕動線",
  routeStops: [
    { label: "第 1 天", detail: "雷克雅未克（入境、取車、可選藍湖／Sky Lagoon）" },
    { label: "第 2 天", detail: "南岸瀑布群 → 黑沙灘 → 南岸住宿" },
    { label: "第 3 天", detail: "傑古沙龍冰河湖 → 鑽石沙灘 → 藍冰洞（可選）→ 南部住宿" },
    { label: "第 4 天", detail: "南岸小眾景點 → 維克 → 迪霍拉里" },
    { label: "第 5 天", detail: "黃金圈（辛格維利爾 → 間歇泉 → 黃金瀑布）" },
    { label: "第 6 天", detail: "西部白銀圈（熔岩瀑布 → 德爾達圖赫菲 → 維德格爾米爾）" },
    { label: "第 7 天", detail: "斯奈山半島（教會山 → 布迪爾 → 漁村海岸）→ 雷克雅未克" },
    { label: "第 8 天", detail: "雷克雅未克（首都自由行）" },
  ...
  itinerary: [
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "抵達後於凱夫拉維克機場區租車中心取車，工作人員將講解冬季安全駕駛要點。入住首都精選飯店；若時間充裕，可選擇藍湖溫泉或 Sky Lagoon 放鬆，為接下來的自駕做好準備。",
      highlights: icelandSelfDriveWinter9NonRingDay1Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay1OptionalActivities,
    },
    {
      day: 2,
      title: "南岸瀑布與黑沙灘",
      accommodation: "南岸",
      description:
        "沿一號公路南下，造訪塞里雅蘭瀑布與斯科加瀑布，冬季瀑布後方小道可能封閉。繼續前往黑沙灘（Reynisfjara）感受壯闊海岸，亦可安排飛機殘骸打卡或冰川徒步等自選活動。傍晚入住南岸。",
      highlights: icelandSelfDriveWinter9NonRingDay2Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay2OptionalActivities,
    },
    {
      day: 3,
      title: "冰河湖風光",
      ...
      highlights: icelandSelfDriveWinter9NonRingDay3Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay3OptionalActivities,
    },
    {
      day: 4,
      title: "南岸小眾景點",
      accommodation: "黃金圈區域",
      description:
        "沿南岸遊覽更多小眾景點：埃爾德熔岩原（Eldhraun）、小冰河湖（Fjallsárlón）、迪霍拉里（Dyrhólaey）與維克紅頂教堂等，節奏從容，適合深度感受南岸冬日風光。",
      highlights: icelandSelfDriveWinter9NonRingDay4Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay4OptionalActivities,
    },
    {
      day: 5,
      title: "黃金圈",
      accommodation: "黃金圈區域",
      description:
        "造訪黃金圈三大景點：辛格維利爾國家公園、間歇泉與黃金瀑布。可選擇絲浮拉浮潛、雪地摩托或溫泉體驗，深度感受冰島最經典的冬日風光。",
      highlights: icelandSelfDriveWinter9NonRingDay5Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay5OptionalActivities,
    },
    {
      day: 6,
      title: "西部白銀圈",
      accommodation: "西部",
      description:
        "深度探索西部白銀圈：雷克霍特歷史名鎮、熔岩瀑布（Hraunfossar）、兒童瀑布（Barnafoss）、德爾達圖赫菲溫泉與維德格爾米爾熔岩洞，體驗與黃金圈不同的西部魅力。",
      highlights: icelandSelfDriveWinter9NonRingDay6Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay6OptionalActivities,
    },
    {
      day: 7,
      title: "斯奈山半島",
      accommodation: "雷克雅未克",
      description:
        "斯奈山半島被稱為「冰島縮影」，一日之內可見多樣地貌。打卡教會山（Kirkjufell）、布迪爾黑教堂、阿爾納斯塔皮海岸與漁村海岸，傍晚返回雷克雅未克入住。",
      highlights: icelandSelfDriveWinter9NonRingDay7Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay7OptionalActivities,
    },
    {
      day: 8,
      title: "雷克雅未克自由行",
      accommodation: "雷克雅未克",
      description:
        "在雷克雅未克自由安排一日，漫步洛加維格大街、哈帕音樂廳、彩虹街等市區景點，或選擇 Sky Lagoon、藍湖溫泉、極光船遊等自選活動，盡情探索首都風情。",
      highlights: icelandSelfDriveWinter9NonRingDay8Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay8OptionalActivities,
    },
    {
      day: 9,
      title: "離境日",
      accommodation: "—",
      description:
        "今天是離境日，前往凱夫拉維克國際機場還車離境。若航班較晚，可在雷克雅未克市區最後走走逛逛。我們歡迎您下次再來冰島！",
      highlights: icelandSelfDriveWinter9NonRingDay9Highlights,
      optionalActivities: icelandSelfDriveWinter9NonRingDay9OptionalActivities,
    },
  ],
  inclusions: {
    included: [
      "專業行程策劃師為您獨家客製的中文路書（包含冰島駕駛實用資訊，以及各類景點、歷史、文化和自然等資訊描述）",
      "8 整天租車（多種車型可選，包含 CDW 碰撞險）",
      "冰島行程期間 8 晚住宿",
      "簽證輔助行程單材料提供",
      "台灣冰島雙時區服務",
      "VAT 增值稅",
      ...
      items: [
        {
          question: "冬季在冰島自駕安全嗎？",
          answer:
            "雖然冬季天氣有時惡劣，但大部分時間冰島主要道路與城市道路暢通，鏟雪車會定期清理城鎮與熱門景點附近道路。冬季暴風雪有時可能迫使您改變計畫；透過大樂旅行社預訂的優點是，天氣不佳時我們可依經驗與資源迅速與您共同調整行程。若對冬季駕駛沒有信心，也可選擇跟團套餐。",
        },
        {
  ...
  similarTrips: [
    ...
    {
      tripKey: "iceland/self-drive/winter/8/non-ring",
      title: "冰島 8 天 7 夜冬季精選自駕遊",
      tourCode: "SLMSD-084",
      durationLabel: "8 天／7 夜",
      description:
        "打卡黃金圈、南岸、冰河湖與斯奈山半島，並留有一日首都自由行。",
    },
  ],
};
