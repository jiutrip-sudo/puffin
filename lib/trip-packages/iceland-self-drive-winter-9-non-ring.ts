...
行程另安排一日深度探索西部白銀圈（Silver Circle），以及「冰島縮影」斯奈山半島（Snæfellsnes），並留有一日雷克雅維克自由行。途中亦可另行加購藍冰洞探險、冰川健行、賞鯨或極光船遊等體驗。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島冬季西南岸精華。`,
  },
  gallery: [
    {
      id: "winter-drive",
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "雷克雅維克",
      description:
        "今日在雷克雅維克自由安排一日，漫步洛加維格大街（Laugavegur）、哈帕音樂廳、彩虹街等市區景點，品嚐當地美食，感受北歐首都的獨特氛圍。亦可另行加購 Sky Lagoon、藍湖溫泉、極光船遊或賞鯨等體驗。今晚繼續入住雷克雅維克。",
