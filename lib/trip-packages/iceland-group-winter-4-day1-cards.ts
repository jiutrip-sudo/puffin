...
export const icelandGroupWinter4Day1Highlights: TripAttraction[] = [
    reykjavikSpot,
...
export const icelandGroupWinter4Day1OptionalActivities: TripAttraction[] = [
    auroraMiniBusSpot,auroraBoatTourSpot,
    auroraSuperJeepSpot,reykjavikWhaleWatchingSpot,reykjavikLavaShowSpot,
