...
export const icelandGroupSummer6SouthHikingDay1Highlights: TripAttraction[] = [
    reykjavikSpot,
    hallgrimskirkjaSpot,
    laugavegurSpot,
...
export const icelandGroupSummer6SouthHikingDay1OptionalActivities: TripAttraction[] = [
    flyoverIcelandSpot,
