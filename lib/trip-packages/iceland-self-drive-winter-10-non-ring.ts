...
export const icelandSelfDriveWinter10NonRing: TripPackage = {
  ...
  intro: {
    summary:
      "這個 10 天 9 夜冰島冬季深度自駕，打卡南岸、冰河湖、黃金圈、西部白銀圈、斯奈山半島與雷克雅內斯半島，並留有一日首都自由行。",
    full: `在 10 天時間內，您將體驗南岸瀑布與黑沙灘的冬日風光，探索傑古沙龍冰河湖與鑽石沙灘，造訪黃金圈與西部白銀圈，深度遊覽斯奈山半島「微縮冰島」，並前往雷克雅內斯半島打卡藍湖與亞歐大陸橋，另有充裕時間漫步雷克雅未克。
...
全程由您掌控方向盤，靈活安排冰川徒步、藍冰洞、溫泉與極光追尋等自選活動。專業行程策劃師客製中文路書，涵蓋實用駕駛資訊與景點深度介紹。`,
  ...
  routeStops: [
    ...
    { label: "第 9 天", detail: "雷克雅內斯半島（藍湖 → 亞歐大陸橋）→ 雷克雅未克" },
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "沿一號公路南下，造訪塞里雅蘭瀑布與斯科加瀑布，冬季瀑布後方小道可能封閉。繼續前往黑沙灘（Reynisfjara）感受壯闊海岸，亦可安排飛機殘骸打卡、冰川徒步或 ATV 等自選活動。傍晚入住南岸。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "斯奈山半島被稱為「微縮冰島」，一日之內可見多樣地貌。打卡教會山（Kirkjufell）、布迪爾黑教堂、阿爾納斯塔皮海岸與漁村海岸，可自選 Vatnshellir 洞穴探險，傍晚返回雷克雅未克入住。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "前往雷克雅內斯半島，探索藍湖溫泉、布藍斯科礦洞、亞歐大陸橋（Bridge Between Continents）與海岸奇觀，感受冰島西南部地質公園的火山與地熱魅力，傍晚返回首都入住。",
  ...
  similarTrips: [
    ...
    },
    {
      ...
      description:
        "打卡黃金圈、南岸、冰河湖、西部白銀圈與斯奈山半島，並留有一日首都自由行。",
    },
  ],
};
