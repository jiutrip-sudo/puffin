...
行程另安排一日深度探索西部白銀圈（Silver Circle）、「冰島縮影」斯奈山半島（Snæfellsnes），以及雷克雅內斯半島（Reykjanes）的藍湖溫泉與亞歐大陸橋（Bridge Between Continents）等地質奇觀，並留有一日雷克雅維克自由行。途中亦可另行加購藍冰洞探險、冰川健行、賞鯨或極光船遊等體驗。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島冬季西南岸精華。`,
  },
  gallery: [
    {
      id: "kirkjufell-night",
