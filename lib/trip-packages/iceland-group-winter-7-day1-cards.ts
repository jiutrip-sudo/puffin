...
export const icelandGroupWinter7Day1OptionalActivities: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "預訂須知",
      "由於北極光之旅的成功很大程度上取決於天氣狀況，如果極光預報不佳，極光團保留在行程當天更改或取消的權利。 如果追光之旅繼續進行但沒有看到北極光，您將根據情況獲得免費無限次再次參加的機會（三年內均有效），直到您看見極光為止，僅限本人。具體請您參見帕芬假期旅行的服務條款，諮詢後台客服重新預訂。",
      "集合地點及時間",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 我們始終竭力為您提供觀看北極光的最佳機會。然而，由於極光是一種自然現象，我們永遠無法保證一定能看到北極光。如果您參加後未看到，我們將盡力為您額外安排一次免費參加機會， 具體請您參見帕芬假期旅行的服務條款，諮詢後台客服重新預訂。",
      "行程時長：",
      "最低參加年齡：",
      "體驗包含：",
      "不包含：",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "預訂須知",
      "此次行程沒有固定的目的地，一切將會由極光情況和天氣情況所決定。極光為自然現象，北極光探索之旅的成功很大程度上取決於天氣狀況，極光團保留旅行當天取消或更改的權利。如果追光之旅繼續進行且沒有看到北極光，則無法退款，如果沒有看到極光，極光團可為您保留3年有效期內無限次重試的機會，僅限本人使用。相應條款請參考帕芬假期旅行的服務條款並諮詢客服。",
      "集合地點及時間",
