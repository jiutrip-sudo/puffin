...
export const icelandSelfDriveWinter11: TripPackage = {
  ...
  intro: {
    summary:
      "這個 11 天 10 夜冰島冬季深度環島自駕，沿一號公路完整環島，深入斯奈山半島，並留有一日首都自由行。",
    full: `您將在這次冰島冬季 11 天環島自駕冒險中領略冰島冬季的無限魅力。行程沿一號公路探索最具冰島特色的景觀：黃金圈三大知名景點、南岸瀑布與黑沙灘、冰河湖與鑽石沙灘、東部峽灣、米湖熱能區、北部眾神瀑布與阿克雷里、西部沿途風光，以及被稱為「冰島縮影」的斯奈山半島。

比 10 天行程多一日首都自由行，讓您在環島後有充裕時間漫步雷克雅未克，品味冰島美食、享受溫泉，並靈活安排冰川徒步、藍冰洞等自選活動，亦有機會追尋北極光。`,
  },
  gallery: [
    {
      id: "aurora",
  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "斯奈山半島被稱為「冰島縮影」，是 11 天環島自駕的經典亮點之一。",
      ],
    },
  ],
  ...
  routeStops: [
    ...
    { label: "第 10 天", detail: "雷克雅未克（首都自由行）" },
    { label: "第 11 天", detail: "雷克雅未克 → 機場離境" },
  ],
  routeMap: {
    waypoints: [
      {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "在雷克雅未克自由安排一日，漫步彩虹街、哈爾格林姆斯教堂、哈帕音樂廳等市區景點，或選擇 Sky Lagoon、藍湖溫泉、Flyover Iceland 等自選活動放鬆休整。",
