...
export const icelandGroupSummer5: TripPackage = {
  ...
  intro: {
    summary:
      "這個 5 天 4 夜夏季跟團套餐涵蓋南岸兩日、冰川徒步與斯奈山半島，由品質小巴團與專業嚮導帶領。行程含 Sky Lagoon 體驗，善用夏季長日照與午夜陽光，節奏適中、安排務實。",
    full: `這個 5 天 4 夜夏季跟團套餐涵蓋南岸兩日、冰川徒步與斯奈山半島，由品質小巴團與專業嚮導帶領。套餐含凱夫拉維克機場至市區大巴接送與 Sky Lagoon 溫泉體驗，充分利用夏季長日照與午夜陽光，行程安排務實。

南岸動線串連塞里雅蘭瀑布（Seljalandsfoss）、斯科加瀑布（Skógafoss）、黑沙灘（Reynisfjara）、傑古沙龍冰河湖（Jökulsárlón）與鑽石沙灘（Diamond Beach）；冰川徒步由嚮導陪同並提供安全裝備（10 月前為冰川徒步，之後改為藍冰洞體驗）。第四日造訪斯奈山半島，涵蓋教會山（Kirkjufell）、海豹沙灘（Ytri Tunga）與黑教堂（Búðakirkja）。`,
  },
  gallery: [
    {
  ...
  itinerary: [
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今日搭乘品質小巴團沿南岸一號公路南下。夏季南岸瀑布水量充沛、草木蔥鬱。\n\n造訪塞里雅蘭瀑布（Seljalandsfoss）、秘密瀑布（Gljúfrabúi）與斯科加瀑布（Skógafoss）；夏季可沿小徑繞至塞里雅蘭瀑布後方，斯科加瀑布晴朗時常可見彩虹。接著在專業嚮導帶領下進行索爾黑馬冰川（Sólheimajökull）徒步，穿戴安全裝備近距離感受千年冰川地貌（10 月前為冰川徒步，之後改為藍冰洞體驗）。最後前往黑沙灘（Reynisfjara），遠處可見雷尼斯岩（Reynisdrangar）；夏季加達爾懸崖常有海鳥棲息。請務必在嚮導指示的安全區域內活動，遠離洶湧海浪。今晚入住南岸附近飯店。",
