  ...
  attractions: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "羽毛峽谷健行有兩條線路，分別是從峽谷頂部以及峽谷下方。從停車場開始，有一條有標記的小路通向峽谷頂部的峽谷觀景點，那裡是俯瞰峽谷壯麗景色最佳的地點。這條路相對容易、好走，而另一條從峽谷下方的健行線路則更加冒險，您需要蹚過淺淺卻異常冰冷的河水，最好穿上溯溪鞋、登山杖等專業健行的工具。",
        "美麗的羽毛峽谷在四季呈現出的景色截然不同。冬夏無疑是這裡最熱鬧的季節，夏天滿眼的綠色植被和泛著金色陽光的河流讓人流連忘返，而冬季白雪皚皚覆蓋著蜿蜒曲折的峽谷，河水的藍色深邃冷酷。春秋兩季，你會看到植被與苔蘚呈現處棕褐色的景象，另外，由於強降水原因，羽毛峽谷的路面會變得泥濘濕滑，許多旅客會為了避免弄髒鞋子衣服而離開標記的路線。一方面這是非常危險的行為，另一方面這會對植被造成嚴重的破壞。",
      ],
    },
    {
      name: "維克",
