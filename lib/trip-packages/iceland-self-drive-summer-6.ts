...
export const icelandSelfDriveSummer6: TripPackage = {
  ...
  intro: {
    summary:
      "不知道冰島怎麼玩？交給我們！這個6天5夜夏季精選自駕遊行程，我們為您精心規劃，您將看到冰島所能看到的各種獨具特色的無限美麗風光。",
    full: `不知道冰島怎麼玩？交給我們！這個6天5夜夏季精選自駕遊行程，我們為您精心規劃，您將看到冰島所能看到的各種獨具特色的無限美麗風光。

您將會參觀到冰島許多著名的旅遊景點，打卡知名電影取景地，您將打卡冰島最著名的旅遊線路之一：黃金圈，包括了三個主要景點：黃金瀑布（Gullfoss）、間歇泉地區（Geysir）和辛格維利爾國家公園（Þingvellir National Park）。除此之外，您還將探訪冰島南岸瀑布，感受傑古沙龍冰河湖（Jökulsárlón）和鑽石沙灘（Diamond Beach）的神秘夢幻。您可以在冰河湖上乘坐船隻，欣賞冰山和冰川的壯美。

在行程中，您還將來到冰島西部，追尋冰島歷史遺址，並有充足的時間在雷克雅未克自由行，感受極北首都的城市人文風貌。

同時，您也有足夠自主的權利在小眾景點停留，發現冰島隱匿於世的寶藏地區。整個行程安排合理有序，讓您每一天都會豐富多彩！

在您盡情自駕，隨心走停，享受這個豐富的旅遊線路同時，您還可以沿途預訂額外的旅遊附加項目，為您的旅程增加不一樣的獨特回憶，如騎行冰島小矮馬、冰河湖遊船、冰川徒步、出海觀鯨等，在好奇中發現樂趣，在樂趣中暢遊冰島。`,
  },
  gallery: [
    {
      id: "_b6fee84594",
  ...
  routeStops: [
    ...
    { label: "第 5 天", detail: "斯奈山半島（教會山 → 布迪爾 → 漁村海岸）→ 雷克雅未克" },
  ...
  itinerary: [
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "到達冰島後，您將直接前往凱夫拉維克機場租車辦公室取車。工作人員會在為您詳細講解所有關於取車、還車、保險以及冰島安全駕駛資訊等，並在交車前仔細為你檢車車輛。隨後您將直接駕車前往雷克雅未克，並入住為您精心挑選的飯店。如果您的航班抵達冰島的時間較早，不妨在雷克雅未克市區走走逛逛，當然您還可以提前準備好泳衣，利用時間在入境後直接前往藍湖（Blue Lagoon）或天空之境溫泉（Sky Lagoon）放鬆，緩解長途飛行的疲倦。",
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "您將沿著南海岸旅行，欣賞塞里雅蘭瀑布 (Seljalandsfoss) 和斯科加瀑布 (Skógafoss) 這兩個令人驚歎的瀑布。站在瀑布下，您也可以感受到與自然的親密接觸。您可以感受到瀑布湍急的水流，體會到水的清涼和清新。同時，周圍的景色也十分壯觀，瀑布周圍被鬱鬱蔥蔥的綠色植被所環繞，山脈和天空構成了壯麗的背景，讓您在這片自然的宏偉中沉醉。在斯科加瀑布，您可以登上旁邊的步道，到達瀑布頂端，站在觀景臺眺望南岸的壯美風光。若時間剩餘較多，不妨前去旁邊的斯科加民俗博物館參觀瞭解該地區的文化和定居史，在距離此不遠的索爾黑馬冰川（Sólheimajökull），跟隨專業嚮導一起登上冰川，參與冰川徒步，身體力行地感受何為冰川奇蹟。迪霍拉里（Dyrhólaey）和燈塔位於迪霍拉里自然保護區，是冰島南岸不容錯過的景點。夏季您說不定能在保護區看到海鸚，不要忘記在燈塔打卡哦。旁邊就是冰島最具代表性的黑沙灘（Reynisfjara）遊覽，感受著大西洋海浪與黑沙灘交織的“異星”既視感。 在海浪聲中，您將感受著來自世界盡頭的力量。在冰島最南端迷人的維克小鎮（Vík），秀美可愛的小鎮和黑沙灘巨浪形成的鮮明對比，紅頂教堂佇立小鎮中，讓人印象深刻。",
    ...
    },
    {
      ...
      accommodation: "南岸",
      description:
        "今天，您將沿著歐洲最大的冰川瓦特納冰川（Vatnajökull）行駛。傑古沙龍冰河湖（Jökulsárlón），這個位於Breiðamerkurjökull冰川南端的瀉湖，被《孤獨星球》列為此生必去景點之一。湖水深邃而清澈，湖面上漂浮著從冰川斷裂下來的冰山，它們形態各異，有的像寶石一樣晶瑩剔透，有的則呈現出古老的藍色調。您可以預約船票，乘坐小船穿梭於這些冰山之間，感受彷彿置身於千年冰晶世界中的浪漫。而在隔壁的鑽石沙灘（Diamond Beach）這裡的黑沙灘上散落著從冰河湖沖刷上來的冰山碎片，它們在陽光下閃耀著鑽石般的光芒。夏日的暖陽與冰冷的冰山碎片共同營造出一種夢幻般的場景，讓人彷彿置身於童話世界。參觀結束後，您將動身返回雷克雅未克。途中，您會經過一眾景點，比如一大片連綿起伏的熔岩苔原地貌埃爾德熔岩原（Eldhraun）。這是一片由1783年拉基火山（Laki）噴發形成的廣闊熔岩地帶。這片熔岩苔原地貌獨特，覆蓋著厚厚的苔蘚，給人一種荒涼而又生機勃勃的感覺。除此之外，您將抵達羽毛峽谷（Fjaðrárgljúfur），這個深邃而狹窄的峽谷，因其巖壁上溝壑縱橫，狀如羽毛而得名。峽谷中流淌著清澈的溪流，兩側的巖壁高聳入雲，給人一種神秘而幽靜的感覺。這裡不僅是冰島最負盛名的峽谷之一，也是《權力的遊戲》第八季的拍攝地之一，讓您在欣賞自然美景的同時，也能感受到影視作品中的史詩氛圍。",
    ...
    },
    {
      ...
      accommodation: "西部",
      description:
        "今天您將前往冰島最熱門的旅遊路線——黃金圈一探究竟。經典黃金圈包含3個景點，分別是辛格維利爾國家公園（Þingvellir National Park）、間歇泉（The Great Geysir and Strokkur）以及黃金瀑布（Gullfoss）。您的旅程會來到辛格維利爾國家公園，這裡是冰島乃至世界上最為重要的歷史遺址之一。作為冰島議會的誕生地，它見證了冰島民主的起源。同時，這裡也是地質奇蹟的展示，歐亞大陸板塊與美洲大陸板塊在此分離，形成了壯觀的大裂谷。您可以站在兩大板塊之間，感受地殼運動的威力。而間歇泉區域，這裡是地熱活動的熱點，尤其是史托克間歇泉（Strokkur），每隔幾分鐘就會噴發出高達十多米的水柱，展現了地球內部的巨大能量。您可以在這裡耐心等待，記錄下間歇泉噴發的壯觀瞬間。黃金瀑布以其宏偉的氣勢和美麗的景色而聞名。瀑布分為兩層，水流從32米的高度傾瀉而下，發出震耳欲聾的轟鳴聲。陽光下，瀑布的水霧中常常會出現彩虹，為這壯觀的自然景觀增添了一抹神秘的色彩。除此之外，您還可以在黃金圈沿線探索新晉小眾景點，比如凱瑞斯火山口（Kerið Crater）、番茄農場（Friðheimar），您也可以盡情享受黃金圈的三大王牌體驗項目：浮潛、騎馬以及雪地摩托。",
    ...
    },
    {
      ...
      accommodation: "雷克雅未克",
      description:
        "斯奈山半島位於冰島西部，距離雷克雅未克僅有2個小時的路程，就能抵達這片被譽為“冰島縮影”的半島，它同時也被稱為進入地心的唯一入口。您將從南部開始以順時針方向探索這片半島。第一站，您將來到海豹沙灘（Ytri Tunga），和這群呆萌慵懶的代言人打個照面。隨後，在布迪爾黑教堂（Búðakirkja）打卡這個以黑色為主色調的超酷教堂，如果教堂有性格，那麼他一定是一個i人。教堂旁邊就是被稱為斯奈山半島最美漁村的阿爾納斯塔皮（Arnarstapi），您可以在這稍作休息，遠眺湛藍澎湃的大西洋。在半島的西南角，您將看到又一片美麗的黑沙灘Djúpalónssandur，這裡的傳統大力士抱石遊戲吸引著世界各地的旅客前來體驗，在這裡你或許還能發現以前英國沉船的殘骸。接著，您將來到斯奈山半島上最著名的景點教會山（Kirkjufell），酷似草帽的它也被台灣旅客稱為“草帽山”。如果時間和精力充足，您還可以向北拐去，探訪白日夢想家小鎮斯蒂基斯霍爾米（Stykkishólmur），在這個充滿色彩的可愛小鎮喝上一杯熱拿鐵，欣賞群山、港灣和慢悠悠的風。",
    ...
    },
    {
      ...
      accommodation: "—",
      description:
        "美好時光總是短暫，時間匆匆而過，今天便來到了您的離境日。我們為您安排好了符合您 離境時間的機場大巴，請您按時乘坐前往機場。離境之前，如果您還有足夠時間，您還可以多在雷克雅未克停留，再度感受一下這座北國首都的迷人風情，再品嚐一下冰島特色羊肉湯，或者在老城區的小咖啡館裡，享受一杯溫暖的咖啡和冰島甜點，逛逛購物街上的精品小店，參觀各大地標建築。最後，不要忘記在機場退稅，祝您一路順風，歡迎下次再會冰島！",
