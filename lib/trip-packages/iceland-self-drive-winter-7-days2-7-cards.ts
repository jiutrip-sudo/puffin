...
export const icelandSelfDriveWinter7Day4Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "泛舟湖上，看千年浮冰熠熠生輝",
      "小冰河湖（Fjallsárlón）位於傑古沙龍冰河湖（Jökulsárlón）以西約10公里處，瓦特納冰川（Vatnajökull）的南緣。在傑古沙龍冰河湖的盛名之下，面積較小的Fjallsárlón冰河湖被臺灣旅客賦予了小冰河湖的名字，不過不要懷疑！它的美景和遊玩體驗絕對絲毫不輸於傑古沙龍。Fjallsjökull冰川作為瓦特納冰川的冰川舌一直延伸至小冰河湖，使這裡成為享受原生態大自然的絕佳寧靜之地。",
