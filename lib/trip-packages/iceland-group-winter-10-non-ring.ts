...
行程另安排一日西部白銀圈，造訪熔岩瀑布（Hraunfossar）與雷克霍特（Reykholt）歷史名鎮；以及「冰島縮影」斯奈山半島（Snæfellsnes）一日遊、Hvammsvík 溫泉與冰島馬騎行體驗，並留有一日雷克雅維克自由行。途中亦可另行加購絲浮拉裂谷（Silfra）浮潛、觀鯨或極光船遊等體驗。完成預訂後，您將收到行程策劃師為您客製的中文行程手冊，讓您輕鬆盡享冰島冬季西南岸精華。`,
  },
  gallery: [
    {
      id: "_5c0263f9ce",
  ...
  attractions: [
    ...
    },
    {
      ...
      imageUrl: "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/crystal_ice_cave1_d570272984.jpg",
      galleryImages: [
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/crystal_ice_cave1_d570272984.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/crystal_ice_cave2_13a7c81950.jpg",
        "https://www.senlinmao.com/images/g_auto,f_auto,c_fill,w_1200,q_auto:good/crystal_ice_cave3_d00e366be0.jpg",
      ],
      paragraphs: [
        "冬季冰島不容錯過的無雙體驗",
  ...
  itinerary: [
    ...
    {
      day: 4,
      title: "黃金圈環遊：黃金瀑布、辛格維利爾國家公園、間歇泉",
      accommodation: "雷克雅維克",
      description:
    ...
    {
      day: 9,
      title: "雷克雅維克自由活動日（可選觀鯨）",
      accommodation: "雷克雅維克",
      description:
        "今日在雷克雅維克自由安排一日，漫步洛加維格大街（Laugavegur）、哈帕音樂廳（Harpa）與彩虹街等市區景點，品嚐當地美食，感受北歐首都的獨特氛圍。亦可另行加購觀鯨、極光船遊或溫泉等體驗。今晚繼續入住雷克雅維克。",
  ...
  faq: [
    {
      ...
      items: [
        ...
        {
          question: "大樂旅行社旅行的冰島旅遊套餐中包含往返機票嗎？",
          answer:
    ...
    },
    {
      ...
      items: [
        {
          question: "大樂旅行社旅行提供什麼住宿？",
          answer:
            "[{\"tag\":\"PARAGRAPH\",\"content\":[{\"tag\":null,\"content\":[\"在大樂旅行社旅行的套餐中，您可以選擇三種級別的住宿：\"]",
        }
      ],
    }
  ],
