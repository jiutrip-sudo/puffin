...
export const icelandSelfDriveSummer4Day2Highlights: TripAttraction[] = [
  {
    ...
    paragraphs: [
      ...
      "需要提醒旅客的是，無論是夏季還是夏季前往塞里雅蘭瀑布，都需要注意這條小路極其溼滑，由於瀑布落差巨大，因此無論是否有風，瀑布都會打溼這條隱藏在其後的小路。夏季，這條小路有可能會因為安全原因而封路，如果幸運沒有遇到道路封閉的情況，請一定要注意腳下，另外還要注意頭上可能會落下的冰柱。",
...
export const icelandSelfDriveSummer4Day2OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "冰島的冰洞是非常有代表性的天然景觀，每年夏季開始，便是探尋神秘冰洞的好時節。",
...
export const icelandSelfDriveSummer4Day3OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "注意事項：",
      "1. 建議穿保暖防水的衣物，並穿登山靴。",
      "2. 由於冰洞的形成是純天然且人為不可控的，所以每一年冰洞的位置和樣貌都會有變化，且只能在夏季降到零度以下時才能進入。為了您更好的體驗感受，我們會根據天氣狀況做預測，如天氣狀況不符合進洞要求，我們會提前聯繫您取消行程。取消條款請參見森林貓旅行的服務條款。",
      "活動時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveSummer4Day4Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "對於尋求冒險的人，舊港口是各種出海旅程的起點。觀鯨之旅（Reykjavík Whale Watching）是其中最受歡迎的一個，旅客有機會近距離觀察這些壯麗的生物。觀鳥、海釣和夏季的極光巡遊，是您在雷克雅未克能夠體驗到的最有趣的活動之一。",
...
export const icelandSelfDriveSummer4Day4OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "該溫泉於2021年正式開放，Sky Lagoon的建築靈感來自冰島自然地質和傳統建築，選用了灰藍色和深綠色等色彩，使建築與周圍的自然景象相得益彰。從70米長的無邊溫泉池向外看去，你不僅能夠一覽北大西洋的全景，欣賞到海上落日，還能夠眺望遠處的凱尼爾山（Keilir）、斯奈菲爾冰川（Snæfellsjökull）、冰島總統府（Bessastaðir）。夏季，浸泡在溫暖的泉水中，您還有機會能夠看到絢麗的北極光在你上空飛舞。",
