...
export const icelandSelfDriveSummer4Day2OptionalActivities: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "2. 如您需要從雷克雅維克出發的卡特拉冰洞探險，請您諮詢森林貓旅行後台客服。",
      "體驗時長：",
      "最低參加年齡：",
      "體驗包括：",
      "不包括：",
...
export const icelandSelfDriveSummer4Day4Highlights: TripAttraction[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "對於尋求冒險的人，舊港口是各種出海旅程的起點。觀鯨之旅（Reykjavík Whale Watching）是其中最受歡迎的一個，旅客有機會近距離觀察這些壯麗的生物。觀鳥、海釣和夏季的極光巡遊，是您在雷克雅維克能夠體驗到的最有趣的活動之一。",
