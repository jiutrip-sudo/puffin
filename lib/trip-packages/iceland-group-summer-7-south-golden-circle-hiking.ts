...
export const icelandGroupSummer7SouthGoldenCircleHiking: TripPackage = {
  ...
  intro: {
    summary:
      "這個 7 天 6 夜夏季探險跟團套餐涵蓋黃金圈、南岸冰川徒步、冰河湖、火山內部探險與觀鯨，由品質小巴團與專業嚮導帶領。第六日為自由活動，可另行加購蘭德曼納勞卡高地徒步。",
    full: `這個 7 天 6 夜夏季探險跟團套餐涵蓋黃金圈、南岸冰川徒步、傑古沙龍冰河湖、火山內部探險與雷克雅維克觀鯨，由品質小巴團與專業嚮導帶領。套餐含凱夫拉維克機場至市區大巴接送，充分運用夏季日照長的優勢。

行程涵蓋黃金圈三大景點——辛格維利爾國家公園（Þingvellir National Park）、蓋錫爾間歇泉地帶與黃金瀑布（Gullfoss），並參觀凱瑞斯火山口（Kerið）；南岸則有塞里雅蘭瀑布（Seljalandsfoss）、斯科加瀑布（Skógafoss）、索爾黑馬冰川徒步、黑沙灘（Reynisfjara）與雷尼斯岩（Reynisdrangar）。第四日造訪傑古沙龍冰河湖（Jökulsárlón）與鑽石沙灘（Diamond Beach）；第五日搭乘升降機深入 Þríhnúkagígur 休眠火山內部，並從雷克雅維克老港口出海觀鯨。

第六日為自由活動，可另行加購蘭德曼納勞卡（Landmannalaugar）高地徒步——僅夏季開放。夏季迪霍拉里（Dyrhólaey）等地常有海鸚棲息，實際停留時間將由嚮導依天候與路況調整。`,
  },
  gallery: [
    {
      id: "1_8dcfeb3210",
  ...
  routeStops: [
    ...
    { label: "第 6 天", detail: "自由活動日（可選高地徒步）" },
