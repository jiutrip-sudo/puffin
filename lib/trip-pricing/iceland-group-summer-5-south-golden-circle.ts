...
import { ICELAND_GROUP_SUMMER_5_SOUTH_GOLDEN_CIRCLE_OPERATING_EXCLUSIONS } from "./iceland-group-summer-5-south-golden-circle-operating-exclusions";
...
export const icelandGroupSummer5SouthGoldenCirclePricing: PricingConfig = {
  packageId: "iceland-group-summer-5-south-golden-circle",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_5_SOUTH_GOLDEN_CIRCLE_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 5,
  accommodationIntro:
