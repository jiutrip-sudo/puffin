...
import { ICELAND_GROUP_SUMMER_7_OPERATING_EXCLUSIONS } from "./iceland-group-summer-7-operating-exclusions";
...
export const icelandGroupSummer7Pricing: PricingConfig = {
  packageId: "iceland-group-summer-7",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_7_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 7,
  accommodationIntro:
