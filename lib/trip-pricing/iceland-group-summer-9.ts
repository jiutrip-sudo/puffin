...
import { ICELAND_GROUP_SUMMER_9_OPERATING_EXCLUSIONS } from "./iceland-group-summer-9-operating-exclusions";
...
export const icelandGroupSummer9Pricing: PricingConfig = {
  packageId: "iceland-group-summer-9",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_9_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 9,
  accommodationIntro:
