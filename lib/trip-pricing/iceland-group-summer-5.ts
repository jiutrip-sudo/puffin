...
import { ICELAND_GROUP_SUMMER_5_OPERATING_EXCLUSIONS } from "./iceland-group-summer-5-operating-exclusions";
...
export const icelandGroupSummer5Pricing: PricingConfig = {
  packageId: "iceland-group-summer-5",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_5_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 5,
  accommodationIntro:
