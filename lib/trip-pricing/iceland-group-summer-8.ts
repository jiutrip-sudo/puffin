...
import { ICELAND_GROUP_SUMMER_8_OPERATING_EXCLUSIONS } from "./iceland-group-summer-8-operating-exclusions";
...
export const icelandGroupSummer8Pricing: PricingConfig = {
  packageId: "iceland-group-summer-8",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_8_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 8,
  accommodationIntro:
