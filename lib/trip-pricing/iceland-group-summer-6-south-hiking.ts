...
import { ICELAND_GROUP_SUMMER_6_SOUTH_HIKING_OPERATING_EXCLUSIONS } from "./iceland-group-summer-6-south-hiking-operating-exclusions";
...
export const icelandGroupSummer6SouthHikingPricing: PricingConfig = {
  packageId: "iceland-group-summer-6-south-hiking",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_6_SOUTH_HIKING_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 6,
  accommodationIntro:
