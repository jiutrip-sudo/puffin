...
import { ICELAND_GROUP_SUMMER_10_OPERATING_EXCLUSIONS } from "./iceland-group-summer-10-operating-exclusions";
...
export const icelandGroupSummer10Pricing: PricingConfig = {
  packageId: "iceland-group-summer-10",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_10_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 10,
  accommodationIntro:
