...
import { ICELAND_GROUP_SUMMER_6_OPERATING_EXCLUSIONS } from "./iceland-group-summer-6-operating-exclusions";
...
export const icelandGroupSummer6Pricing: PricingConfig = {
  packageId: "iceland-group-summer-6",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_6_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 6,
  accommodationIntro:
