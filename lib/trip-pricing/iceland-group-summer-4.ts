...
import { ICELAND_GROUP_SUMMER_4_OPERATING_EXCLUSIONS } from "./iceland-group-summer-4-operating-exclusions";
...
export const icelandGroupSummer4Pricing: PricingConfig = {
  packageId: "iceland-group-summer-4",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  ...
  bookingDateExclusions: [
    ...
    ...ICELAND_GROUP_SUMMER_4_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 4,
  accommodationIntro:
