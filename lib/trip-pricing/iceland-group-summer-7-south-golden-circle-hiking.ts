...
import { ICELAND_GROUP_SUMMER_7_SOUTH_GOLDEN_CIRCLE_HIKING_OPERATING_EXCLUSIONS } from "./iceland-group-summer-7-south-golden-circle-hiking-operating-exclusions";
...
export const icelandGroupSummer7SouthGoldenCircleHikingPricing: PricingConfig = {
  packageId: "iceland-group-summer-7-south-golden-circle-hiking",
  currency: "ISK",
  depositRate: 0.2,
  occupancyBase: 2,
  minAdults: 1,
  maxTravelers: 9,
  maxInfants: 2,
  bookingDateRange: { min: "2026-09-11", max: "2027-10-31" },
  bookingDateExclusions: [
    ...ICELAND_SUMMER_BOOKING_EXCLUSIONS,
    ...ICELAND_GROUP_SUMMER_7_SOUTH_GOLDEN_CIRCLE_HIKING_OPERATING_EXCLUSIONS,
  ],
  tripDurationDays: 7,
  accommodationIntro:
